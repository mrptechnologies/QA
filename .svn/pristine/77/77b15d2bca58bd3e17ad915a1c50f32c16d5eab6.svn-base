...
*/
		...
		function loadTable(url) {
			...
			new Ajax.Updater(
				...
				method: "get",
				onComplete: function(){
					if(document.getElementById("Home_Panel") != null && document.getElementById("Home_Panel") != undefined) {
						forwardToLoginPageIfInvalidSession(document.getElementById("Home_Panel").innerHTML);
					}
					//Do something
				}
				}
