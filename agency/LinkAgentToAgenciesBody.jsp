...
<tr>
	...
	<tr>
		...
		<td align="left">&nbsp;<dmshtml:get_all_agencies nameInSession="arListagencies"  parentAgencyId="-1" ownerId="<%=Long.parseLong(""+ownerId) %>" dbname="<%=com.dms.web.util.DbUtils.getReadDS(pageContext)%>"/><html:select property="answer(Object::EntityObjectLink::AgencyId)" >
		<html:option value ="">Select An Agency</html:option>
		<logic:present name="arListagencies" scope="session">
		<logic:iterate id="details" name="arListagencies" scope="session" >
...
<html:hidden property="formName" value="MicaCare::LinkAgentToAgencies"/>
...
<html:hidden property="TabPanelName" value="<%=""+request.getParameter("TabPanelName") %>" /></html:form>
</body>
<!--</html:html>-->
