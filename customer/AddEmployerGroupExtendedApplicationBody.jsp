...
objectVerId="0" objectName="EMPLOYER_EXTENDED" applicationType="EMPLOYER" applicationSubType="" isSubApplicationCoveredByForm="Yes"  actionName="/saveEmployerGroupExtendedApplicationAction.go" isApplicationEnabled="Y"  showOneTabAtTime="N"/>
