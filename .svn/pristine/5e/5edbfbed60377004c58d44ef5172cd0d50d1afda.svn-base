...
<html:form action="/FindUploadClaimFiles.do" onsubmit="return GoTOFindButton(this)">
<html:hidden property="answer(dbname)" value='<%=com.dms.web.util.DbUtils.getWriteDS(pageContext)%>'/>
<bean:define id="ownerId" property="answer(Object::UserDetail::ownerId)" name="LoginPage" scope="session"/>

 <table WIDTH="98%" ALIGN="center" BORDER="0" CELLSPACING="0" CELLPADDING="2">
	    <tr><td>&nbsp;</td></tr>
		<tr><td class="NewSectionHead" colspan="4" align="center">FIND IMPORTED CLEARANCE FILE</td></tr>
		 ...
		 <td>
			<table WIDTH="90%" ALIGN="center" BORDER="0" CELLSPACING="0" CELLPADDING="2">
				...
				<tr>
					...
					<td align="left" ><html:text  property="answer(Object::Claims::FileName)" size="30" styleClass="txtbox"/></td>
				</tr>
