...
%>
<dmshtml:GetLocationEndorsementSubjectivityList subjectivityCount="subjectivityCount" subjectivieRequiredProcess="<%=""+subjectivityReqProcess%>" sortColumn="<%=""+sort%>" direction="<%=""+dir %>" startIndex="<%=""+startIndex %>"  resultsPerPage="<%=""+results %>"   preBindSubjectivityList="preBindSubjectivityList" parentQuoteVerId="<%=parentQuoteVerId %>" subQuoteVerId="<%=subQuoteVerId %>" ownerId="<%=ownerId %>"  dbname="<%=com.dms.web.util.DbUtils.getReadDS(pageContext)%>"/>
