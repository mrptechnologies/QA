	...
	<tr>
		<td>
			<table WIDTH="1100px" ALIGN="center" BORDER="0" CELLSPACING="0" CELLPADDING="0">
				<tr>
					<td class="NewSectionHead" colspan="4" align="center">ADD/EDIT FEE</td>
				</tr>
										...
										<table WIDTH="90%" ALIGN="left" BORDER="0" CELLSPACING="0" CELLPADDING="2">
											...
											<tr>
												<td>
													...
													<html:hidden name="AddFeeDefinition"  property="answer(Object::Product::Fee::Definition::ProductFeeId)"  />
