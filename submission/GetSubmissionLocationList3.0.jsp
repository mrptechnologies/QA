...
<template:put name='ProgressBar' content='/common/ProgressBarLocations.jsp' />
<template:put name='Header1' content='/submission/SubmissionHeaderBody.jsp' />
<template:put name='GeneralBody' content='/submission/GetSubmissionLocationListBody3.0.jsp' /> 
