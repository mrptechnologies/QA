...
<template:put name='ProgressBar' content='/common/ProgressBarClearanceBTA.jsp' />
...
<template:put name='ProgressBar' content='/common/ProgressBarClearance.jsp' />
</dmshtml:dms_static_with_connector>
<template:put name='GeneralBody' content='/clearance/CheckClearanceBodyCVStarr3.0.jsp' /> 
