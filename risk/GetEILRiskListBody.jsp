...
function confirmDelete(){
	...
	for(var i=0; frm.elements[i]!=null; i++) {
		...
		if(frm.elements[i].name == "answer(Object::Risk::ComProperty::ComPropertyId)" && frm.elements[i].checked == true) {
			count++;
			break;
		}
	}
...
<html:form action="/DeleteCLRisk.do" scope="request">
...
<a href="/AddEILProperty.do?answer(TabPanelName)=Insured_Panel&answer(Object::UserDetail::ownerId)=<%=""+ownerId%>&answer(OwnerId)=<%=""+ownerId%>&answer(Object::Customer::CustomerId)=<%=""+customerId %>&answer(Object::Risk::ComProperty::CustomerId)=<%=""+customerId%>&answer(objectId)=0&answer(Object::Risk::ComProperty::ComPropertyId)=-1&answer(objectVerId)=0&answer(objectName)=UST_RISK&answer(applicationType)=RISK&answer(applicationSubType)=&Navigation=&answer(teritory)=<%=""%>&answer(state)=<%=""%>&answer(territoryName)=<%=""%>&answer(zone)=<%=""%>&answer(showOnetTab)=Y&tabNo=0&answer(Object::Agency::AgencyId)=<%=id.toString()%>&answer(Object::Risk::ComProperty::ComPropertyId)=-1&answer(SelectedRiskType)=UST&answer(Object::Risk::ComProperty::CustomerId)=<%=""+customerId%>
&answer(Object::Risk::RiskId)=-1&answer(Object::UST::SpecificQuestion::USTSpecificQuestionId)=-1&TabPanelName=Insured_Panel" title="Click to go to add a New Risk" />Add Risk</a>
									</td>
				...
				<table WIDTH="1000px" ALIGN="center" border="0"CELLSPACING="0" CELLPADDING="2">
					...
					<logic:present name="riskListArray">
						...
						<logic:iterate id="riskListArray" name="riskListArray" >
							...
							<tr>
							<bean:write name="riskListArray" property="resPropertyId" />
								<td class="SearchResult" align="center">								
									<a href="../EditCLRisk.do?answer(TabPanelName)=Insured_Panel&answer(Object::Risk::ComProperty::CustomerId)=<%=""+customerId %>&answer(Object::Agency::AgencyId)=<%=id.toString()%>&answer(objectId)=0&answer(objectVerId)=0&answer(objectName)=&answer(applicationType)=RISK&answer(applicationSubType)=&Navigation=&tabNo=0&answer(teritory)=&answer(territoryName)=&answer(zone)=&answer(showOnetTab)=Y&answer(state)=
												&answer(Object::Risk::ComProperty::CustomerId)=<%= customerId.toString()%>&answer(Object::Risk::ComProperty::ComPropertyId)=<bean:write name="riskListArray" property="resPropertyId" />&answer(SelectedRiskType)=<bean:write name="riskListArray" property="riskType" />&answer(OwnerId)=<%=ownerId+"" %>" title="Click to go to edit Risk Detail">
								...
								<td class="SearchResult">
									<a href="../EditCLRisk.do?answer(TabPanelName)=Insured_Panel&answer(Object::Risk::ComProperty::CustomerId)=<%=""+customerId %>&answer(Object::Agency::AgencyId)=<%=id.toString()%>&answer(objectId)=0&answer(objectVerId)=0&answer(objectName)=&answer(applicationType)=RISK&answer(applicationSubType)=&Navigation=&tabNo=0&answer(teritory)=&answer(territoryName)=&answer(zone)=&answer(showOnetTab)=Y&answer(state)=
										&answer(Object::Risk::ComProperty::CustomerId)=<%= customerId.toString()%>&answer(Object::Risk::ComProperty::ComPropertyId)=<bean:write name="riskListArray" property="resPropertyId" />&answer(SelectedRiskType)=<bean:write name="riskListArray" property="riskType" />&answer(OwnerId)=<%=ownerId+"" %>" />
										<bean:write name="riskListArray" property="riskNumber" />
									</a>
									<%++i;%>
								</td>
								<td class="SearchResult">
									<a href="../EditCLRisk.do?answer(TabPanelName)=Insured_Panel&answer(Object::Risk::ComProperty::CustomerId)=<%=""+customerId %>&answer(Object::Agency::AgencyId)=<%=id.toString()%>&answer(objectId)=0&answer(objectVerId)=0&answer(objectName)=&answer(applicationType)=RISK&answer(applicationSubType)=&Navigation=&tabNo=0&answer(teritory)=&answer(territoryName)=&answer(zone)=&answer(showOnetTab)=Y&answer(state)=
										...
										<bean:write name="riskListArray" property="riskName" />	
										</a>
									&nbsp;
									
								</td>
								<td class="SearchResult">
									<bean:write name="riskListArray" property="riskType" />&nbsp;
								</td>
								<td class="SearchResult">
									<bean:write name="riskListArray" property="policyNumber" />&nbsp;
								</td>
								<td class="SearchResult">
									<bean:write name="riskListArray" property="effectiveDate" />&nbsp;
								</td>
								<td class="SearchResult">
									<bean:write name="riskListArray" property="expirationDate" />&nbsp;
								</td>
								
								 <td class="SearchResult">
								 	<bean:define id="resPropId" name="riskListArray" property="resPropertyId"></bean:define>								 
								 	<html:checkbox property="answer(Object::Risk::ComProperty::ComPropertyId)" value="<%= resPropId.toString() %>" styleId='<%="deleteQuote"+count%>' />								 	
					...
					<table WIDTH="1000px" ALIGN="center" border="0"CELLSPACING="0" CELLPADDING="2">
						...
						<tr>
						 ...
						 <!--    <td class="sectionhead" width="20%">
							...
							<td class="sectionhead" width="46%" align="right">
								Delete
							</td>
						</tr>
						<% int i=0; %>
						...
						<logic:iterate id="arrOfInCompRiskQmap" name="ArrOfInCompRiskQmap" >
							...
							<tr>
							<bean:write name="arrOfInCompRiskQmap" property="Object::Risk::ResProperty::RiskId" />aaa
								<td class="SearchResult" align="left">
									<a href="../EditEILRisk.do?TabPanelName=Insured_Panel&answer(Object::Agency::AgencyId)=<%=id.toString()%>&answer(objectId)=0&answer(objectVerId)=0&answer(objectName)=&answer(applicationType)=RISK&answer(applicationSubType)=&Navigation=&tabNo=0&answer(teritory)=&answer(territoryName)=&answer(zone)=&answer(showOnetTab)=Y&answer(state)=
									&answer(Object::Risk::ComProperty::CustomerId)=<%= customerId.toString()%>&answer(Object::Risk::ComProperty::ComPropertyId)=<bean:write name="arrOfInCompRiskQmap" property="Object::Risk::ResProperty::RiskId" />&answer(SelectedRiskType)=<bean:write name="arrOfInCompRiskQmap" property="Object::Risk::ResProperty::RiskType" />" title="Click to go to edit Risk Detail">
								...
								<td class="SearchResult">
									<a href="../EditEILRisk.do?TabPanelName=Insured_Panel&answer(Object::Agency::AgencyId)=<%=id.toString()%>&answer(objectId)=0&answer(objectVerId)=0&answer(objectName)=&answer(applicationType)=RISK&answer(applicationSubType)=&Navigation=&tabNo=0&answer(teritory)=&answer(territoryName)=&answer(zone)=&answer(showOnetTab)=Y&answer(state)=
									&answer(Object::Risk::ComProperty::CustomerId)=<%= customerId.toString()%>&answer(Object::Risk::ComProperty::ComPropertyId)=<bean:write name="arrOfInCompRiskQmap" property="Object::Risk::ResProperty::RiskId" />&answer(SelectedRiskType)=<bean:write name="arrOfInCompRiskQmap" property="Object::Risk::ResProperty::RiskType" />" title="Click to go to view this Risk Detail"><bean:write name="arrOfInCompRiskQmap" property="Object::Risk::ResProperty::RiskNumber" /></a>
									<%++i;%> 
								</td>
								<td class="SearchResult">
									<a href="../EditEILRisk.do?TabPanelName=Insured_Panel&answer(Object::Agency::AgencyId)=<%=id.toString()%>&answer(objectId)=0&answer(objectVerId)=0&answer(objectName)=&answer(applicationType)=RISK&answer(applicationSubType)=&Navigation=&tabNo=0&answer(teritory)=&answer(territoryName)=&answer(zone)=&answer(showOnetTab)=Y&answer(state)=
								...
								<td class="SearchResult">
								 ...
								 <td class="SearchResult" align="right">
								 	<bean:define id="resPropId" name="arrOfInCompRiskQmap" property="Object::Risk::ResProperty::RiskId"></bean:define>
		      						<html:checkbox property="answer(Object::Risk::ComProperty::ComPropertyId)" name="arrOfInCompRiskQmap" styleId="<%="addlInterestArray"+commonCount%>" value="<%= resPropId.toString() %>" />
		       					</td>
							</tr>
						</logic:iterate>
					</table>
	...
	<html:hidden property="answer(TabPanelName)" value="<%="Insured_Panel"%>" />
