...
<SCRIPT type="text/javascript" >
	function navigate(nextOrPre)
	{
	 ...
	 formElement.action="../FindUploadClaims.do?answer(Object::Claims::OwnerId)=<%=""+ownerId %>&answer(Object::Claims::PageNum)="+nextOrPre;
...
<html:form action="/FindUploadClaims.do" >
...
<table WIDTH="100%" ALIGN="center" BORDER="0" CELLSPACING="0" CELLPADDING="0">
	...
	<tr>
		<td class="NewSectionHead" align="center" colspan ="10" >Find Claims-Results</td></tr>
	<tr>	
	...
	<logic:present name='ClaimsListSize' scope="request">
		...
		<tr><td class="FormLabels">No. of Claim Records Found:&nbsp;<%=ClaimsListSize1.toString()%></td></tr>
		<tr><td>&nbsp;</td></tr>
	</logic:present>
	<tr>
		<td>
			<table WIDTH="100%" ALIGN="left" BORDER="0" CELLSPACING="2" CELLPADDING="0">
				<logic:present name ='searchresultClaimsDisplay' scope="request">
					...
					<tr>
						<td class="sectionhead" width="3%">S.No</td>
						<td class="sectionhead" width="10%">Policy #</td>
						<td class="sectionhead" width="10%">Claim Policy #</td>
						<td class="sectionhead" width="10%">Claim #</td>
						<td class="sectionhead" width="5%">Claim Sequence #</td>
						<td class="sectionhead" width="10%">Records Status</td>
						...
						<tr>
						    ...
						    <td class="SearchResult" width="10%" id="">
						    	<a href="../GetPolicySummary.do?TabPanelName=Policy_Panel&answer(policyNumber)=<%=searchResultQMap.getString("Object::Claims::PolicyNumber")%>"> 
						   		<%=searchResultQMap.getString("Object::Claims::PolicyNumber")%>	
						   		</a>
						    </td>
						    
						   	<td class="SearchResult" width="10%" id="">
						   		<%=searchResultQMap.getString("Object::Claims::ClaimPolicyNumber")%>
						   	</td>
						  
						   	<td class="SearchResult" width="10%" id="">
						   		<%=searchResultQMap.getString("Object::Claims::ClaimNumber")%>
						   	</td>

						   	<td class="SearchResult" width="5%" id="">
						   	    <%=searchResultQMap.getString("Object::Claims::ClaimSequenceNumber")%>
						   	</td>
						   	
						   	
						   	<td class="SearchResult" width="10%" id="">
						   		<%=searchResultQMap.getString("Object::Claims::RecordStatus")%>
						   	</td>
	...
	<tr>
		<td>
			<bean:define id="policyNumber" name="UploadClaims" property="answer(Object::Claims::PolicyNumber)" /> 
			<bean:define id="claimPolicyNumber" name="UploadClaims" property="answer(Object::Claims::ClaimPolicyNumber)" /> 
			<bean:define id="ClaimNumber" name="UploadClaims" property="answer(Object::Claims::ClaimNumber)" /> 				
			<bean:define id="ClaimSequenceNumber" name="UploadClaims" property="answer(Object::Claims::ClaimSequenceNumber)" /> 
			<bean:define id="RecordStatus" name="UploadClaims" property="answer(Object::Claims::RecordStatus)" /> 
			...
			<html:hidden property="answer(Object::Claims::PolicyNumber)" value="<%=""+policyNumber %>" /> 
			<html:hidden property="answer(Object::Claims::ClaimPolicyNumber)" value="<%=""+claimPolicyNumber %>"/> 
			<html:hidden property="answer(Object::Claims::ClaimNumber)" value="<%=""+ClaimNumber %>"/> 				
			<html:hidden property="answer(Object::Claims::ClaimSequenceNumber)" value="<%=""+ClaimSequenceNumber %>"/> 
			<html:hidden property="answer(Object::Claims::RecordStatus)" value="<%=""+RecordStatus %>"/> 
