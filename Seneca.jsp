...
<table WIDTH="100%" style="height:100%" ALIGN="center" BORDER="0" CELLSPACING="0" CELLPADDING="0">
	...
	<td width="60%" align="center" valign="middle"><IMG SRC="Images/SenecaLogo.JPG" WIDTH="350" HEIGHT="250" BORDER="0" ALT=""></td>
		...
		<%
		 ...
		 session.setAttribute("ownerId","10");
		 session.setAttribute("dbname","java:/jdbc/senecads");
		 session.setAttribute("ReadDS","java:/jdbc/senecads");
		 session.setAttribute("WriteDS","java:/jdbc/senecads");
	...
	<tr>
	   <td>
		...
		<INPUT name="answer(Object::UserDetail::siteId)" type=hidden value="10"/>
		<INPUT name="answer(Object::UserDetail::ownerId)" type=hidden value="10"/>
		<INPUT name="answer(dbname)" type=hidden value="java:/jdbc/senecads"/>
		<INPUT name=ownerId type=hidden value="10"/>
		...
		<INPUT name="answer(PageLogo)" type=hidden value="../Images/SenecaSmallLogo.JPG"/>
