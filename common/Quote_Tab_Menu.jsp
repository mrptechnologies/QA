			...
			try {
				new Ajax.Updater(
					...
					url,
					{
						method: "get",
						onComplete: function(){
						if(document.getElementById("Quote_Panel") != null && document.getElementById("Quote_Panel") != undefined) {
							forwardToLoginPageIfInvalidSession(document.getElementById("Quote_Panel").innerHTML);
						}
								//Do something
							}
					}
			...
			<div class="bd">
				...
				<%if(insType.equals("PC")) {%>
					...
					<dmshtml:dms_static_with_connector ruleName='privilage' property='<%=new String[]{"QUOTE_MENU"}%>' connector='or' negated="true">
						<li class="yuimenubaritem"><a class="yuimenubaritemlabel" href="../QuickquoteRiskAddAction.do?TabPanelName=Quote_Panel&clear=yes">Create Quick Quote</a> </li>
						<li class="yuimenubaritem"><a class="yuimenubaritemlabel" href="../quote/FindQuote.jsp?TabPanelName=Quote_Panel">Find Quote</a> </li>
					...
					<dmshtml:dms_static_with_connector ruleName='privilage' property='<%=new String[]{"DOCUMENT_MENU"}%>' connector='or' negated="true">
						<li class="yuimenubaritem"><a class="yuimenubaritemlabel" href="../documents/Documents.jsp?TabPanelName=Quote_Panel">Documents</a>
							<div id="quote_tab_staticdocuments" class="yuimenu">
								<div class="bd">
									<ul>
										<dmshtml:dms_static_with_connector ruleName='privilage' property='<%=new String[]{"DOCUMENT_MENU"}%>' connector='or' negated="true">
											<li class="yuimenuitem"><a class="yuimenuitemlabel" href="../documents/AdminForms.jsp?TabPanelName=Quote_Panel">Administrative Forms</a></li>
											<li class="yuimenuitem"><a class="yuimenuitemlabel" href="../documents/BenefitAndContact.jsp?TabPanelName=Quote_Panel">Benefit Summary & Contact Info</a></li>
											<%if(strDomainName.indexOf("mica")>=0)
											{%>
												<li class="yuimenuitem"><a class="yuimenuitemlabel" href="../documents/MicaCommissionDocuments.jsp?TabPanelName=Quote_Panel">Commission Documents</a></li>
											<%}%>
										</dmshtml:dms_static_with_connector>
									</ul>
								</div>
				 ...
				 <%}else if(insType.equals("Professional Liability")){%>
				  <dmshtml:dms_static_with_connector ruleName='privilage' property='<%=new String[]{"ENROLLMENT_MENU"}%>' connector='or' negated="true">
				     <li class="yuimenubaritem"><a class="yuimenubaritemlabel" href="../quote/FindQuote.jsp?TabPanelName=Quote_Panel">Existing</a> </li>
     			  </dmshtml:dms_static_with_connector>
