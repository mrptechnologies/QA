...
<SCRIPT type="text/JavaScript" src="../Scripts/JScripts/FindExpiringPoliciesWithNoRenewalQuoteUI3.js"></SCRIPT>
...
<html:form action="/SearchExpiringPoliciesWithNoRenewalsActionUI3.do" onsubmit="return false;">
...
<div class="formpage01">
	<div class="content">
	<div class="formheadnew"><h2 class="left">FIND UPCOMING RENEWALS WITH NO RENEWAL QUOTE</h2></div>
<br class="clear" />
...
<%--  <dmshtml:GetParameterByOwnerId nameInSession="paramValue" ownerId="<%=ownerId.toString()%>" dbname='<%=com.dms.web.util.DbUtils.getReadDS(pageContext)%>' parameterName="EXPIRING_POLICIES_WITH_NO_RENEWAL_QUOTE_DATE_LIMIT" /> --%>
	<%
...
<div class="formcontent" style="width:50%" align="center"><center>
	<html:submit value="Find >" property="Search" styleClass="covbutton" onclick="findExpiringPoliciesWithNoRenewalQuote('../SearchExpiringPoliciesWithNoRenewalsActionUI3.do')"/></center>
</div>
...
<html:hidden property="answer(RenewalSearchType)" value="expiringPolciesWithNoRenewals"/>
