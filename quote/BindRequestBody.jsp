...
<%@ page import="com.dms.ejb.entity.DMSEntityDetail"%>
		...
		<%
			...
			if(parentPolicyId.equalsIgnoreCase("") || parentPolicyId.equalsIgnoreCase("null")) {
				parentPolicyId=request.getParameter("answer(Object::Policy::ParentPolicyId)");
			}
							...
							<tr>
								<td>
									<table WIDTH="100%" ALIGN="center" border="0" CELLSPACING="0" CELLPADDING="0">
										<dmshtml:dms_static_with_connector ruleName='privilage' property='<%=new String[]{"CVSTARR_SUBMISSION_SHOW"}%>' connector='or' negated="false">										
										<tr>
											<td class="NewSectionHead" align="center">BIND REQUEST</td>
										</tr>
										<tr>
											<td>
										...
										<tr>
											<dmshtml:dms_isPresent property='<%=new String[]{"Offered"}%>' value="<%=strParetQuoteStatus.toString()%>" negated="true">
												<td align="center" class="links" colspan="4">
													<INPUT TYPE="Submit" value="Request Binder" class="sbttn1" id="BindRequestSubmit">
												</td>
											</dmshtml:dms_isPresent>
