...
<table WIDTH="95%" ALIGN="center" BORDER="0" CELLSPACING="2" CELLPADDING="0">
	...
	<tr>
		<td class="links">
			...
			<a href="../customer/AddEmployeeCencusApplication.jsp?TabPanelName=<%=""+request.getParameter("TabPanelName")%>&answer(teritory)=<%=""%>&Navigation=&answer(territoryName)=<%=""%>&answer(zone)=<%=""%>&tabNo=0&answer(Object::Customer::CustomerId)=<%=""+custid%>&answer(Object::Employee::EmployeeId)=<%=""+empId%>">Employee Health Application</a>
		</td>
	</tr>
</table>
...
<body>
	...
	objectVerId="0" objectName="EMPLOYEE_EXTENDED" applicationType="EMPLOYEE" applicationSubType="" isSubApplicationCoveredByForm="Yes"  actionName="/saveEmployeeExrndApplicationAction.go" isApplicationEnabled="Y"  showOneTabAtTime="N"/>
