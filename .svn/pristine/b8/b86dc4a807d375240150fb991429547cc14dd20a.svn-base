...
<template:put name='ProgressBar' content='/common/ProgressBarSubCompletedBTA.jsp' />
...
<template:put name='ProgressBar' content='/common/ProgressBarSubCompleted.jsp' />
</dmshtml:dms_static_with_connector>


<template:put name='Header1' content='/submission/SubmissionHeaderBody.jsp' />
<template:put name='GeneralBody' content='/submission/SubmitCompleteApplicationBody3.0.jsp' /> 
