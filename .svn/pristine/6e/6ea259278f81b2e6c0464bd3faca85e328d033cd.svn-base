...
class ComboCELL extends UIComponent
{
	...
	private static var COMBOBOX_DATA_PROVIDER : Array = [{label: "Age", data: "Age"}, 
														 {label: "End Stage Renal", data:"End Stage Renal"}, 
														 {label: "Disability", data:"Disability"}];
	// Constructor:  Should be empty.
	public function ComboCELL()
	{
	}
