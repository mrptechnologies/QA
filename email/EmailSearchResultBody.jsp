...
<SCRIPT type="text/javascript" SRC="../Scripts/JScripts/EmailSearchResult.js"></SCRIPT>
...
<table WIDTH="100%" ALIGN="center" BORDER="0" CELLSPACING="0" CELLPADDING="0">
			...
			<table WIDTH="100%" ALIGN="left" BORDER="0" CELLSPACING="2" CELLPADDING="0">
				<logic:present name ='searchresultEmailDisplay' scope="request">
					...
					<tr>
						...
						<td class="sectionhead" width="25%">Sent Date</td>
					</tr>	
						...
						<tr>
						    ...
						    <td class="SearchResult" width="20%" id="ToAddress">
						   			<%=searchResultQMap.getString("Object::Notification::Email::ToAddress")%> 
						    </td>
						    
						   	<td class="SearchResult" width="25%" id="Subject">
						   		<a href="../EmailReSend.do?answer(Object::Notification::Email::FromAddress)=<%=""+searchResultQMap.getString("Object::Notification::Email::FromAddress")%>&answer(Object::Notification::Email::ToAddress)=<%=""+searchResultQMap.getString("Object::Notification::Email::ToAddress")%>&answer(Object::Notification::Email::ObjectId)=<%=""+searchResultQMap.getString("Object::Notification::Email::ObjectId")%>&answer(Object::Notification::Email::ObjectVerId)=<%=""+searchResultQMap.getString("Object::Notification::Email::ObjectVerId")%>&answer(Object::Notification::Email::ObjectType)=<%=""+searchResultQMap.getString("Object::Notification::Email::ObjectType")%>&answer(Object::Notification::Email::NotificationType)=<%="EMAIL"%>&answer(Object::Notification::Email::NotificationId)=<%=""+searchResultQMap.getString("Object::Notification::Email::NotificationId")%>&answer(Object::Notification::Email::QuoteNumber)=<%=""+searchResultQMap.getString("Object::Notification::Email::QuoteNum")%>&answer(Object::Notification::Email::QuoteSubNumber)=<%=""+searchResultQMap.getString("Object::Notification::Email::QuoteSubNum")%>&answer(Object::Notification::Email::PolicyNumber)=<%=""+searchResultQMap.getString("Object::Notification::Email::PolicyNumber")%>&answer(Object::Notification::Email::QuoteStatus)=<%=""+searchResultQMap.getString("Object::Notification::Email::QuoteStatus")%>&answer(Object::UserDetail::ownerId)=<%=""+ownerId %>" title="Re-Send" onClick="return EmailPopup(this, 'Email');" ><%=searchResultQMap.getEncodedString("Object::Notification::Email::EmailSubject")%> </a> 
						   	</td>
	...
	<tr>
		<td>
			...
			<html:hidden property="answer(Object::Notification::Email::ObjectType)" value="<%=""+objectType %>"/>
