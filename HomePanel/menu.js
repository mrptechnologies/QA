...
oCMenu.fromleft=135 //This is the left position of the menu. (Only in use if menuplacement below is 0 or aligned) (will change to adapt any borders) - Value: px || "%"
...
oCMenu.level[0].bordercolor="156088" //The border color for all level[0] (top) items. - Value: "color"
...
oCMenu.makeMenu('top0','','&nbsp;&nbsp;&nbsp;To Do List','ToDoList.html','','83','26','','')

	
oCMenu.makeMenu('top1','','&nbsp;&nbsp;&nbsp;Submissions','','','104','26','','')
	oCMenu.makeMenu('sub100','top1','&nbsp;&nbsp;New Submission','new_submission.html','', 130,'25')
	oCMenu.makeMenu('sub101','top1','&nbsp;&nbsp;Find Submission','','', 130,'25')

oCMenu.makeMenu('top2','','&nbsp;&nbsp;&nbsp;&nbsp;Quotes','','','75','26','','')
	oCMenu.makeMenu('sub200','top2','&nbsp;New Quote','#','', 110,'25')
	oCMenu.makeMenu('sub201','top2','&nbsp;Find Quote','#','', 110,'25')

oCMenu.makeMenu('top3','','&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Policies','','','85','26','','')
	oCMenu.makeMenu('sub300','top3','&nbsp;Find policy','#','', 110,'25','','','','')

oCMenu.makeMenu('top4','','&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Manage','','','82','26','','')
	oCMenu.makeMenu('sub1400','top4','&nbsp;Agencies','#','', 150,'25','','','','')
	oCMenu.makeMenu('sub1401','top4','&nbsp;Agents','#','', 150,'25','','','','')
	oCMenu.makeMenu('sub1402','top4','&nbsp;Sales Managers','#','', 150,'25','','','','')
	oCMenu.makeMenu('sub1403','top4','&nbsp;User Accounts','#','', 150,'25','','','','')
	oCMenu.makeMenu('sub1404','top4','&nbsp;Alert Management','#','', 150,'25','','','','')
		oCMenu.makeMenu('sub14040','sub1404','&nbsp;Alert Definition','#','', 130,'25','','','','')
			oCMenu.makeMenu('sub140400','sub14040','&nbsp;Add Alert Definition','#','', 140,'25','','','','')
			oCMenu.makeMenu('sub140401','sub14040','&nbsp;Find Alert Definitino','#','', 140,'25','','','','')
			oCMenu.makeMenu('sub140402','sub14040','&nbsp;Delete Alert Definition','#','', 140,'25','','','','')
			oCMenu.makeMenu('sub140403','sub14040','&nbsp;Update Alert Definition','#','', 140,'25','','','','')
		oCMenu.makeMenu('sub14041','sub1404','&nbsp;Alert','#','', 130,'25','','','','')
