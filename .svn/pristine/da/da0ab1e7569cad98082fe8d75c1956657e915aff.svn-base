...
<%="ExpDate = " + ExpDate %>
	...
	<%
		...
		String arrReleaseStatus[] = releaseStatus.split("/");
		String arrExpStatus[] = expStatus.split("/");
		
		String releaseMonth = arrReleaseStatus[0];
		String releaseDate = arrReleaseStatus[1];
		String releaseYear = arrReleaseStatus[2];
		
		String expMonth = arrExpStatus[0];
		String expDate = arrExpStatus[1];
		String expYear = arrExpStatus[2];
		
	%>

	<% boolean readonly = false; %>
	
	<dmshtml:dms_isPresent property="<%=new String[]{"Released","QA"}%>" value="<%=""+documentStatus%>" negated="true">
			...
			<table WIDTH="1200px" ALIGN="center" BORDER="0" CELLSPACING="1" CELLPADDING="0">
				...
				<tr>
					<dmshtml:dms_isPresent property="<%=new String[]{"Released","QA"}%>" value="<%=""+documentStatus%>" negated="true">
						...
						<td width="35%" class="links"><a href="/GetAllVersionOfDocumentDefinitionListAction.do?TabPanelName=<%=""+request.getParameter("TabPanelName") %>&answer(Object::Product::Document::Definition::DocId)=<%= ""+documentId %>&answer(Object::Product::Document::Definition::OwnerId)=<%= ""+ownerId %>&answer(Object::Product::Document::Definition::VerId)=<%= ""+documentVerId %>" >List Document Versions</a></td>
									
					</dmshtml:dms_isPresent>
					
					<td width="35%" class="links"> <a href="../AddDocumentDefinitionAction.do?TabPanelName=<%=""+request.getParameter("TabPanelName") %>&clear=yes">Add Document</a> </td>
				</tr>
									...
									<td class="TextMatter1">
										...
										<table WIDTH="90%" ALIGN="left" BORDER="0" CELLSPACING="0" CELLPADDING="2">
											...
											<tr>
												...
												<td class="links">
													<html:select property="answer(Object::Product::Document::Definition::ReleaseStatus)" styleId="ReleaseStatus" styleClass="txtbox" disabled="<%=readonly%>" >
											...
											<tr>
												...
												<td class="links"><html:text property="answer(Object::Product::Document::Definition::VerName)" styleId="VerName" size="30" maxlength="60" styleClass="txtbox" /></td>
											</tr>											
											...
											<tr>
												...
												<td class="links">
													<html:select property="answer(Object::Product::Document::Definition::DocTemplType)" styleId="DocTemplType"  styleClass="txtbox" >
														...
														<html:option value="DOC">MS Word Doc</html:option>
														<html:option value="DOT">MS Word Template</html:option>
														<html:option value="XSL">EXCEL</html:option>
														<html:option value="XML">XML</html:option>
														<html:option value="TIFF">TIFF</html:option>
														<html:option value="JPEG">JPEG</html:option>
														<html:option value="JIF">JIF</html:option>
													</html:select>
												</td>		
											</tr>
											...
											--><tr>
												...
												<td class="links"><html:text property="answer(Object::Product::Document::Definition::DocTemplUrl)" styleId="DocTemplUrl" size="30" maxlength="60" styleClass="txtbox" /></td>
											</tr>
											...
											<dmshtml:dms_isPresent property="<%=new String[]{"Development"}%>" value="<%=""+documentStatus%>" negated="true">
												<tr>
													<td>&nbsp;</td>
													<td align="left">
											...
											<tr>
												<td>
													...
													<html:hidden property="answer(Object::Product::Document::Definition::CurrentVerId)" styleId="VerId" />	
