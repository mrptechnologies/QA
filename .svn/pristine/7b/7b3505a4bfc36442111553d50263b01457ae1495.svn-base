...
<SCRIPT type="text/javascript" src="../Scripts/JScripts/FindOutBoundGetDataFeedXML.js"></SCRIPT>
...
<html:form action="/FindGetDataFeedXmlDetails.do" onsubmit="return false;">
<div class="formpage01">
<div class="content">
<div class="formheadnew"><h2 class="left">Find GetDataFeed Batch sent to Genius</h2></div>
<div>&nbsp;</div>
...
<input type="submit" value="Find >" class="covbutton" onclick="FindGetDataFeed('../FindGetDataFeedXmlDetails.do')" style="width:90px;">	</center>
</div>
