...
<%				 
 ...
 %>
 	...
 	<div id="divideTabs">
	 	<a href="javascript:void(0);" id="Benefits" onclick="showCommonBenefits(this.id)" class="loctab_inactive left">	
		<div>Benefits</div></a>
		<a href="javascript:void(0);" id="ClassSchedule" onclick="showClassListClassBenefits(this.id);" class="loctab_active left">	
		<div id="ClassListSize">Class Benefits (<%=classSize %>)</div></a>
	</div>	
	
	<div class="locformpage" id="Loc3TableDatas">
		<table border="0" width="100%" cellspacing="0" cellpadding="0" class="">
        	...
        	<logic:iterate id="ClassListArray" name="ClassListArray" >
        	   ...
        	   <bean:define id="ClassBenefitsId"  property="Object::Quote::ClassBenefitsId" name="ClassListArray" />
        	   <%classBenefitsId=""+ClassBenefitsId; %>
        	   <%String strClassDescription =""+ClassDescription; %>
        	   <tr class=<%=className%>>
        	   		<td><div class="yui-dt-liner"><p class="tableData"><a href="javascript:void(0);" onclick="getClassBenefits('<%=ClassBenefitsId%>','<%=newClassName %>')"><%=ClassIndex %></a></p></div></td>
        	   		<td><div class="yui-dt-liner"><p class="tableData"><a href="javascript:void(0);" onclick="getClassBenefits('<%=ClassBenefitsId%>','<%=newClassName %>')"><%=""+newClassName %></a></p></div></td>
        	   	   	<td><div class="yui-dt-liner"><p class="tableData"><%=strClassDescription %></p></div></td>
        	   </tr>
         	   <tr><td> <html:hidden property="answer(ClassBenefitsId)" value='<%=classBenefitsId %>' styleId="RiskIdForPopUp"/></td></tr>        	   
         	   <% if  (ClassIndex%2==0){
	 ...
	 <div id="AddClassDivs" class="locformpages" style="clear:both;display:none">
		<div class="formpage4">
			<div class="content">
				<div class="formhead4"><h2 class="left">Class Benefits Selections</h2></div>      
	...
	<logic:present name='ClassListSize'>
		...
		<html:hidden property="answer(classBenefitsId)" value='<%=""+classBenefitsId%>' styleId="riskIdUpdated" />		
	</logic:present>
