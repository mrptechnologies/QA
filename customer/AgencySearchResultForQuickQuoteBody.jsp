...
<html:form action="/LinkAgencytoCustomerActionForQuickQuote.do">
			...
			<table WIDTH="100%" ALIGN="Left" cellspacing="2" cellpadding="2">
				...
				<tr>
					<td align="Left" class="links" colspan="5">
						<logic:present name="firstAgency"  scope="request">
							<a href="../AgencySearchActionForQuickQuote.do?TabPanelName=<%=""+request.getParameter("TabPanelName") %>&answer(ownerId)=<%=""+ownerId %>&LimitSearch=yes&answer(Object::Agency::PageNum)=0&answer(Agency::Like::BusinessName)=<%=""+businessName%>&answer(Address::Equals::State)=<%=""+agencyState%>&answer(Agency::Equals::OwnerId)=<%=""+ownerId%>">&lt;&lt;First</a>
						</logic:present>&nbsp;&nbsp;
						<logic:present name="prevAgency"  scope="request">
							<a href="../AgencySearchActionForQuickQuote.do?TabPanelName=<%=""+request.getParameter("TabPanelName") %>&answer(ownerId)=<%=""+ownerId %>&LimitSearch=yes&answer(Object::Agency::PageNum)=<%=(Integer.parseInt(""+pagenum)-1)%>&answer(Agency::Like::BusinessName)=<%=""+businessName%>&answer(Address::Equals::State)=<%=""+agencyState%>&answer(Agency::Equals::OwnerId)=<%=""+ownerId%>"><bean:message key="Common.Previous"/></a>
						</logic:present>
					</td>
					
					<td align="right" class="links" colspan="5">
						<logic:present name="moreAgency"  scope="request">
							<a href="../AgencySearchActionForQuickQuote.do?TabPanelName=<%=""+request.getParameter("TabPanelName") %>&answer(ownerId)=<%=""+ownerId %>&LimitSearch=yes&answer(Object::Agency::PageNum)=<%=(Integer.parseInt(""+pagenum)+1)%>&answer(Agency::Like::BusinessName)=<%=""+businessName%>&answer(Address::Equals::State)=<%=""+agencyState%>&answer(Agency::Equals::OwnerId)=<%=""+ownerId%>">Next&gt;&gt;</a>
						</logic:present>&nbsp;&nbsp;
						<logic:present name="lastAgency"  scope="request">
							<a href="../AgencySearchActionForQuickQuote.do?TabPanelName=<%=""+request.getParameter("TabPanelName") %>&answer(ownerId)=<%=""+ownerId %>&LimitSearch=yes&answer(Object::Agency::PageNum)=<%=(Integer.parseInt(""+totpagenum)-1)%>&answer(Agency::Like::BusinessName)=<%=""+businessName%>&answer(Address::Equals::State)=<%=""+agencyState%>&answer(Agency::Equals::OwnerId)=<%=""+ownerId%>">Last&gt;&gt;</a>
						</logic:present>   
					</td>
				</tr>
				...
				<tr>
					<td class=<%= styleClass %>>
					  	 <%=++i%>
					  	 <% ++radioFlag; %>
						<bean:define id="agencySel" name="QuickQuote" property="answer(Agency::AgencyId)" scope="session"/>
...
<!--  -->
				<tr>
					<td align="Left" class="links" colspan="5">
						<logic:present name="firstAgency"  scope="request" >
							<a href="../AgencySearchActionForQuickQuote.do?TabPanelName=<%=""+request.getParameter("TabPanelName") %>&answer(ownerId)=<%=""+ownerId %>&LimitSearch=yes&answer(Object::Agency::PageNum)=0">&lt;&lt;First</a>
						</logic:present>&nbsp;&nbsp;
						<logic:present name="prevAgency"  scope="request" >
							<a href="../AgencySearchActionForQuickQuote.do?TabPanelName=<%=""+request.getParameter("TabPanelName") %>&answer(ownerId)=<%=""+ownerId %>&LimitSearch=yes&answer(Object::Agency::PageNum)=<%=(Integer.parseInt(""+pagenum)-1)%>&answer(Agency::Like::BusinessName)=<%=""+businessName%>&answer(Address::Equals::State)=<%=""+agencyState%>&answer(Agency::Equals::OwnerId)=<%=""+ownerId%>"><bean:message key="Common.Previous"/></a>
						</logic:present>
