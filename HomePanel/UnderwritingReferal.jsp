...
<DIV class="body_Home" id="bodyReferal"  style="display:block;">
		...
		<TBODY>
			<TR>
				<TD class=rowicon_Home>
					<table>
						<tr>
							<td width="12%"><SPAN style="FONT-WEIGHT: normal; WIDTH: 99.9%"><input type="checkbox" style="border: 0px" checked="checked" id="chk1" name="asdf" onclick="onRefCheckClick(this.form)"/>Assigned To You</SPAN></td>
							<td width="3%"></td>
							<td width="12%"><SPAN style="FONT-WEIGHT: normal; WIDTH: 99.9%"><input type="checkbox"  style="border: 0px" checked="checked" id="chk2" name="asdf" onclick="onRefCheckClick(this.form)"/>Un Assigned</SPAN></td>
							<td width="3%"></td>
							<td width="15%"><SPAN style="FONT-WEIGHT: normal; WIDTH: 99.9%"><input type="checkbox" style="border: 0px" checked="checked" id="chk3" name="asdf" onclick="onRefCheckClick(this.form)"/>Assigned To Others</SPAN></td>
							<td width="3%"></td>
						...
						<tr>
							<td colspan="8" width="100%" align="left">
								...
								<br>					
								<div class="locformbox1 yui-skin-sam " id="assigned" style="display:inline;"></div>
								<br>
							</td>
						</tr>
					</table>
