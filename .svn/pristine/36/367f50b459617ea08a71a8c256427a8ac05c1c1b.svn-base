...
<%@ page import="java.util.ArrayList"%>
   <div class="content"> 
	<div class="formpage01">
	 <html:form action="/UpdateEndorsementSectionCoverageDetail.do" styleId="sectionCoverageForm">
		<div class="formheadnew"><h2 class="left"> Section Coverage Details</h2></div>
		  <div>&nbsp;</div>
			<table width= "100%">
			        
			        <tr>
						<td class="field" width="30%" align = "right">Section Type Code :</td>
						<td width="1%">&nbsp;</td>
						<td width="69%' align="left">
						   <html:text property="answer(Object::SectionCoverages::SectionTypeCode)" name="FindOutBoundTransactions" />
						</td>
					</tr>	
				    <tr>
					...
					<html:hidden property="answer(Object::SectionCoverages::ExchangeRate)" name="FindOutBoundTransactions" />
					...
					<html:hidden property="answer(Object::SectionCoverages::SectionDTLClassCode01)" name="FindOutBoundTransactions" />
				    <html:hidden property="answer(Object::SectionCoverages::SectionDTLClassCode04)" name="FindOutBoundTransactions" />
				        ...
				        <tr><td colspan="2">&nbsp;</td></tr>
				         ...
				         <td width="25%">
				          <td width="75%" align="left">
				           <html:button styleClass="covbutton" value="Save" property="save" onclick="submitEndorsementSectionCoverageDetails()" />
