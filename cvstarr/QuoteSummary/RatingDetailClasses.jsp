...
<style>
  ...
  .tableData{
  	line-height:17px;text-align:left;margin:0;padding:0;
  }
...
<div class="formpagenew" style="margin:-30px 0 0 -3px;background:url(i/bodybg1.gif) repeat-x top;">

<div align="left" id="ClassListRatingDetail" >
	<jsp:include page="RatingDetailClassListParent.jsp"/>
</div>
<br class="clear" />
