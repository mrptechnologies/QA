...
<SCRIPT type="text/javascript">
	...
	function CloseWindow(){
	    setTimeout("refreshParentWindow();",10000);
	}
	function loadParent(){
...
<table WIDTH="80%" ALIGN="center">
	...
	<TR>
    	<td class="FormLabels" align="left" height="25">From:</td>
 		<td>
			<html:text property="answer(Object::Notification::Email::FromAddress)" value="<%=request.getAttribute("FromAddress")+"" %>" styleId="ThisFrom" size="80" maxlength="100" disabled="<%=isEnabled%>" />
 		</td>
	...
	<TR>
		...
		<td><html:text property="answer(Object::Notification::Email::ToAddress)" value="<%=request.getAttribute("ToAddress")+"" %>" styleId="ThisTo" size="80" maxlength="500" /></td>
	</TR>    
	
	<TR>
		 <td class="FormLabels" align="left" height="25">Cc:</td>
		 <td>
		   <html:text property="answer(Object::Notification::Email::CcAddress)" value="<%=request.getAttribute("CcAddress")+"" %>" styleId="ThisCc" size="80" maxlength="500"/>          
		 </td>
	</TR>
	
	<TR>
		 <td class="FormLabels" align="left" height="25">Bcc:</td>
		 <td><html:text property="answer(Object::Notification::Email::BccAddress)" value="<%=request.getAttribute("BccAddress")+"" %>" styleId="ThisBcc" size="80" maxlength="500" /></td>
	</TR> 
	...
	<logic:present name="TemplateList" scope="request">  
		<logic:iterate id="TemplateList" name="TemplateList" scope="request">
	        ...
	        <TR>
			    ...
			    <td><html:text property="answer(Object::Notification::Email::EmailSubject)" value="<%=""+Subject%>" styleId="ThisSubject" size="80" maxlength="100" /></td>
   			</TR>
			...
			<tr>
				<td align="center">	
					<html:reset value=" " onmouseover="style.cursor='hand'" styleClass="resetbutton" /> 
							&nbsp;&nbsp;&nbsp;
					<input type="button" value=" " styleId="SendEmail" name="button" onclick="viewMailDetails();enableIndicator();" class="sendbutton" onmouseover="style.cursor='hand'"/>
