...
<tr><td>&nbsp;</td></tr>
	...
	<tr><td class="links">
		...
		<dmshtml:dms_static_with_connector ruleName='privilage' property='<%=new String[]{"ADD_AGENT_MENU"}%>' connector='or' negated="true">
		  ...
		  <a href="../AddAgents.do?TabPanelName=<%=""+request.getParameter("TabPanelName")%>&clear=yes"  title="Click to go to the Add General Agency Page" />Add Agent</a> 
		...
		<dmshtml:dms_static_with_connector ruleName='privilage' property='<%=new String[]{"FIND_AGENT_MENU"}%>' connector='or' negated="true">
			<IMG SRC="../Images/bullxred.gif" WIDTH="20" HEIGHT="20" BORDER="0" ALT="">
		  <a href="../FindAgent.do?TabPanelName=<%=""+request.getParameter("TabPanelName")%>&clear=yes"  title="Click to go to the Add Agency Page" />Find Agent</a> 
