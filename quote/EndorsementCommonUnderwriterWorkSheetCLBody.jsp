...
<html:form action="/SaveEndorsementQuoteUnderwriterStatusAction.do" styleId="SaveQuoteUnderwriterStatusAction" onsubmit="return validateForm(this);">
			...
			<table width="764px" align="Left" border="0" >
				<tr>
					...
					<dmshtml:isFeatureAvailableForProductRoleStatus roleId='<%=Long.parseLong(""+objDescId) %>' productId='<%=Long.parseLong(""+ProductId) %>' dbName='<%=com.dms.web.util.DbUtils.getReadDS(pageContext)%>' featureId="CREATE_RENEWAL_PDF" 
														property='<%=new String[]{"Sold","Offered","Accepted"}%>' value="<%=paretQuoteStatus.toString()%>" negated="true">
									
									
						   <a href="../QuoteProposalPdf.go?TabPanelName=Quote_Panel&answer(DocumentType)=PROPOSAL&answer(QuoteId)=<%= ""+parentQuoteId%>&answer(OwnerId)=<%=ownerId.toString()%>&answer(Object::Customer::CustomerId)=<%=customerId.toString()%>&answer(Object::Agency::AgencyId)=<%=agencyId.toString()%>&answer(parentQuoteId)=<%=parentQuoteId.toString()%>&answer(policyNumber)=<%=""+policyNumber%>&answer(Object::Policy::ParentPolicyId)=<%=""+parentPolicyId %>&answer(Object::Policy::ParentPolicyVerId)=<%=""+parentPolicyVerId%>&answer(Object::Quote::ProductId)=<%=""+ProductId%>&answer(isRenewalEndorsement)=YES">
							<IMG SRC="../Images/pdficon.gif" WIDTH="15" HEIGHT="15" BORDER="0" ALT="">Renewal PDF</a>			
	...
	<tr><td>&nbsp;</td></tr>
				<tr>
					<td class="SearchResult" align="left" width="20%">
						Umbrella Underwriting Grade
					</td>
					<td class="SearchResult" align="left" width="20%">
						<html:select property="answer(Object::Plan::UnderWriterTier)" styleClass='txtbox' >
				...
				<tr>
					<td class="SearchResult" align="left" width="20%">
						Package Rate Modification Factor 
					</td>
					<td class="SearchResult" align="left" width="20%">
						<html:text styleId="RateModificationFactor" property="answer(Object::PlanFactor::RateModificationFactor)" name="UWWorkSheet" styleClass="txtbox" maxlength="5" size="5"/>						
					</td>
				</tr>
				<tr>
					<td class="SearchResult" align="left" width="20%">
					...
					<td class="SearchResult" align="left" width="20%">
					<%
						String isTerrorismCoverage ="";
						isTerrorismCoverage= ""+certifiedActsOfTerrorismCoverage;
						if(isTerrorismCoverage.equalsIgnoreCase("y")){ %>
							<html:text styleId="TerrorismFactor" property="answer(Object::PlanFactor::TerrorismFactor)" name="UWWorkSheet" styleClass="txtbox" maxlength="5" size="5"/>
					<%}else{ %>
						<html:text styleId="TerrorismFactor" property="answer(Object::PlanFactor::TerrorismFactor)" disabled="true" name="UWWorkSheet" styleClass="txtbox" maxlength="5" size="5"/>
					<%} %>
					</td>
				</tr>
				<tr>
					...
					<td class="SearchResult" align="left" width="20%">
						<html:text styleId="JudgementFactor" property="answer(Object::PlanFactor::JudgementFactor)" name="UWWorkSheet" styleClass="txtbox" maxlength="5" size="5"/>
					</td>
				</tr>	
	...
	<tr><td>&nbsp;</td></tr>
		<tr>
			...
			<table border="0" cellspacing="0" cellpadding="0" align="center"
				width="100%">
				<tr>
					<td class="sectionhead" align="center">First Layer And Additional Layer Calculations</td>
				</tr>
			</table>
			</td>
		</tr>
			...
			<tr>
				<td width="60%">
					<table border="0" cellspacing="3" cellpadding="0" WIDTH="50%">
						...
						<tr>								
							...
							<td class="SearchResult" align="left" >
								...
								<% double subQuoteTotal = 0;
									...
									try{
										CommissionPercent = (new Double(""+parentOwnerCommissionPercent)).doubleValue();
									}catch(Exception ex){}
								%>
						<tr>							   
							<td class="SearchResult" align="left" width="40%">
						...
						<%if(paretQuoteStatus.toString().equalsIgnoreCase("In Progress") || paretQuoteStatus.toString().equalsIgnoreCase("Bind Request") || paretQuoteStatus.toString().equalsIgnoreCase("Offered") || paretQuoteStatus.toString().equalsIgnoreCase("Submitted")){%>
							<tr>
...
<dmshtml:IsRenewalEndorsement productId='<%=""+ProductId%>'dbname='<%=com.dms.web.util.DbUtils.getReadDS(pageContext)%>' ownerId="<%=Long.parseLong(""+ownerId)%>" ></dmshtml:IsRenewalEndorsement>
  <% String isRenewalEndorsement = (String) request.getAttribute("isRenewalEndorsement"); 
