...
<html:form action="/SearchClearanceFailureActionUI3.do">
	...
	<div class="formpageinsured">
		...
		<div id="divCompany">
		<div class="field"  style="width:463px ;" id="company_legal_name1"><font color="red">*&nbsp;Legal Name / DBA</font>:<html:text name="AddCustomer" property="answer(Object::Clearance::LegalName1)" size="110" maxlength="110" styleClass="txtbox" styleId="LegalName1" /></div><!--
		...
		<%-- <div class="field" style="text-align: right ; width:450px ;"><font color="red">*</font>&nbsp;Zip Code:
			...
			<div class="field" id="zipcodeAutoComplete" style="text-align:right; width:167px ;float:left"><font color="red">*Zipcode or City Name</font>:
		...
		<div class="field" style="width:505px ;text-align: left;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="red">*</font> &nbsp;Proposed Effective Date:     
			<dmshtml:dms_text property="answer(Month)" size="2" style="width:40px;"	maxlength="2" styleClass="txtbox" styleId="csdmm" onkeyup="validateDate(12,this,'Month');" />&nbsp;
			<dmshtml:dms_text property="answer(Date)" size="2" style="width:40px;"	maxlength="2" styleClass="txtbox" styleId="csddd" onkeyup="validateDate(31,this,'Date');" />&nbsp;
			<dmshtml:dms_text property="answer(Year)" size="2" style="width:80px;  " maxlength="4" styleClass="txtbox" styleId="csdyy" onkeyup="var dat = new Date();var currentyear = dat.getFullYear();validateDate(currentyear+1,this,'Year');"/> (MM/DD/YYYY) 
		</div>
		...
		<div class="field" style="text-align:left; width:290px ;float:left;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="red">*</font>&nbsp;Proposed Effective Date:    
          <div style="text-align:left; width:590px;float:right;margin:-20px 0px 0px 170px" id="proposedEffectiveDate" ></div>
		...
		<div class="field">
			<input type="button" class="covsmallbutton" value="Next"  onclick="submitClearance(this.form)" style="width:100px;">	
			</div>
...
function  submitClearance(frm){
	 var strDate = document.getElementById('ProposedEffectiveDate1').value;
	...
	if(result!=false){
	//searchClearance();
	 frm.action = "../ClearanceAction3.0.do";  
	   frm.submit();   
	}
 }
...
<script type="text/javascript">
   			Ext.onReady(function(){
   				 ...
   				 var effDate = Ext.getCmp('ProposedEffectiveDate1').getValue();  
   				 var MM = effDate.getMonth()+1;
				 var DD = effDate.getDate();
				 var YY = effDate.getFullYear();		   
   				 document.forms[0].ProposedEffectiveDate.value =YY+'-'+MM+'-'+DD; 
   				 document.forms[0].ProposedEffectiveDate1.value =YY+'-'+MM+'-'+DD; 
				 ...
				 if (isNaN(dmonth) || dmonth < 1 || dmonth > 12 || isNaN(dday) || dday < 1 || dday > 31 || isNaN(dyear) || strDate.substring(2, 3)!="/" || strDate.substring(5, 6)!="/" || strDate.length>10)
				 {	
					alert("Please enter Effective Date in 'MM/DD/YYYY' format");
					Ext.getCmp('ProposedEffectiveDate1').setValue('<%=""+today%>');
					document.forms[0].ProposedEffectiveDate1.value = '<%=""+today%>';
					document.forms[0].ProposedEffectiveDate.value = '<%=""+today%>';
					return false;
			 	 }else{
   					 var effDate = Ext.getCmp('ProposedEffectiveDate1').getValue();  
   					 var MM = effDate.getMonth()+1;
   				...
   				Ext.EventManager.on('ProposedEffectiveDate1', 'blur', blurHandler);   				   				
  			});
	</script>
