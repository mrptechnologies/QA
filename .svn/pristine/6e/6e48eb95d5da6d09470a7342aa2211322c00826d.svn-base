...
<template:put name='ProgressBar' content='/cvstarr/ProgressBarClasses.jsp' />
<template:put name='Header1' content='/submission/SubmissionHeaderBody.jsp' />
<template:put name='GeneralBody' content='/cvstarr/GetSubmissionLocationListBody3.0.jsp' /> 
