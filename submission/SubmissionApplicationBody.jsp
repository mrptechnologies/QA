...
objectVerId="0" objectName='<%="GENERAL QUESTION SUBMISSION"%>' applicationType="SUBMISSION" applicationSubType="" isSubApplicationCoveredByForm="Yes"  actionName="/saveSubmissionGeneralQuestionApp.go" isApplicationEnabled="Y"  showOneTabAtTime="N"/>
