...
<bean:define id="ownerId" property="answer(Object::Activity::OwnerId)" name="SearchActivityManagerAction2" />
<bean:define id="intPageNum" property="answer(Object::Activity::PageNum)" name="SearchActivityManagerAction2" />
<bean:define id="objId" property="answer(Object::Activity::ObjectId)" name="SearchActivityManagerAction2" />
<bean:define id="agencynameId" property="answer(Object::Agency::BusinessName)" name="SearchActivityManagerAction2" />

<SCRIPT type="text/javascript" >
	function navigate(nextOrPre)
	{
	 var formElement=document.forms[0];
	 formElement.action="/SearchActivityManagerAction2.do?TabPanelName=<%=""+request.getParameter("TabPanelName") %>&answer(Object::Agency::BusinessName)=<%= ""+agencynameId %>&answer(Object::Activity::PageNum)="+nextOrPre;
	    document.forms[0].submit();
	}
</SCRIPT>
<!-- formElement.action="../SearchActivityManagerAction2.do?answer(Object::Activity::PageNum)="+nextOrPre; -->
<%intPageNum = ""+request.getAttribute("pageNum");%>

<html:form action="/SearchActivityManagerAction2.do">
...
<table WIDTH="98%" ALIGN="center" BORDER="0" CELLSPACING="2" CELLPADDING="0">	
	...
	<tr>
		<td class="NewSectionHead" colspan="4" align="center">AGENCY ACTIVITY LIST</td>
		...
		<td>
			...
			<tr height="30">
				...
				<tr>			
					...
					<td class="sectionhead" width="11%" align="left">
						 Performed By
				...
				<a id="editAgencyPageLink" style="display: none;" href="../EditAgencies.do?TabPanelName=<%=""+request.getParameter("TabPanelName") %>&agencyId=<%=""+objId%>&primaryObjectId=<%=""+objId%>&primaryObjectType=AGENCY" title="<bean:message key='ToolTip.AgencyList.AgencyName'/>"></a>
				<html:reset value="Back" onclick="goToEditAgencyPage();" styleClass="sbttn"/>
			</table>
			
		</td>
	</tr>
	<bean:define id="ActivityId" name="SearchActivityManagerAction2" property="answer(Object::Activity::ActivityId)" />
	<bean:define id="ObjectStatus" name="SearchActivityManagerAction2" property="answer(Object::Activity::ObjectStatus)" />
	<bean:define id="ActivityType" name="SearchActivityManagerAction2" property="answer(Object::Activity::ActivityType)" />
	<bean:define id="ObjectId" name="SearchActivityManagerAction2" property="answer(Object::Activity::ObjectId)" />
	<bean:define id="ObjectVerId" name="SearchActivityManagerAction2" property="answer(Object::Activity::ObjectVerId)" />
	<bean:define id="CreatedBy" name="SearchActivityManagerAction2" property="answer(Object::Activity::CreatedBy)" />
	<bean:define id="UpdatedBy" name="SearchActivityManagerAction2" property="answer(Object::Activity::CreatedBy)" />
	<bean:define id="CreatedBeginDate" name="SearchActivityManagerAction2" property="answer(Object::Activity::CreatedBeginDate)" />
	<bean:define id="CreatedEndDate" name="SearchActivityManagerAction2" property="answer(Object::Activity::CreatedEndDate)" />
	<bean:define id="UpdatedBeginDate" name="SearchActivityManagerAction2" property="answer(Object::Activity::UpdatedBeginDate)" />
	<bean:define id="UpdatedEndDate" name="SearchActivityManagerAction2" property="answer(Object::Activity::UpdatedEndDate)" />
...
<script type="text/javascript">
function goToEditAgencyPage() {
	if(document.getElementById("editAgencyPageLink") != null && document.getElementById("editAgencyPageLink") != undefined) {
		document.location = document.getElementById("editAgencyPageLink").href;
	}
}
</script>