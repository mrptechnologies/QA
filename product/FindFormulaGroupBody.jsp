...
<html:form action="/FindFormulaGroup.do" >
...
<tr>
	<td class="NewSectionHead" colspan="4" align="center">FIND FORMULA GROUP</td>
</tr>
...
<tr><td class="sectionhead" colspan ="2" align="center" >FORMULA GROUP DETAILS</td></tr>
		    <tr><td>&nbsp;</td></tr>
	...
	<tr>
		...
		<td align="left" ><html:text  property="answer(Rule::Like::FormulaGroupName)" size="40" style="class:txtbox"/></td>
	</tr>
