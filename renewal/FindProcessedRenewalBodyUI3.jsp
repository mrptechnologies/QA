...
<SCRIPT type="text/JavaScript" src="../Scripts/JScripts/FindProcessedRenewalUI3.js"></SCRIPT>
...
<html:form action="/SearchProcessedRenewalActionUI3.do" onsubmit="return false;">
...
<div class="formpage01">
	<div class="content">
	<div class="formheadnew"><h2 class="left">FIND ALREADY PROCESSED RENEWALS</h2></div>
<br class="clear" />
...
<div class="field" style="width:490px">Renewed Policy Status:
...
<div class="field" style="width:654px">Renewed Policy Effective Start Date:
...
<div class="field" style="width:654px">Renewed Policy Effective End Date:
...
<div class="field" style="width:654px">Renewed Policy Created Start Date:
...
<div class="field" style="width:654px">Renewed Policy Created End Date:
...
<div class="formcontent" style="width:50%" align="center"><center>
	<html:submit value="Find >" property="Search" styleClass="covbutton" onclick="findProcessedRenewals('../SearchProcessedRenewalsActionUI3.do')"/></center>
</div>
...
<html:hidden property="answer(RenewalSearchType)" value="processedRenewals"/>
