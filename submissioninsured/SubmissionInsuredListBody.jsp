...
<bean:define id="customerId" property="answer(Object::Submission::Insured:Id)" name="AddCustomer"/>
<html:form action="/XMLGeneratorAction" >
	...
	<table WIDTH="100%" ALIGN="center" BORDER="0" CELLSPACING="2" CELLPADDING="0">
		...
		<tr>
			<td class="NewSectionHead" colspan="4" align="center">SUBMISSION LIST</td>
		</tr>
		...
		<tr><td>&nbsp;</td></tr>
			...
			<tr><td class="FormLabels">No of Submission Found:&nbsp;<%=customersSize1.toString()%>
			</td></tr>
		</logic:present>
		...
		<dmshtml:dms_static_with_connector ruleName='privilage' property='<%=new String[]{"ADD_LIU_INSURED_MENU"}%>' connector='or' negated="true">
				<li class="yuimenuitem"><a class="yuimenuitemlabel" href='../CreateSubmissionForInsured.do?TabPanelName=Submission_Panel&answer(Object::Submission::Insured:Id)=<%=""+customerId%>&answer(Object::Submission::ClearanceStatus)=<%="Cleared"%>&answer(Object::Submission::Status)=<%="In Progress"%>&answer(Object::ExistingInsured)=<%="YES"%>'>Create a New Submission</a></li>
		</dmshtml:dms_static_with_connector>		
	...
	<html:hidden property="answer(Object::Submission::Insured::Id)" value='<%=""+CustomerId %>' />
		...
		<tr>
			<td>
				<table WIDTH="100%" ALIGN="Left" cellspacing="5" cellpadding="2">
					...
					<bean:define id="id1" name="FindCustomerXml" property="answer(1*Customer::Equals::SearchObjectId)"/>
					...
					<tr>
						...
						<td align="right" class="links" colspan="14">
					...
					<tr>
						<td class="sectionhead" width="4%" valign="top">
						...
						<dmshtml:dms_static_with_connector ruleName='privilage' property='<%=new String[]{"DATABASE-ID-VIEW"}%>' connector='or' negated="true">	
						      	<td class="sectionhead" width="10%">Submission <br>Id</td>
						</dmshtml:dms_static_with_connector>
						
						<td class="sectionhead" valign="top" width="8%">
							Submission Number
						</td>

						<td class="sectionhead" valign="top" width="11%">
							Submission Name
						</td>
						<td class="sectionhead" align="top" width="7%">
							Submission Status
						</td>
						<td class="sectionhead" align="top" width="7%">
							Clearance Status
						</td>
						<td class="sectionhead" valign="top" width="7%">
							Insured Name Type
						</td>					
						<td class="sectionhead" valign="top" width="6%">
							DBA
						</td>
						<td class="sectionhead" valign="top" width="8%">
							Broker Name
						...
						<td class="sectionhead" valign="top" width="5%">
						...
						<td class="sectionhead" valign="top" width="50%">
							Created Date
						</td>
						<td class="sectionhead" valign="top" width="8%">
							Updated By
						</td>
						<td class="sectionhead" valign="top" width="25%">
							Updated Date
						</td>
					...
					<tr>
						...
						<%String copySubmissionID = "window.location=document.getElementById('Copy_Submission_"+i+"');this.disabled=true;"; %>		
							<a href="/CopySubmissionInsured.do?answer(TabPanelName)=Submission_Panel&answer(Object::Customer::Status)=<%=""+status %>&answer(Object::Customer::Like::SubmissionNumber)=<%=""+submissionNumber %>&answer(Object::Customer::Like::customerName)=<%=""+customerName %>&answer(Object::Customer::PageNum)=0&answer(requestForm)=Submission&answer(Object::Application::ApplicationType)=SUBMISSION_APPLICATION&answer(Object::Submission::SubmissionId)=<%=""+qmap.getString("Object::Submission::SubmissionId")%>&answer(Object::Submission::SubmissionVerId)=<%=""+qmap.getString("Object::Submission::SubmissionVerId")%>&answer(Object::Submission::Insured::Id)=<%=""+cId%>&answer(Object::Submission::InsuredId)=<%=""+cId%>&answer(Object::Customer::CustomerId)=<%=""+cId%>&answer(Agency::AgencyId)=<%=""+qmap.getString("Object::Submission::AgencyId")%>&answer(AgentId)=<%=""+qmap.getString("Object::Submission::AgentId")%>" id='<%="Copy_Submission_"+i %>' /></a><html:button styleClass="linkButton" property="answer(CopySubmission)" value="Copy" onclick='<%=""+copySubmissionID %>'/>					        					
					</td>
					</tr>
					<!--/logic:iterate-->
					<%}%>
