...
<table WIDTH="95%" ALIGN="center" border="0" CELLSPACING="0" CELLPADDING="0">
	...
	<%
		...
		{
			isRenewalEndorsement = request.getParameter("isRenewal");
				...
				<tr>
					<td align="left" colspan=2>
						<table width="950px" align="left" border="0" >
							<tr>
							<td class="NewSectionHead" align="center">LAPSE QUOTE</td>
							</tr>
						</table>
					</td>
				</tr>			
...
<tr><td>
					...
					<table  ALIGN="left" border="0"  CELLPADDING="0" class="SubjectivityPage">						
						<tr><td><div class="Subjectivityformhead"><h2 class="left">Lapse QUOTE</h2><br/></div></td></tr>						
