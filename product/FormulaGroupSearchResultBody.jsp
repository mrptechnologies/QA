				...
				<tr>
					<td colspan="3">
						<table WIDTH="1200px" ALIGN="left" BORDER="0" CELLSPACING="0" CELLPADDING="0">
							<tr>
								<td class="NewSectionHead" colspan="4" align="center">SEARCH FORMULA GROUP RESULT</td>
							</tr>
...
<bean:define id="groupSize" name='grpSize' scope='request'/>
	...
	<tr><td class="FormLabels">Number of Formula Groups found : <%=""+groupSize%></td></tr>
	<tr><td>&nbsp;</td></tr>
	</table>
</logic:present>
...
<bean:define id="objectType" name="objectType" scope="request" />
	...
	<a href="../ListFormula.do?TabPanelName=<%=""+request.getParameter("TabPanelName")%>&answer(Object::Rule::PageNum)=0&answer(Rule::Equals::OwnerId)=<%=""+ownerId%>&answer(isFormula)=Yes&answer(objectType)=<%=""+objectType%>&answer(Object::Rule::FormulaGroupId)=<bean:write name='searchresultnewDisplay' property='answer(Object::Rule::FormulaGroupId)' />" >
	<bean:write name="searchresultnewDisplay" property="answer(Object::Rule::FormulaGrpName)" /></a>							</logic:present>	
			</td>
			<td class="SearchResult"><bean:write name="searchresultnewDisplay" property="answer(Object::Rule::FormulaGrpDesc)" />
			</td>
		</tr>
