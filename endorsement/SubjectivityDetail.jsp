							...
							<tr>
								<td width="100%">																											
									...
									<tr>
										...
										<html:button property="answer(Submit)" onclick="updateEndorsementSubjectivityDetail(this.form)" value="Save" styleClass="subbutton" />
										</td>
										...
										<tr class="locformhead1">
		               						 <td class="datadispcolhead" width="100%" >
		               						 	<table border="0" id="table5" cellspacing="0" cellpadding="0">
														...
														<td>&nbsp;&nbsp;&nbsp;</td>
														<td>
															<a href="javascript:void(0)" onclick="document.getElementById('subjectivityAlertObjectType').value='Subjectivity';showAttach('<%=""+quoteSubjId %>','0','Subjectivity');" class="button2" style="width:100px">Add File</a>
														</td>
														<td>&nbsp;&nbsp;&nbsp;</td>
