...
<html:form action="/LinkOptionToProduct">
...
<tr><td>&nbsp;</td></tr>
<tr><td class="MH">
LINK OPTIONS AND PRODUCT
</td></tr>
<tr><td class="TextMatter">
Use this page to link options to product
<br>
</td></tr>
...
<td class="FormLabels" align="left">Select option(s) to be linked to the product</td></tr>
<tr><td>
...
<tr>
		<td width="15%"><dmshtml:get_available_options nameInSession="arrOptions" ownerId="<%=Long.parseLong(""+ownerId)%>" productId="<%=Long.parseLong(request.getParameter("answer(Object::Product::ProductId)").toString())%>" dbname="<%=com.dms.web.util.DbUtils.getReadDS(pageContext)%>"/>
		<dmshtml:dms_select  property="answer(Object::Product::OptionId)" styleId="possible" multiple="true" size="7" >
			<logic:present name="arrOptions" scope="request">
           <logic:iterate id="options" name="arrOptions" scope="request" >
					 <bean:define id='optionId' name="options"  property="optionId" />
		    <bean:define id='optionName' name="options"  property="optionName" />
...
<td width="30%"><dmshtml:get_product_options nameInSession="arrProdOptions" ownerId="<%=Long.parseLong(""+ownerId)%>" productId="<%=Long.parseLong(request.getParameter("answer(Object::Product::ProductId)").toString())%>" dbname="<%=com.dms.web.util.DbUtils.getReadDS(pageContext)%>"/>
		<dmshtml:dms_select  property="answer(Object::ProductOptions::OptionId)" styleId="chosen" multiple="true" size="7" >
	...
	<tr><td align="center">
		<html:submit value="Save" styleClass="sbttn" onclick="return allSelect()"/>
			...
			<tr><td class="sectionhead1" >Note: The order in the above Selected options list will be taken as the order for the Selected Coverages & Limits Page</td></tr>
</table>
<bean:define id="userName" property="answer(Object::UserDetail::userName)" name="LoginPage" scope="session"/> 
<html:hidden property="answer(Object::Entity::User)" value="<%=userName.toString()%>" />
<html:hidden property="answer(objectType)" value="productOption" />
