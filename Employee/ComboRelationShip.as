...
class ComboRelationShip extends UIComponent
{
	...
	private static var COMBOBOX_DATA_PROVIDER : Array = [{label: "Select", data:"Default"},
														 {label: "Child", data:"Child"},
														 {label: "Adopted", data:"Adopted"},
														 {label: "Stepchild", data:"Stepchild"},
														 {label: "Other", data:"Other"}];
	// Constructor:  Should be empty.
	public function ComboRelationShip()
	{
	}
