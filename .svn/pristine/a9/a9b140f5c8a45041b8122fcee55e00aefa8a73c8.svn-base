...
<template:put name='Header1' content='/common/NewInsuredHeader.jsp' />
<template:put name='ProgressBar' content='/common/ProgressBarAddPolicyDetail.jsp' />
<template:put name='GeneralBody' content='/policy/AddPolicyDetailBody.jsp' /> 
