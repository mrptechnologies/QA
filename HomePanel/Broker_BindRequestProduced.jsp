...
function loadBindReq(){
    YAHOO.example.XHR_Text = function() {
       ...
       var moreColumnDefs = [           
            ...
            {key:"Insured Name", formatter:formatInsuredUrl, resizable:"true",width:205},
            {key:"State", resizable:"true",width:50},
            {key:"Status", resizable:"true",width:195},
        ...
        anotherDataSource.responseSchema = {
            ...
            fields: ["Date","Quote #","Insured Name","State","Status","Priority","Delete","Quote Url","Insured Url","CustomerId","QuoteId","AgencyId","UserId","Quote PanelName","Insured PanelName","OwnerId","AlertId"]
        };
