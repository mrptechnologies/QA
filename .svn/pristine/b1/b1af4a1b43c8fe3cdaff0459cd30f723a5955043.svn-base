...
<table width="90%" align="center" border="0" >
			...
			<tr >					
				...
				<td class="sectionhead" width="20%">SubApplicationName</td>
				<td class="sectionhead" width="20%">Description</td>
...
<logic:iterate id="searchresultnewDisplay" name="searchresultnewDisplay" scope="request" >		
		<tr>
			...
			<td class="SearchResult">
			<a href="../GetSubApplicationVersionAction.do?TabPanelName=<%=""+request.getParameter("TabPanelName") %>&answer(SubApplicationId)=<bean:write name="searchresultnewDisplay" property="answer(Object::Application::SubApplicationId)" />&answer(SubApplicationVerId)=<bean:write name="searchresultnewDisplay" property="answer(Object::Application::SubApplicationVerId)" />"><bean:write name="searchresultnewDisplay" property="answer(Object::Application::SubApplicationName)" /></a>			
			</td>
			<td class="SearchResult"><bean:write name="searchresultnewDisplay" property="answer(Object::Application::SubApplicationDesc)" />
			</td>
			<td class="SearchResult"><bean:write name="searchresultnewDisplay" property="answer(Object::Application::SubApplicationVerNum)" />
			</td>
