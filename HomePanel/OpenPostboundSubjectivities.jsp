...
<DIV  id=headPostBound>
<%//	<SPAN class=subFirst_Home>open post-bound subjectivities</SPAN> %>
</DIV>

<DIV class=body_Home id=bodyPostBound  style="display:block;">	
		...
		<TBODY>
			<TR>
				<TD class="rowicon_Home">
					<table>
						<tr>
							<td width="12%"><SPAN style="FONT-WEIGHT: normal; WIDTH: 99.9%"><input type="checkbox" style="border: 0px" checked="checked" id="clchk1" name="asdf" onclick="onPostboundCheckClick(this.form)"/>Assigned To You</SPAN></td>
							<td width="3%"></td>
							<td width="12%"><SPAN style="FONT-WEIGHT: normal; WIDTH: 99.9%"><input type="checkbox"  style="border: 0px" checked="checked" id="clchk2" name="asdf" onclick="onPostboundCheckClick(this.form)"/>Un Assigned</SPAN></td>
							<td width="3%"></td>
							<td width="15%"><SPAN style="FONT-WEIGHT: normal; WIDTH: 99.9%"><input type="checkbox" style="border: 0px" checked="checked" id="clchk3" name="asdf" onclick="onPostboundCheckClick(this.form)"/>Assigned To Others</SPAN></td>
							<td width="3%"></td>
						...
						<tr>
							...
							<br>
							<div class="locformbox1 yui-skin-sam "  id="postBoundassigned" style="display:inline;"></div>
							<br>
							</td>
						</tr>
...
function loadOpenPostBoundSubj(){
    YAHOO.example.XHR_Text = function() {
       ...
       var moreColumnDefs = [
            ...
            {key:"Insured Name", resizable:"true",width:125},
            {key:"Broker", resizable:"true",width:140},
            {key:"Priority", formatter:formatPriorityUrl, resizable:"true",width:45},
