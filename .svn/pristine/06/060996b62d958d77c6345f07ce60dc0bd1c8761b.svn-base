...
*/	 
	 ...
	 var errorMessage_InsSectionACoverageReason:String =  "Section A. has not been completely answered on the Employee Waiver page.";
	...
	*/	
		 ...
		 */
		 if(alertmsg.length>0) {
			var err_msg="To submit this application complete the following information:"
			err_msg = err_msg+"\n\n"+alertmsg; 
	...
	executeInsSubmissionRule = function() {					
		...
		if(validateWaiveEmployeeSubmission(global_employee_XML) && validateWaiveEmployeeExtendedSubmission(global_employee_XML_Extended)) {			
			...
			if(errorMessage_InsSectionA!="" || errorMessage_InsSectionACoverageReason!=""){
