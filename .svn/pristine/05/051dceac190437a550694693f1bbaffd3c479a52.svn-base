	...
	<tr>
		<td>
			<table WIDTH="1200px" ALIGN="Right" border="0"CELLSPACING="2" CELLPADDING="0">
				<logic:present name="agentUploaded">
					<tr>
						<td class="Error"> 
				...
				<logic:present name="AgencyNotFound">
					<tr>
						<td class="Error"> 
							<%= ""+request.getAttribute("AgencyNotFound") %>
						</td>
					</tr>		
					<tr>
						<td>&nbsp;</td>
				...
				<logic:present name="agentUploadeFailed">
					<tr>
						<td class="Error"> 
							Agent Import -Failed
						</td>
					...
					<td>
						<table WIDTH="1200px" ALIGN="Right" border="0"CELLSPACING="2" CELLPADDING="0">
							...
							<tr>
								...
								<td>
									<html:form action="/AgentImport.do" enctype="multipart/form-data">
									<table border="0" width="10%" cellspacing="2" cellpadding="2"
										...
										<tr>
											<td class="FormLabels" nowrap align="left">
												Select Agent file (.xml) to import :
											</td>
											<td>
										...
										<tr>
											<td colspan="3">
												&nbsp;
												<html:hidden property="answer(Object::XMLUpload::Agent::CreatedBy)" value="<%=usernameId.toString()%>" />
