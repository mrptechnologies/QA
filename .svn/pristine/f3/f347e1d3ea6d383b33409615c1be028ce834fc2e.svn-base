...
<template:put name='ProgressBar' content='/cvstarr/ProgressbarSubCompleted.jsp' />
<template:put name='Header1' content='/submission/SubmissionHeaderBody.jsp' />
<template:put name='GeneralBody' content='/cvstarr/SubmitCompleteApplicationBody3.0.jsp' /> 
