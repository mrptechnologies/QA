...
java.lang.String policyNumber = quoteQMap.getString("Object::QuoteHeader::PolicyNum");
...
if(i==0){%>
<%="Assignee"+"____~____*"+"Date"+"____~____*"+"Quote #"+"____~____*"+"Insured Name"+"____~____*"+"State"+"____~____*"+"Broker"+"____~____*"+"Priority"+"____~____*"+"Delete"+"____~____*"+"Quote Url"+"____~____*"+"Insured Url"+"____~____*"+"CustomerId"+"____~____*"+"QuoteId"+"____~____*"+"AgencyId"+"____~____*"+"UserId"+"____~____*"+"Quote PanelName"+"____~____*"+"Insured PanelName"+"____~____*"+"OwnerId"+"____~____*"+"AlertId"+"____~____*"+"PolicyId"+"____~____*"+"PolicyVerId"+"____~____*"+"PolicyNumber"+"____~____*"+"QuoteSubNum"+"\n"%>
<%}%>
<%=assignee+"____~____*"+updatedDate+"____~____*"+quoteNo+"____~____*"+insuredName+"____~____*"+state+"____~____*"+broker+"____~____*"+""+"____~____*"+""+"____~____*"+quoteURL+"____~____*"+insuredURL+"____~____*"+custId+"____~____*"+quoteId+"____~____*"+agencyId+"____~____*"+assignedUser+"____~____*"+"Quote_Panel"+"____~____*"+"Insured_Panel"+"____~____*"+ownerId+"____~____*"+alertId+"____~____*"+policyId+"____~____*"+policyVerId+"____~____*"+policyNumber+"____~____*"+quoteSubNum+"\n"%>
<%}%>
<%}%>
