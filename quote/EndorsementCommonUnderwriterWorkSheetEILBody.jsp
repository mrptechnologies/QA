					...
					<td width="60%">
						<table border="0" cellspacing="1" cellpadding="3">
							...
							<%out.println((htmlPage.toString()).replace("<tr><td>&nbsp;</td></tr>",""));
								...
								if(isRenewalEndorsement.equals("Y") && startDate.after(sdf.parse("2023-07-31"))){
									dateApplicable = true; // For Renewals
								}else if(!isRenewalEndorsement.equals("Y") && startDate.after(sdf.parse("2023-06-30"))){
									dateApplicable = true; // For Endorsements
								}
								if(BranchCode.equals("PR") && dateApplicable){%>		
