...
<style>
  .tableHeader{	border:1px solid #4E4E50;font-weight:bold;}
...
<div class="formpagenew" style="margin:-30px 0 0 -2px;background:url(i/bodybg1.gif) repeat-x top;">
<div align="left" id="ClassListClassBenefits">
	<jsp:include page="NewQuoteClassBenefitsClassListParent.jsp"/>
</div>
