...
<html:form action="/SaveDeclineSubmissionStatus.do" >
			...
			<logic:notEqual name="Tab_UI_View" value="UI_3.0" scope="session" >
				...
				<tr>
					<td >	
						<table WIDTH="100%" ALIGN="left" BORDER="0" CELLSPACING="0" CELLPADDING="0">	
							...
							<tr>
								<td class="NewSectionHead" colspan="5" align="center">DECLINE SUBMISSION </td>
							</tr>
							<tr>
								<td  class="FormLabels" align="left" colspan="4">&nbsp; </td>
							</tr>
				...
				<tr>
					<td align="left">
						<table width="100%" border="0">
										...
										<tr>
											...
											<td colspan="2" class="links">												
												<a href="../GetSubmissionInsuredDetailAction.do?TabPanelName=Submission_Panel&answer(Object::Submission::SubmissionVerId)=<%=Long.parseLong(SubmissionVerId.toString())%>&answer(Object::Submission::SubmissionId)=<%=Long.parseLong(SubmissionId.toString())%>&answer(TabPanelName)=Submission_Panel&answer(customerId)=<%=Long.parseLong(customerId.toString())%>&customerId=<%=Long.parseLong(""+customerId)%>&answer(Object::Customer::CustomerId)=<%=Long.parseLong(""+customerId)%>&answer(requestForm)=Submission&answer(Object::Application::ApplicationType)=SUBMISSION_APPLICATION&answer(Object::Submission::InsuredId)=<%=Long.parseLong(""+customerId)%>" title="<bean:message key='ToolTip.DeclineSubmission.SubmissionSummary'/>">Submission Summary</a>
											</td>											
										</tr>
										<tr>										
						...
						<div class="content">							
						<div class="Subjectivityformhead"><h2 class="left">DECLINE SUBMISSION</h2></div>						
						...
						<table WIDTH="100%" ALIGN="left" border="0" CELLSPACING="2" CELLPADDING="0">
							...
							<tr>
								<td>
									<html:hidden property="answer(Object::Submission::SubmissionStatus)" value="Declined" />
								</td>
							</tr>							
							<tr>
								<td>
									<table WIDTH="75%" ALIGN="center" border="0" CELLSPACING="0" CELLPADDING="0">
										...
										<tr>
											<td align="center" class="links" colspan="4" title="<bean:message key='ToolTip.DeclineSubmission.Save'/>">
											<!-- 	<dmshtml:dms_isPresent property="<%=new String[]{"In Progress","Referred","Lapsed"}%>" value="<%=""+strSubmissionStatus%>" negated="true" >
...
<html:hidden property="answer(Object::Activity::ActivityMsg)" value="<%="Submission Declined"%>"/>
