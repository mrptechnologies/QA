...
<html:form action="/SaveInsuredCL"  focus="InsuredName" onsubmit="return validateAddInsuredCLFields()">
					...
					<td>
						<table WIDTH="100%" ALIGN="right" BORDER="0" CELLSPACING="0" CELLPADDING="2">
							...
							<tr>
								...
								<td>	
									<IMG SRC="../Images/zipcodefind.jpg"  BORDER="0" align="left" ALT="Search for Agency." onmouseover="this.style.cursor='hand';" onclick="return GoTOFindButtonCL()">
					...
					<td>
						<table WIDTH="100%" ALIGN="right" BORDER="0" CELLSPACING="0" CELLPADDING="2">
							...
							<tr>
								...
								<td class="links">&nbsp;<html:text  name="AddCustomer" property ="answer(Object::Customer::DBA)"  size="30" maxlength="60" styleClass="txtbox" styleId="DBA" /></td>
							</tr>

							 <tr>
								<td width="40%" class="FormLabels" align="left">&nbsp;&nbsp;Form of Business</td>
								<td class="links" style="Class:txtbox">&nbsp;
								<html:select name="AddCustomer" property="answer(Object::Customer::Business)" styleClass="txtbox" styleId="FormOfBusiness">
							...
							<tr>
								...
								<td class="links">&nbsp;<html:textarea name="AddCustomer" property="answer(Object::Customer::BusinessDesc)" rows="3" cols="60" styleId="BusinessDesc" onkeyup="maxLengthTextArea()" /></td>
							</tr>
							...
							<tr>
								...
								<td class="TextMatter">&nbsp;
									<input type="radio" name="answer(Object::Customer::BillingAddressSame)" value="Yes" onclick="setBillingAddress()" id="BillingAddressSame" >Yes&nbsp;&nbsp;&nbsp;
									<input type="radio" name="answer(Object::Customer::BillingAddressSame)" value="No" onclick="setBillingAddress()" id="BillingAddressNotSame" >No
								</td>
							</tr>

							<tr>
								<td class="FormLabels" align="left">&nbsp;&nbsp;Billing Address Line1</td>
								<td class="links">&nbsp;<html:text  name="AddCustomer" property="answer(Object::Customer::BillingAddress1)" size="24" maxlength="25" styleClass="txtbox" styleId="BillingStreetName"/></td>
							</tr>
							<tr>
								<td class="FormLabels" align="left">&nbsp;&nbsp;Billing Address Line2</td>
								<td class="links">&nbsp;<html:text  name="AddCustomer" property="answer(Object::Customer::BillingAddress2)" size="24" maxlength="60" styleClass="txtbox" styleId="BillingAddress2"/></td>
							</tr>
							<tr>
								<td class="FormLabels" align="left">&nbsp;&nbsp;<bean:message key="AddCustomer.City" /></td>
								<td class="links">&nbsp;<html:text  name="AddCustomer" property="answer(Object::Customer::BillingCity)" size="20" maxlength="40" styleClass="txtbox" styleId="BillingCity"/></td>
							</tr>
							<tr>
								<td class="FormLabels" align="left">&nbsp;&nbsp;County Name</td>
								<td class="links">&nbsp;<html:text   property="answer(Object::Customer::BillingCounty)" size="20" maxlength="20" styleClass="txtbox" styleId="BillingCounty"/></td>
							</tr>
							...
							<tr>
								...
								<td class="links" style="Class:txtbox">&nbsp;<html:select name="AddCustomer" property="answer(Object::Customer::BillingState)" styleClass="txtbox" styleId="BillingState">
									<html:option value ="" styleClass="txtbox">Select A State</html:option>
							...
							<html:hidden property="answer(InsType)" value="CL" styleId="InsType"/>
								<td class="FormLabels" align="left">&nbsp;&nbsp;Zip Code*</td>
								<td class="links">&nbsp;<html:text  name="AddCustomer" property="answer(Object::Customer::BillingZip)" size="10" maxlength="10" styleClass="txtbox" styleId="BillingZip" onkeyup="if(this.value.length==5) {this.value=this.value+'-'}"/>
								<!--Zipcode lookup start 05-06-2006-->
								<a href="../SearchZipCodeCommon.do?answer(Object::ZipCode::PageNum)=0&FormName=AddCustomer&clear=yes&BillingCity=BillingCity&BillingCounty=BillingCounty&BillingState=BillingState&BillingZip=BillingZip" title="Search for zip code, state, county" onClick="return ZipCodePopup(this, 'ZipCode');" /><IMG SRC="../Images/zipcodefind.jpg"  BORDER="0" align="top" ALT="Search for Zip code, City, State and County."></a></td>
								<!-- 05-06-2006 end-->																	
							</tr>
							<tr>
								<td class="FormLabels" align="left">&nbsp;&nbsp;Bill to Loan #</td>
								<td class="links">&nbsp;<html:text  name="AddCustomer" property="answer(Object::Customer::BilltoLoan)" size="24" maxlength="60" styleClass="txtbox" styleId="BillToLoan"/></td>
							</tr>
