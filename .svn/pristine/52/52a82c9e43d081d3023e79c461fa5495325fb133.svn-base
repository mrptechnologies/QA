...
<template:put name='ProgressBar' content='/common/ProgressBarCoverageandLimits.jsp' />
<template:put name='Header1' content='/common/InsuredAgencyLinkspage3.0.jsp' /> 
<template:put name='GeneralBody' content='/quote/CoverageLimitsApplicationBody.jsp' /> 
