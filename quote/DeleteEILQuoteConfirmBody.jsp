...
<html:form action="/DeleteEILQuoteAction">
...
<bean:define id="SubmissionId" property="answer(Object::Submission::SubmissionId)" name="DataForm" scope="session"/>
<bean:define id="SubmissionVerId" property="answer(Object::Submission::SubmissionVerId)" name="DataForm" scope="session"/>
<bean:define id="ApplicationType" property="answer(Object::Application::ApplicationType)" name="DataForm" scope="session"/>
<html:hidden property="answer(Object::Application::ApplicationType)" value="<%=""+ApplicationType%>" />
