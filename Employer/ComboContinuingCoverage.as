/**
  ...
  * @ author amrutha_aa@solartis.net
  */ 
import mx.core.UIComponent
import mx.controls.ComboBox
import mx.controls.DataGrid

class ComboContinuingCoverage extends UIComponent
{
	...
	private static var COMBOBOX_DATA_PROVIDER : Array = [{label: "Yes", data: "Y"}, 
														 {label: "No", data:"N"}];
	// Constructor:  Should be empty.
	public function ComboContinuingCoverage()
	{
	}
