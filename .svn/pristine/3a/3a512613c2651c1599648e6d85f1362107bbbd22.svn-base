...
<html:form action="/RateQuoteSummaryBTA.do" onsubmit="return validateCoverages(this);">
...
<html:hidden property="answer(Object::Quote::CustomerState)" value='<%=stateCode.toString()%>' styleId="state"/>
<%}else{ %>
<html:hidden property="answer(Object::Quote::CustomerState)" value="<%=stateCode.toString()%>" styleId="state"/>
<%} %>
...
<html:hidden  property="answer(activateTabId)" value='<%="CoverageandLimits_Row"%>'/>
</TD>
</TR>
</TABLE>													
<div class="formpage1">	
...
<div id="OPTIONS_DIV" style="height: 550px;">
