			...
			try {
				new Ajax.Updater(
					...
					url,
					{
						method: "get",
						onComplete: function(){
						if(document.getElementById("Insured_Panel") != null && document.getElementById("Insured_Panel") != undefined) {
							forwardToLoginPageIfInvalidSession(document.getElementById("Insured_Panel").innerHTML);
						}
								//Do something
							}
					}
			...
			<div class="bd">
				...
				<%if(insType.equals("PC")) {%>
					...
					<dmshtml:dms_static_with_connector ruleName='privilage' property='<%=new String[]{"ADD_COM_INSURED_MENU"}%>' connector='or' negated="true">
						<li class="yuimenuitem"><a class="yuimenuitemlabel" href="../AddInsuredCom.do?TabPanelName=Insured_Panel&clear=yes&answer(Object::PageType)=ADD_INSURED">Add Insured</a></li>
					</dmshtml:dms_static_with_connector>
				<%-- 	<dmshtml:dms_static_with_connector ruleName='privilage' property='<%=new String[]{"ADD_LIU_INSURED_MENU"}%>' connector='or' negated="true">
						<li class="yuimenuitem"><a class="yuimenuitemlabel" href="../AddLIUInsured.do?TabPanelName=Insured_Panel&clear=yes&answer(Object::PageType)=ADD_INSURED">Add Insured</a></li>
					</dmshtml:dms_static_with_connector>		--%>			
