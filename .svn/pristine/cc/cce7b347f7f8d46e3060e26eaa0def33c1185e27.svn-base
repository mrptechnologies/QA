...
<%				 
 ...
 %>
 	...
 	<div id="divideTab">
 		<a href="javascript:void(0);" id="PolicyHazards" onclick="showHazards(this.id)" class="loctab_inactive left">	
		<div id="ClassListSize">Hazards</div></a>
		<a href="javascript:void(0);" id="ClassSchedule" onclick="showClassList(this.id);" class="loctab_active left">	
		<div id="ClassListSize">Class Hazards (<%=classSize %>)</div></a>
	</div>	
	...
	<div class="locformpage" id="Loc3TableData">
		<table border="0" width="100%" cellspacing="0" cellpadding="0" class="">
        	...
        	<logic:iterate id="ClassListArray" name="ClassListArray" >
        	   ...
        	   <bean:define id="ClassHazardsId"  property="Object::Quote::ClassHazardsId" name="ClassListArray" />
        	   <%classHazardsId=""+ClassHazardsId; %>
        	   <%String strClassDescription =""+ClassDescription; %>
        	   <tr class=<%=className%>>
        	   		<td><div class="yui-dt-liner"><p class="tableData"><a href="javascript:void(0);" onclick="getClass('<%=ClassHazardsId%>','<%=newClassName %>')"><%=ClassIndex %></a></p></div></td>
        	   		<td><div class="yui-dt-liner"><p class="tableData"><a href="javascript:void(0);" onclick="getClass('<%=ClassHazardsId%>','<%=newClassName %>')"><%=""+newClassName %></a></p></div></td>
	 ...
	 <div id="AddClassDiv" class="locformpages" style="clear:both;display:none">
		<div class="formpage4">
			<div class="content">
