...
*/
		...
		function loadTable(url) {
			...
			new Ajax.Updater(
				...
				method: "get",
				onComplete: function(){
					if(document.getElementById("Policy_Panel") != null && document.getElementById("Policy_Panel") != undefined) {
						forwardToLoginPageIfInvalidSession(document.getElementById("Policy_Panel").innerHTML);
					}
					//Do something
				}
				}
			...
			<div class="bd">
				<ul class="first-of-type">
					...
					<dmshtml:dms_static_with_connector ruleName='privilage' property='<%=new String[]{"POLICY_MENU"}%>' connector='or' negated="true">
						<li class="yuimenubaritem"><a class="yuimenubaritemlabel" href="/SearchPolicyDisplayAction.do?TabPanelName=Policy_Panel">Find Policy</a></li>
					...
					<dmshtml:dms_static_with_connector ruleName='privilage' property='<%=new String[]{"FIND_CERTIFICATE_MENU"}%>' connector='or' negated="true">
						<li class="yuimenubaritem"><a class="yuimenubaritemlabel" href="/SearchPolicyDisplayAction.do?TabPanelName=Policy_Panel">Find Certificate</a></li>
					</dmshtml:dms_static_with_connector>
					...
					<dmshtml:dms_static_with_connector ruleName='privilage' property='<%=new String[]{"DOCUMENT_MENU"}%>' connector='or' negated="true">
						<li class="yuimenubaritem"><a class="yuimenubaritemlabel" href="../documents/Documents.jsp?TabPanelName=Policy_Panel">Documents</a>
							<div id="policy_tab_staticdocuments" class="yuimenu">
								<div class="bd">
									<ul>
										<dmshtml:dms_static_with_connector ruleName='privilage' property='<%=new String[]{"DOCUMENT_MENU"}%>' connector='or' negated="true">
											<li class="yuimenuitem"><a class="yuimenuitemlabel" href="../documents/AdminForms.jsp?TabPanelName=Policy_Panel">Administrative Forms</a></li>
											<li class="yuimenuitem"><a class="yuimenuitemlabel" href="../documents/BenefitAndContact.jsp?TabPanelName=Policy_Panel">Benefit Summary & Contact Info</a></li>
											<%if(strDomainName.indexOf("mica")>=0)
											{%>
												<li class="yuimenuitem"><a class="yuimenuitemlabel" href="../documents/MicaCommissionDocuments.jsp?TabPanelName=Policy_Panel">Commission Documents</a></li>
											<%}%>
										</dmshtml:dms_static_with_connector>
									</ul>
								</div>
