...
class ComboSmoker extends UIComponent
{
	...
	private static var PREFERRED_WIDTH = 50; 			// The preferred width of the cell containing the Combobox.
	...
	private static var COMBOBOX_DATA_PROVIDER : Array = [{label: "Yes", data:"Yes"},
														 {label: "No", data:"No"}];
	// Constructor:  Should be empty.
	public function ComboSmoker()
	{
	}
