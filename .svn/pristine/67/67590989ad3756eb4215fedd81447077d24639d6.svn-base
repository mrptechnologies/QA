...
java.lang.String status = qMap.getString("Object::Alert::ObjectStatus");
...
if(objectType.equalsIgnoreCase("Quote")) {
		...
		broker = qMap.getString("Object::QuoteHeader::AgencyName");
		agencyId = qMap.getString("Object::QuoteHeader::AgencyId");
		policyId = qMap.getString("Object::Alert::PolicyId");
		policyVerId = qMap.getString("Object::Alert::CurrentVerId");
		policyNumber = qMap.getString("Object::Alert::PolicyNumber");
		quoteSubNum = qMap.getString("Object::QuoteHeader::QuoteSubNum");
		objectNo = objectNo+quoteSubNum;
		objectLink="<a id='' rel='' target=''  href='" +"../SyncQuoteWithEmployerGroupAndProductAction.do"+"?TabPanelName="+"Quote_Panel"+"&answer(Object::Customer::CustomerId)="+custId+"&answer(QuoteId)="+objectId+"&answer(parentQuoteId)="+objectId+"&answer(ownerId)="+ownerId+"&answer(policyNumber)="+policyNumber+"&answer(Object::Policy::ParentPolicyId)="+policyId+"&answer(Object::Policy::ParentPolicyVerId)="+policyVerId+"&answer(Object::Agency::AgencyId)="+agencyId+"&answer(userId)="+assignedUser+"'>"+objectNo+"</a>";
}
...
if(objectType.equalsIgnoreCase("Submission")) {
	...
	agencyId = qMap.getString("Object::Submission::AgencyId");
	broker = qMap.getString("Object::Submission::AgencyName");
	...
	objectLink="<a id='' rel='' target=''  href='../GetSubmissionInsuredDetailAction.do?TabPanelName=Submission_Panel&answer(Object::Submission::SubmissionVerId)="+objectVerId+"&answer(Object::Submission::SubmissionId)="+objectId+"&answer(TabPanelName)=Submission_Panel&answer(customerId)="+custId+"&customerId="+custId+"&answer(Object::Customer::CustomerId)="+custId+"&answer(requestForm)=Submission"+"&answer(Object::Application::ApplicationType)=SUBMISSION_APPLICATION"+"&answer(Object::Submission::InsuredId)="+custId+"'>"+objectNo+"</a>";

}
insuredLink="<a id='' rel='' target=''  href='../GetInsuredAction.do?TabPanelName=Insured_Panel"+"&customerId="+custId+"'>"+insuredName+"</a>";
java.lang.String assignee =""; 
if(i==0){%>
<%="Date"+"____~____*"+"Quote/Submission #"+"____~____*"+"Insured Name"+"____~____*"+"State"+"____~____*"+"Status"+"____~____*"+"Priority"+"____~____*"+"Delete"+"____~____*"+"Object Url"+"____~____*"+"Insured Url"+"____~____*"+"CustomerId"+"____~____*"+"ObjectId"+"____~____*"+"AgencyId"+"____~____*"+"UserId"+"____~____*"+"Quote PanelName"+"____~____*"+"Insured PanelName"+"____~____*"+"Submission PanelName"+"____~____*"+"OwnerId"+"____~____*"+"AlertId"+"____~____*"+"ObjectType"+"____~____*"+"ObjectVerId"+"____~____*"+"PolicyId"+"____~____*"+"PolicyVerId"+"____~____*"+"PolicyNumber"+"____~____*"+"QuoteSubNum"+"\n"%>
<%}%>
<%=updatedDate+"____~____*"+objectNo+"____~____*"+insuredName+"____~____*"+state+"____~____*"+status+"____~____*"+""+"____~____*"+""+"____~____*"+objectLink+"____~____*"+insuredLink+"____~____*"+custId+"____~____*"+objectId+"____~____*"+agencyId+"____~____*"+assignedUser+"____~____*"+"Quote_Panel"+"____~____*"+"Insured_Panel"+"____~____*"+"Submission_Panel"+"____~____*"+ownerId+"____~____*"+alertId+"____~____*"+objectType+"____~____*"+objectVerId+"____~____*"+policyId+"____~____*"+policyVerId+"____~____*"+policyNumber+"____~____*"+quoteSubNum+"\n"%>
<%}%>
<%}%>
