...
<html:form name="FindForm" type="com.dms.web.data.DataForm" action="/LinkAgenttoInsuredEILAction.do">
...
<bean:define id="ownerId" property="answer(Object::UserDetail::ownerId)" name="LoginPage" scope="session"/>
	...
	<div class="formpage01">
		...
		<div class="formcontent" title="<bean:message key='ToolTip.SelectAgency.Find'/>">
		<input type="button" value="Find >" class="covsmallbutton" onclick="listAgency('../ListOfAgencies.do');updateCount('../ListOfAgenciesCount.do');">	
		</div>
		<div class="formcontentRightAlign" style="display:none" id="divSelectButton" title="<bean:message key='ToolTip.SelectAgency.Select'/>">
		<input type="button" class="covsmallbutton" value="Select" onclick="selectAgent();" >
		</div>
		...
		<div class="formcontentRightAlign" style="display:none" id="divSelectButton1" title="<bean:message key='ToolTip.SelectAgency.Select'/>">
		<input type="button" class="covsmallbutton" value="Select" onclick="selectAgent();" >
		</div>
		</div>
