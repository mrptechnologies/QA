...
<html:form styleId="MANUFORM" action="/AddSubjectivity.do">
		<div class="SubjectivityPage">									
			...
			<tr><td>&nbsp;</td></tr>																																										
			<tr><td align="right" ><html:button property="answer(Submit)" onclick="saveManuScript(this.form)" value="Save" styleClass="subbutton" /></td><td><html:button property="answer(Cancel)" onclick="YAHOO.example.container.manuScript.hide();" value="Cancel" styleClass="subbutton" /></td></tr>
			</table>												
			</div></div>
			</html:form>	
