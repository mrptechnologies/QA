...
<bean:define id="ownerId" property="answer(Object::UserDetail::ownerId)" name="LoginPage" scope="session"/>
	...
	<table WIDTH="98%" ALIGN="center" BORDER="0" CELLSPACING="0" CELLPADDING="2">
		...
		<tr>
			<td class="NewSectionHead" colspan="4" align="center">FIND DOCUMENT</td>
		</tr>
		<tr>
			<td>
				<table WIDTH="90%" ALIGN="center" BORDER="0" CELLSPACING="0" CELLPADDING="2">
					<tr><td>&nbsp;</td></tr>
					<tr>
						<td class="sectionhead" colspan ="2" align="center" >DOCUMENT SEARCH CRITERIA</td>
					</tr>
					<tr>
						<td>&nbsp;</td>
					</tr>
					<tr>
						...
						<td align="left" >
							<html:text  property="answer(Object::Product::Document::Definition::DocName)" styleClass="txtbox" styleId="DocName"/>
						</td>
					</tr>
					...
					<logic:present name="documentTypeList">
						<tr>
							<td width="35%" class="FormLabels" align="right">Document Type *</td>
							<td class="links">
