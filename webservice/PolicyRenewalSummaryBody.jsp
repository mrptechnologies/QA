...
<script type="text/javascript" src="../Scripts/JScripts/PolicyRenewalSummary.js"></script>
...
<% long transactionDetailId=0; 
 ...
 <div class="formpage01">
  <div class="content">
	...
	<div class="formheadnew"><h2 class="left">Policy Renewal Summary</h2></div>
 ...
 <html:form action="/UpdatePolicyRenewalDetails.do">
 <table WIDTH="100%"  border="0" CELLSPACING="2" CELLPADDING="0">					
	...
	<html:hidden name = "FindOutBoundTransactions" property="answer(Object::TakeUp::TakeUpEffectiveDate)"/>
 </html:form>
