...
<bean:define id="ownerId" property="answer(Object::UserDetail::ownerId)" name="LoginPage" scope="session"/>
	<table WIDTH="98%" ALIGN="center" BORDER="0" CELLSPACING="0" CELLPADDING="2">
		<html:form action="/AgencyForAgentSearchAction.do" >
	    	<tr>
	    		<td>&nbsp;</td>
	    	</tr>
	    	<!--<tr>-->
	    	<tr>
	    		<td class="MH">AGENCY OF RECORD	</td>
	    	</tr>
			<tr>
				...
				<td>
					<table WIDTH="90%" ALIGN="center" BORDER="0" CELLSPACING="0" CELLPADDING="2">
						...
						<tr>
							...
							<td align="left" >
								<html:text property="answer(Agency::Like::BusinessName)" styleClass="txtbox"/>
							</td>
						</tr>

						<tr>
							<td  align="right" class="FormLabels">State</td>
							<td>
