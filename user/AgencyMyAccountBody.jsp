...
<bean:define id="ownerId" property="answer(Object::UserDetail::ownerId)" name="LoginPage" scope="session"/>
	...
	<bean:define id="primaryRole" property="answer(Object::UserDetail::roleName)" name="ChangeUser"/>
	...
	<%}} %>
		...
		<!-- Business Address -->
				...
				<tr>
					...
					<td>
					&nbsp;<html:text property="answer(Object::Agency::Addresses::BUSINESS::Object::Address::Address1)" styleId="Address2" size="30" maxlength="50" readonly="true" style="border-style:none;"/>
				...
				<tr>
					...
					<td>
						&nbsp;<html:text property="answer(Object::Agency::Addresses::BUSINESS::Object::Address::Address2)" styleId="Address2" size="30" maxlength="50" readonly="true" style="border-style:none;"/>
					</td>
				</tr>
				<tr>
					<td class="FormLabels" align="right">
					...
					<td>
						&nbsp;<dmshtml:dms_text styleClass="txtbox" styleId="City" property="answer(Object::Agency::Addresses::BUSINESS::Object::Address::City)" size="30" maxlength="30" readonly="true" style="border-style:none;"/>
					</td>
				</tr>
				<tr>
					<td class="FormLabels" align="right">
					...
					<td>
					&nbsp;<html:text property="answer(Object::Agency::Addresses::BUSINESS::Object::Address::State)" styleId="State" size="30" maxlength="50" readonly="true" style="border-style:none;"/>
					</td>
				</tr>
				<tr>
					<td class="FormLabels" align="right">
					...
					<td class="TextMatter">
					&nbsp;<html:text property="answer(Object::Agency::Addresses::BUSINESS::Object::Address::Country)" styleId="Country" size="30" maxlength="50" readonly="true" style="border-style:none;"/>
					</td>
				</tr>
				<tr>
					<td class="FormLabels" align="right">
					...
					<td>
						&nbsp;<dmshtml:dms_text styleClass="txtbox" styleId="Zip"  property="answer(Object::Agency::Addresses::BUSINESS::Object::Address::Zip)" size="10" maxlength="10" readonly="true" style="border-style:none;"/>
					</td>
						<!--  end-->		
				</tr>
				<tr>
					...
					<td>
						&nbsp;<dmshtml:dms_text styleClass="txtbox" styleId="BusinessPhoneNum"  property="answer(Object::Agency::Contacts::BUSINESS::Object::Contact::WorkPhone)" size="40" maxlength="40" readonly="true" style="border-style:none;"/>
					</td>
				</tr>
				<tr>
					<td class="FormLabels" align="right">
					...
					<td>
						&nbsp;<dmshtml:dms_text styleClass="txtbox" styleId="BusinessFaxNum"  property="answer(Object::Agency::Contacts::BUSINESS::Object::Contact::Fax)" size="40" maxlength="40" readonly="true" style="border-style:none;"/>
					</td>
				</tr>
				<tr>
					<td>&nbsp;</td>
				...
				<tr>
					...
					<td>&nbsp;<dmshtml:dms_text styleClass="txtbox" styleId="DocType"  property="answer(Object::Agency::BranchName)" size="50" maxlength="40" readonly="true" style="border-style:none;"/></td>
				</tr> 
