...
<script type="text/javascript" src="../Scripts/prototype.js"></script>
	 ...
	 <div class="content">
	   ...
	   <div class="formheadnew"><h2 class="left"> Quote Transaction Summary</h2></div>
	   ...
	   <table width= "100%">
		...
		<tr>
		 ...
		 <tr>
			<td class="field" width="30%" align = "right">Quote Number :</td>
			<td width="1%">&nbsp;</td>
			<td width="69%' align="left">
			 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<bean:write  property="answer(Object::Quote::QuoteNumber)" name="FindOutBoundTransactions"/>  
			</td>
		 </tr>	
		 <tr>
			<td class="field" width="30%" align = "right">Quote Sub Number :</td>
			<td width="1%">&nbsp;</td>
			<td width="69%' align="left">
			 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<bean:write  property="answer(Object::Quote::QuoteSubNumber)" name="FindOutBoundTransactions"/>  
			</td>
		 </tr>	
	  </table>
	
	   <html:form action = "/UpdateQuoteTransactionDetails">
	   ...
	   <%/*
	   Insured Information*/ %>
	   <html:form action="/UpdateQuoteINFInsuredAction.do">	
	  	 <dmshtml:get_INFInsured_Detail nameInSession="infInsuredMap"  transactionMasterId="<%=Long.parseLong(""+transactionMasterId)%>" ownerId="<%=Long.parseLong(""+ownerId) %>" dbname='<%=com.dms.web.util.DbUtils.getReadDS(pageContext)%>' />
			<logic:present name="infInsuredMap">
				...
				<bean:define id="externalInsuredDetailId" name="infInsuredMap" property="Object::INFInsured::ExternalInsuredDetailId"/>
         	 	 ...
         	 	 <%/*
					Quote Details*/ %>
		 	 <html:form action = "/UpdateQuoteDetail">
		       ...
		       <logic:present name="submissionMap">
		         	<bean:define id="title1" name="submissionMap" property="Object::Submission::title"/>
	           		...
	           		<bean:define id="userId" property="answer(Object::UserDetail::userName)" name="LoginPage" scope="session" />
		      	   <table width= "100%">
			 		<tr><td colspan="3"><h3>Quote Details</h3></td></tr>
		           	<tr>
					...
					<html:hidden property="answer(Object::Submission::termCurrencyOfAmounts)" value = "<%=""+termCurrencyOfAmounts1 %>" />
					<html:hidden property="answer(Object::Submission::termMainAcCurrencyCode)" value = "<%=""+termMainAcCurrencyCode1 %>" />
	   ...
	   <!--  
	   <div id="INFLocationInfoDiv">
	      <dmshtml:get_INF_Location_Detail nameInSession="INFlocationList" transactionDetailId="<%=Long.parseLong(""+transactionDetailId1)%>" ownerId="<%=Long.parseLong(""+ownerId) %>" dbname='<%=com.dms.web.util.DbUtils.getReadDS(pageContext)%>' />
	       ...
	       <logic:iterate name="INFlocationList" id="locationDetail" type="com.dms.ejb.webservice.liu.dataloader.INFLocationDetail">
	       		...
	       		<bean:define id="locationDetailId1" name="locationDetail" property="locationDetailId"/>		
	 	   		<tr>  
		            <td><a href="javascript:void(0);" onClick="return editINFLocationDetails(<%=""+locationDetailId1 %>);" ><%= iterator%></a></td>
	   ...
	   <div id="infLocationDiv" style="display:block">
			<div id="editINFLocationDetailsDiv">
			...
			<bean:define id="arrCoveragesList" name="arrCoverageDetails" type="java.util.ArrayList"/> 
 			<logic:iterate name="arrCoveragesList" id="sectionCoverageDetail" type="com.dms.ejb.webservice.liu.dataloader.SectionCoverageDetail">
				<bean:define id="coverageDetailId" name="sectionCoverageDetail" property="sectionCoverageDetailId" />
				 <tr>  
			      <td><a href="javascript:void(0);" onClick="return editQuoteCoverageDetails(<%=""+coverageDetailId %>,<%=transactionDetailId1+"" %>);" ><%= iterator%></a></td>
...
function editAjaxQuoteSectionCoverageDetails(coverageDetailId,transactionDetailId) {
