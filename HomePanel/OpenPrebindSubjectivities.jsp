...
<DIV id=headPreBind><!-- Begin prebindsubjectivities800448896 Head -->
		...
		<TBODY>
			<TR>
				<TD class="rowicon_Home">
					<table>
						<tr>
							<td width="12%"><SPAN style="FONT-WEIGHT: normal; WIDTH: 99.9%"><input type="checkbox" style="border: 0px" checked="checked" id="clchk1" name="asdf" onclick="onPrebindCheckClick(this.form)"/>Assigned To You</SPAN></td>
							<td width="3%"></td>
							<td width="12%"><SPAN style="FONT-WEIGHT: normal; WIDTH: 99.9%"><input type="checkbox"  style="border: 0px" checked="checked" id="clchk2" name="asdf" onclick="onPrebindCheckClick(this.form)"/>Un Assigned</SPAN></td>
							<td width="3%"></td>
							<td width="15%"><SPAN style="FONT-WEIGHT: normal; WIDTH: 99.9%"><input type="checkbox" style="border: 0px" checked="checked" id="clchk3" name="asdf" onclick="onPrebindCheckClick(this.form)"/>Assigned To Others</SPAN></td>
							<td width="3%"></td>
...
function loadOpenPreBindSubj(){
    YAHOO.example.XHR_Text = function() {
       ...
       var moreColumnDefs = [
            ...
            {key:"Insured Name", resizable:"true",width:135},
