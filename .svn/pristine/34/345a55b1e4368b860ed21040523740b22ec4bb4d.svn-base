						...
						<tr>
							<td class="links">
								...
								<a href="../GetListCL.do?answer(TabPanelName)=Insured_Panel&customerId=<%=custid.toString()%>&answer(RiskType)=COMMERCIAL&SearchObjectId=<%=custid.toString()%>&answer(OwnerId)=<%=ownerId+"" %>&answer(Object::UserDetail::ownerId)=<%=ownerId.toString()%>&answer(Object::Customer::CustomerId)=<%=custid.toString()%>&answer(Object::Risk::ComProperty::CustomerId)=<%=""+custid%>&answer(Object::Agency::AgencyId)=<%=id.toString()%>&answer(objectId)=0&answer(Object::Risk::ComProperty::ComPropertyId)=-1&answer(objectVerId)=0&answer(objectName)=HOME_RISK&answer(applicationType)=RISK&answer(applicationSubType)=&Navigation=&answer(teritory)=<%=""%>&answer(territoryName)=<%=""%>&answer(zone)=<%=""%>&answer(state)=<%=""%>&answer(showOnetTab)=Y&tabNo=0&answer(Object::Employee::PageNum)=0&answer(Object::Customer::State)=<%=custState.toString()%>&answer(Object::Risk::ComProperty::CustomerId)=<%=custid.toString()%>&answer(Object::Risk::ComProperty::ComPropertyId)=-1&answer(SelectedRiskType)=COMMERCIAL<%=" "%>AUTO"
									title="Click to go to Show All Risks" />Location</a>
						...
						<tr>
							<td align="center">
								<table WIDTH="90%" ALIGN="center" BORDER="0" CELLSPACING="0" CELLPADDING="2">									
									...
									<tr>
										<td class="sectionhead1" align="left">Contact Name</td>
										<td class="TextMatter" align="left">:<bean:write name='AddCustomer' property='answer(Object::CustomerAdditional::ContactName)' />
										</td>	
									</tr>
									<tr>
										<td class="sectionhead1" align="left">Title of Contact</td>
										<td class="TextMatter" align="left">:<bean:write name='AddCustomer' property='answer(Object::CustomerAdditional::ContactTitle)' />
										</td>	
									</tr>
									<tr>
										<td class="sectionhead1" align="left">Phone Number</td>
										<td class="TextMatter" align="left">:<bean:write name='AddCustomer' property='answer(Object::Customer::WorkPhoneAreaCode)' />-<bean:write name='AddCustomer' property='answer(Object::Customer::WorkPhoneExchangeCode)' />-<bean:write name='AddCustomer' property='answer(Object::Customer::WorkPhone)' />
										</td>	
									</tr>
									<tr>
										<td class="sectionhead1" align="left">Company Website</td>
										<td class="TextMatter" align="left">:<bean:write name='AddCustomer' property='answer(Object::CustomerAdditional::CompanyUrl)' />
										</td>	
									</tr>
									<tr>
										<td class="sectionhead1" align="left">Form of Business</td>
										<td class="TextMatter" align="left">:<bean:write name='AddCustomer' property='answer(Object::CustomerAdditional::FormOfBusiness)' />
										</td>	
									</tr>
									<tr>
										<td class="sectionhead1" align="left">If Other, please specify</td>
										<td class="TextMatter" align="left">:<bean:write name='AddCustomer' property='answer(Object::CustomerAdditional::BusinessFormOther)' />
										</td>	
									</tr>
								</table>
							</td>
