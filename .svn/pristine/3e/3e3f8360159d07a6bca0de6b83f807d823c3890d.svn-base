...
<table WIDTH="95%" ALIGN="center" BORDER="0" CELLSPACING="2" CELLPADDING="0">
	...
	<tr>
		<td class="links">
			...
			<% String empId=""+request.getParameter("answer(Object::Employee::EmployeeId)"); %>
			<a href="../customer/AddEmployeeCencusExtendedApplication.jsp?TabPanelName=<%=""+request.getParameter("TabPanelName")%>&answer(teritory)=<%=""%>&Navigation=&answer(territoryName)=<%=""%>&answer(zone)=<%=""%>&tabNo=0&answer(Object::Customer::CustomerId)=<%=""+custid%>&answer(Object::Employee::EmployeeId)=<%=""+empId%>">Employee Health Application Extended</a>
		</td>
	</tr>
</table>
<body>
	...
	objectVerId="0" objectName="EMPLOYEE" applicationType="EMPLOYEE" applicationSubType="" isSubApplicationCoveredByForm="Yes"  actionName="/saveEmployeeApplicationAction.go" isApplicationEnabled="Y"  showOneTabAtTime="N"/>
