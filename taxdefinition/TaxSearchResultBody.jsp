			   			...
			   			<tr>
							...
							<bean:define id="productTaxId" name="findTax" property="Object::Product::Tax::Definition::ProductTaxId" />
				   			<td class="SearchResult" align="left" >
								<a href="/GetTaxDefinitionAction.do?TabPanelName=<%=""+request.getParameter("TabPanelName") %>&answer(Object::Product::Tax::Definition::OwnerId)=<%=""+ownerId%>&answer(Object::Product::Tax::Definition::ProductTaxId)=<%= ""+productTaxId%>">
