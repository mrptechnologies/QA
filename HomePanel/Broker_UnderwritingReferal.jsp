...
function loadUnderwriterRef(){
    YAHOO.example.XHR_Text = function() {  
       ...
       var moreColumnDefs = [            
            ...
            {key:"Quote/Submission #", formatter:formatObjectUrl, resizable:"true",width:110},
            {key:"Insured Name", formatter:formatInsuredUrl, resizable:"true",width:190},
        ...
        var anotherDataSource = new YAHOO.util.DataSource("../GetReferralAlertAction.do?SearchStartDate="+searchStartDate+"&SearchEndDate="+searchEndDate+"&AlertName="+Referred_Change+"");
        anotherDataSource.responseType = YAHOO.util.DataSource.TYPE_TEXT;
        anotherDataSource.responseSchema = {
            recordDelim: "\n",
            fieldDelim: "____~____*",
            fields: ["Date","Quote/Submission #","Insured Name","State","Status","Priority","Delete","Quote Url","Insured Url","Submission Url","CustomerId","ObjectId","AgencyId","UserId","Quote PanelName","Insured PanelName","Submission PanelName","OwnerId","AlertId","ObjectType","ObjectVerId"]
        };
