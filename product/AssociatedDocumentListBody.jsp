...
<html:hidden property="TabPanelName" value="<%=""+request.getParameter("TabPanelName")%>" />
	<table WIDTH="90%" ALIGN="center" BORDER="0" CELLSPACING="0" CELLPADDING="2">
			...
			<tr><td height="10"></td></tr>
			<tr>
				<td class="NewSectionHead" colspan="4" align="center">ASSOCIATED DOCUMENT LIST</td>
			</tr>

			<logic:present name="isDisAssociated" >
				<tr><td>Document Removed Successfully</td></tr>			
			</logic:present>
					...
					<table width="880px" ALIGN="center" BORDER="0">
						<tr>
							<td align="right">
								...
								<a href="../product/EditAssociatedDocumentDetail.jsp?TabPanelName=<%=""+request.getParameter("TabPanelName")%>&answer(Object::Product::DocGroup::PrdDocType)=<%=productDocType%>&answer(Object::Product::Document::PrdVerId)=<%=productVerId%>&answer(Object::Product::Document::PrdId)=<%=productId%>&answer(Object::Product::Document::Definition::OwnerId)=<%=ownerId%>">Edit</a>
							</td>
						</tr>
					</table>
				</td>
								...
								<logic:iterate id="AssociatedDocumentList" name="AssociatedDocumentList" scope="request">
									...
									<tr>
										...
										<logic:present name="arrayOfProductVerDetailList">
											...
											<td class=<%=styleClass %> align="left" width="20%"><%= ""+productDocumentDefinitionDetail.getRuleName() %></td>
