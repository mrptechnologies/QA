...
function findExpiringPoliciesWithNoRenewalQuote(dataSourceURL) {

	if(GoTOFindButton())
		listExpiringPoliciesWithNoRenewalQuote(dataSourceURL);	
}

function listExpiringPoliciesWithNoRenewalQuote(dataSourceURL) {
	...
	YAHOO.example.DynamicData = function() {	  		  
	   ...
	   var formatTotalPremium = function(elCell, oRecord, oColumn, sData) {	
	    ...
	    var myColumnDefs = [ // sortable:true enables sorting 
	        ...
	        {key:"InsuredName", label:"Insured Name",formatter:formatLink,sortable:true,resizable:"false",width:80}, 	   
	        {key:"InsuredState", label:"Insured State",sortable:true,resizable:"false",width:65},     
	        {key:"AgencyName", label:"Agency Name",resizable:"false",width:90,sortable:true},
	        {key:"EffectiveDate", label:"Effective Date",resizable:"false",width:70,sortable:true},
	        {key:"ExpirationDate", label:"Expiration Date",resizable:"false",width:75,sortable:true},
	        {key:"TotalPremium", label:"Total Premium",formatter:formatTotalPremium,resizable:"false",width:70,sortable:true},
	        {key:"PolicyStatus", label:"Policy Status",resizable:"false",width:60,sortable:true},
	        {key:"NonRenewal", label:"Renew this Policy",resizable:"false",width:90,sortable:false}
	    ]; 
	    ...
	    var myColumnDefsBroker = [ // sortable:true enables sorting 
	        {key:"SNo", label:"SNo", sortable:false,resizable:"false",width:30}, 
	        {key:"PolicyNumber", label:"Policy #",resizable:"false",width:100,formatter:formatPolicyNumLink,sortable:true},       
	        {key:"InsuredName", label:"Insured Name",formatter:formatLink,sortable:true,resizable:"false",width:100},
	        {key:"InsuredState", label:"Insured State",sortable:true,resizable:"false",width:70}, 	        
	        {key:"AgencyName", label:"Agency Name",resizable:"false",width:130,sortable:true},
	        {key:"EffectiveDate", label:"Effective Date",resizable:"false",width:70,sortable:true},
	        {key:"ExpirationDate", label:"Expiration Date",resizable:"false",width:80,sortable:true},	        
