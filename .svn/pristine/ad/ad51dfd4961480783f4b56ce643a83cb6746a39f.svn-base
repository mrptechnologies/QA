	...
	var isMedHealthElement1:Boolean;
	...
	var medConditionExplanation:HashMap = new HashMap();
...
//					if(nameElement=="Object__Employee__InsWaiver__CoverageReason" && valueElement == "Employee/dependent has coverage"){
			...
			/* newly added - start
				...
				var repeatNameElement1:String;
				var repeatValueElement1:String;
				var countTotalMedHealth1:Number = 0;
				isMedHealthElement1 = true;
				var MedHealthRowElement1 = true;
				for(childIndex=0;childIndex < employeeExtendedXML.firstChild.childNodes[parentIndex].childNodes.length;childIndex++){
					
					repeatNameElement1 = employeeExtendedXML.firstChild.childNodes[parentIndex].childNodes[childIndex].firstChild.firstChild.nodeValue;
					repeatValueElement1 = employeeExtendedXML.firstChild.childNodes[parentIndex].childNodes[childIndex].lastChild.lastChild.nodeValue;				
					
					if(repeatNameElement1.indexOf("Object__Employee__MedExplanation__QuestionIdentifier")!= -1){
						countTotalMedHealth = countTotalMedHealth + 1;
						if(repeatValueElement1 !="" and repeatValueElement1 != undefined and repeatValueElement1 != ""){
							medConditionExplanation.put(repeatNameElement1,repeatValueElement1);	
							Alert.show("field1"+repeatValueElement1,Alert.YES);
							MedHealthRowElement1 = (MedHealthRowElement1 && true);
						}else{
							MedHealthRowElement1 = (MedHealthRowElement1 && false);
						}
					}
					else if(repeatNameElement1.indexOf("Object__Employee__MedExplanation__PatientCondition")!= -1){
						countTotalMedHealth = countTotalMedHealth + 1;
						if(repeatValueElement1 !="" and repeatValueElement1 != undefined and repeatValueElement1 != ""){
							medConditionExplanation.put(repeatNameElement1,repeatValueElement1);	
							MedHealthRowElement1 = (MedHealthRowElement1 && true);
					...
					else if(repeatNameElement1.indexOf("Object__Employee__MedExplanation__TreatmentStartDate")!= -1){
						countTotalMedHealth = countTotalMedHealth + 1;
						if(repeatValueElement1 !="" and repeatValueElement1 != undefined and repeatValueElement1 != ""){
							Alert.show("field2"+repeatValueElement1,Alert.YES);
							medConditionExplanation.put(repeatNameElement1,repeatValueElement1);	
							MedHealthRowElement1 = (MedHealthRowElement1 && true);
						}else{
							MedHealthRowElement1 = (MedHealthRowElement1 && false);
					...
					else if(repeatNameElement1.indexOf("Object__Employee__MedExplanation__TreatmentSummary")!= -1){
						 countTotalMedHealth = countTotalMedHealth + 1;
						 if(repeatValueElement1 !="" and repeatValueElement1 != undefined and repeatValueElement1 != ""){
							 medConditionExplanation.put(repeatNameElement1,repeatValueElement1);	
							MedHealthRowElement1 = (MedHealthRowElement1 && true);
					...
					if(countTotalMedHealth % 4 == 0){		
						isMedHealthElement1 = isMedHealthElement1 && MedHealthRowElement1;
					}				
				}
			}
			// newly added - end */
		...
		validateMedQuestionnaire(employeeExtendedXML);
	...
	validateMedQuestionnaire = function(employeeExtendedXML:XML){
		var cancerFilled:Boolean;
		/*if(medicalQuesionMap.containsKey("Object__Employee__MedicalCondition__Cancer")){		
				if(medicalQuesionMap.get("Object__Employee__MedicalCondition__Cancer") == "Y"){
					for(parentIndex = 0;parentIndex<employeeExtendedXML.firstChild.childNodes.length;parentIndex++){		
						 for(childIndex=0;childIndex<employeeExtendedXML.firstChild.childNodes[parentIndex].childNodes.length;childIndex++){
							 var subApplicationName1 = employeeExtendedXML.firstChild.childNodes[parentIndex].attributes.Name;			
							 if(subApplicationName1 == "Expl"){
								var repeatNameElement1:String;
								var repeatValueElement1:String;
								repeatNameElement1 = employeeExtendedXML.firstChild.childNodes[parentIndex].childNodes[childIndex].firstChild.firstChild.nodeValue;
								repeatValueElement1 = employeeExtendedXML.firstChild.childNodes[parentIndex].childNodes[childIndex].lastChild.lastChild.nodeValue;				
								if(repeatNameElement1.indexOf("Object__Employee__MedExplanation__QuestionIdentifier")!= -1){
									if(repeatValueElement1 !="" and repeatValueElement1 != undefined and repeatValueElement1 != ""){
										 //Alert.show("qqqqqq"+repeatValueElement1,Alert.YES);
													if(repeatValueElement1=="CANCER"){
														cancerFilled = true;													
														Alert.show("cancer flag true!"+repeatValueElement1,Alert.YES);
													}
									}
								}if(repeatNameElement1.indexOf("Object__Employee__MedExplanation__PatientCondition")!= -1){
									if(repeatValueElement1 !="" and repeatValueElement1 != undefined and repeatValueElement1 != ""){
					...
					if(medicalQuesionMap.containsKey("Object__Employee__MedicalCondition__CancerType") && cancerFilled){
						isMedHealthQuest = (isMedHealthQuest && true);				
					}
					 else{
						cancerFilled = false;  // visibility of yellow icon is true
						Alert.show(" cancer flag false - not filled :(",Alert.YES);
