...
<bean:define id="ownerId" property="answer(Object::Activity::OwnerId)" name="SearchActivityManagerAction1" />
<bean:define id="intPageNum" property="answer(Object::Activity::PageNum)" name="SearchActivityManagerAction1" />
<bean:define id="objId" property="answer(Object::Activity::ObjectId)" name="SearchActivityManagerAction1" />
...
<SCRIPT type="text/javascript" >
	...
	var formElement=document.forms[0];
	 formElement.action="/SearchActivityManagerAction1.do?TabPanelName=<%=""+request.getParameter("TabPanelName") %>&answer(Object::Customer::CustomerName)=<%= ""+customerName %>&answer(Object::Activity::PageNum)="+nextOrPre;
	    document.forms[0].submit();
	}
</SCRIPT>
<!-- formElement.action="../SearchActivityManagerAction1.do?answer(Object::Activity::PageNum)="+nextOrPre; -->
<%intPageNum = ""+request.getAttribute("pageNum");%>

<html:form action="/SearchActivityManagerAction1.do">
...
<table WIDTH="100%" ALIGN="center" BORDER="0" CELLSPACING="0" CELLPADDING="0">
		...
		<tr><td>
			...
			<td>
			<jsp:include page="../common/InsuredAgencyLinkspage3.0.jsp" />
		</td></tr>
...
<table WIDTH="98%" ALIGN="center" BORDER="0" CELLSPACING="2" CELLPADDING="0">	
	...
	<tr>
		<td class="NewSectionHead" colspan="4" align="center">INSURED ACTIVITY LIST</td>
	</tr>
	<tr><td>&nbsp;</td></tr>
			...
			<table WIDTH="100%" ALIGN="left" BORDER="0" CELLSPACING="2" CELLPADDING="0">
				...
				<tr height="30">
					...
					<td align="right" class="links" colspan="11">
						...
						<%-- %><a href="/SearchActivityManagerAction1.do?TabPanelName=Activity_Panel&answer(Object::Activity::OwnerId)='<%=""+ownerId %>'&answer(Object::Activity::PageNum)='<%=((Integer.parseInt(""+intPageNum))+1) %>'">Next&gt;&gt;</a>--%>
				...
				<tr height="30">
				 ...
				 <html:reset value="Back" onclick="goToInsuredSummaryPage();" styleClass="sbttn"/>
			</table>
		</td>
	</tr>
	<bean:define id="ActivityId" name="SearchActivityManagerAction1" property="answer(Object::Activity::ActivityId)" />
	<bean:define id="ObjectStatus" name="SearchActivityManagerAction1" property="answer(Object::Activity::ObjectStatus)" />
	<bean:define id="ActivityType" name="SearchActivityManagerAction1" property="answer(Object::Activity::ActivityType)" />
	<bean:define id="ObjectId" name="SearchActivityManagerAction1" property="answer(Object::Activity::ObjectId)" />
	<bean:define id="ObjectVerId" name="SearchActivityManagerAction1" property="answer(Object::Activity::ObjectVerId)" />
	<bean:define id="CreatedBy" name="SearchActivityManagerAction1" property="answer(Object::Activity::CreatedBy)" />
	<bean:define id="UpdatedBy" name="SearchActivityManagerAction1" property="answer(Object::Activity::CreatedBy)" />
	<bean:define id="CreatedBeginDate" name="SearchActivityManagerAction1" property="answer(Object::Activity::CreatedBeginDate)" />
	<bean:define id="CreatedEndDate" name="SearchActivityManagerAction1" property="answer(Object::Activity::CreatedEndDate)" />
	<bean:define id="UpdatedBeginDate" name="SearchActivityManagerAction1" property="answer(Object::Activity::UpdatedBeginDate)" />
	<bean:define id="UpdatedEndDate" name="SearchActivityManagerAction1" property="answer(Object::Activity::UpdatedEndDate)" />
...
function goToInsuredSummaryPage() {
	...
	if(document.getElementById("InsuredSummaryPageLink") != null && document.getElementById("InsuredSummaryPageLink") != undefined) {
		window.location = document.getElementById("InsuredSummaryPageLink").href;
	}
}
</script>