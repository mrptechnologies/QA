...
<bean:define id="agencyId" property="answer(Agency::Equals::AgencyId)" name="QuickQuote" />
<bean:define id="businessName" property="answer(Agency::Like::BusinessName)" name="QuickQuote" />		
<bean:define id="firstName" property="answer(Object::Entity::FirstName)" name="QuickQuote" />		
<bean:define id="lastName" property="answer(Object::Entity::LastName)" name="QuickQuote" />	
<%String agencyState=request.getParameter("answer(Address::Equals::State)");%>
<%String agencySize =""+request.getAttribute("agencySize");%>
...
<html:form action="/LinkAgencttoCustomerActionForQuickQuote.do">
	...
	<table WIDTH="98%" ALIGN="center" BORDER="0" CELLSPACING="2" CELLPADDING="0">
		...
		<tr>
			<td class="NewSectionHead" colspan="4" align="center">AGENTS FOUND IN SEARCH</td>
		</tr>
		...
		<tr><td class="sectionhead" >
			<b>Total Number of Agents Found &nbsp;&nbsp;<%=strcnt%></b>
		</td></tr>
		<tr><td></td></tr>
		...
		<tr><td>
			...
			<table WIDTH="100%" ALIGN="Left" cellspacing="2" cellpadding="2">
				...
				<tr>
					<td align="Left" class="links" colspan="5" >
						<logic:present name="firstAgency"  scope="request" >
							<a href="../AgencySearchActionForQuickQuote.do?TabPanelName=<%=""+request.getParameter("TabPanelName") %>&answer(ownerId)=<%=""+ownerId %>&LimitSearch=yes&answer(Object::Agency::PageNum)=0&answer(Agency::Like::BusinessName)=<%=""+businessName%>&answer(Object::Entity::FirstName)=<%=""+firstName%>&answer(Object::Entity::LastName)=<%=""+lastName%>&answer(Address::Equals::State)=<%=""+agencyState%>&answer(Object::Agency::TotalRec)=<%=""+agencySize%>">&lt;&lt;First</a>
						</logic:present>&nbsp;&nbsp;
						<logic:present name="prevAgency"  scope="request" >
							<a href="../AgencySearchActionForQuickQuote.do?TabPanelName=<%=""+request.getParameter("TabPanelName") %>&answer(ownerId)=<%=""+ownerId %>&LimitSearch=yes&answer(Object::Agency::PageNum)=<%=(Integer.parseInt(""+pagenum)-1)%>&answer(Agency::Like::BusinessName)=<%=""+businessName%>&answer(Object::Entity::FirstName)=<%=""+firstName%>&answer(Object::Entity::LastName)=<%=""+lastName%>&answer(Address::Equals::State)=<%=""+agencyState%>&answer(Object::Agency::TotalRec)=<%=""+agencySize%>&answer(Agency::Equals::OwnerId)=<%=""+ownerId%>"><bean:message key="Common.Previous"/></a>
						</logic:present>
					</td>
					
					<td align="right" class="links" colspan="5">
						<logic:present name="moreAgency"  scope="request" >
							<a href="../AgencySearchActionForQuickQuote.do?TabPanelName=<%=""+request.getParameter("TabPanelName") %>&answer(ownerId)=<%=""+ownerId %>&LimitSearch=yes&answer(Object::Agency::PageNum)=<%=(Integer.parseInt(""+pagenum)+1)%>&answer(Agency::Like::BusinessName)=<%=""+businessName%>&answer(Object::Entity::FirstName)=<%=""+firstName%>&answer(Object::Entity::LastName)=<%=""+lastName%>&answer(Address::Equals::State)=<%=""+agencyState%>&answer(Object::Agency::TotalRec)=<%=""+agencySize%>&answer(Agency::Equals::OwnerId)=<%=""+ownerId%>">Next&gt;&gt;</a>
						</logic:present>&nbsp;&nbsp;
						<logic:present name="lastAgency"  scope="request" >
							<a href="../AgencySearchActionForQuickQuote.do?TabPanelName=<%=""+request.getParameter("TabPanelName") %>&answer(ownerId)=<%=""+ownerId %>&LimitSearch=yes&answer(Object::Agency::PageNum)=<%=(Integer.parseInt(""+totpagenum)-1)%>&answer(Agency::Like::BusinessName)=<%=""+businessName%>&answer(Object::Entity::FirstName)=<%=""+firstName%>&answer(Object::Entity::LastName)=<%=""+lastName%>&answer(Address::Equals::State)=<%=""+agencyState%>&answer(Object::Agency::TotalRec)=<%=""+agencySize%>&answer(Agency::Equals::OwnerId)=<%=""+ownerId%>">Last&gt;&gt;</a>
						</logic:present>   
					</td>
				</tr>
				...
				<tr>
					...
					<td class="sectionhead" width="20%" align="center">Agent First Name</td>
					
					<td class="sectionhead" width="20%" align="center">Agent Last Name</td>
					
					<td class="sectionhead" width="20%" align="center">E-MailID</td>
				...
				<logic:iterate id="qmap" name="searchresultnewDisplay" scope="request" type="com.dms.ejb.data.QuestionHashMap">
					...
					<td class=<%= styleClass %>>
					  	 <%=++i%>
					  	 <% ++radioFlag; %>
						<bean:define id="agencySel" name="QuickQuote" property="answer(Agency::AgencyId)" scope="request"/>											
						<bean:define id="agentSel" name="QuickQuote" property="answer(Object::Entity::EntityId)" scope="request"/>						
						<%	  
					...
					<td class=<%= styleClass %>>
						<%=qmap.getString("Object::Entity::FirstName")%>
						
					</td>
					
					<td class=<%= styleClass %>>
						<%=qmap.getString("Object::Entity::LastName")%>
						
					</td>
					<td class=<%= styleClass %>>
						<%=qmap.getString("Object::Entity::EmailID")%>
				...
				<!-- <td class=<%= styleClass %>>
					...
					<td class=<%= styleClass %> align="center" >
						<%
					       		if(checked) { 
					        %> 
						<INPUT TYPE="radio" name="answer(Agency::AgencyId)" value="<%=qmap.getString("Object::AGENCY::AGENCYID")+"::"+qmap.getString("Object::Entity::EntityId")%>"  checked />
					        <%
					                }else {
					        %> 
						<html:radio property="answer(Agency::AgencyId)" value="<%=qmap.getString("Object::AGENCY::AGENCYID")+"::"+qmap.getString("Object::Entity::EntityId")%>" >
						</html:radio>
				                <%
				                        }
				                %>
...
<!--  -->
				<tr>
					<td align="Left" class="links" colspan="5">
						<logic:present name="firstAgency"  scope="request" >
							<a href="../AgencySearchActionForQuickQuote.do?TabPanelName=<%=""+request.getParameter("TabPanelName") %>&answer(ownerId)=<%=""+ownerId %>&LimitSearch=yes&answer(Object::Agency::PageNum)=0&answer(Agency::Like::BusinessName)=<%=""+businessName%>&answer(Object::Entity::FirstName)=<%=""+firstName%>&answer(Object::Entity::LastName)=<%=""+lastName%>&answer(Address::Equals::State)=<%=""+agencyState%>&answer(Object::Agency::TotalRec)=<%=""+agencySize%>&answer(Agency::Equals::OwnerId)=<%=""+ownerId%>">&lt;&lt;First</a>
						</logic:present>&nbsp;&nbsp;
						<logic:present name="prevAgency"  scope="request" >
							<a href="../AgencySearchActionForQuickQuote.do?TabPanelName=<%=""+request.getParameter("TabPanelName") %>&answer(ownerId)=<%=""+ownerId %>&LimitSearch=yes&answer(Object::Agency::PageNum)=<%=(Integer.parseInt(""+pagenum)-1)%>&answer(Agency::Like::BusinessName)=<%=""+businessName%>&answer(Object::Entity::FirstName)=<%=""+firstName%>&answer(Object::Entity::LastName)=<%=""+lastName%>&answer(Address::Equals::State)=<%=""+agencyState%>&answer(Object::Agency::TotalRec)=<%=""+agencySize%>&answer(Agency::Equals::OwnerId)=<%=""+ownerId%>"><bean:message key="Common.Previous"/></a>
						</logic:present>
...
<!--  -->
 ...
 <bean:define id="Customerid" name="QuickQuote" property="answer(Object::Customer::CustomerId)" /> 
