...
<title>Welcome to Starr Online Quoting & Policy Administration System </title>
<!-- <html:base/> -->
...
<table WIDTH="100%" style="height:100%" ALIGN="center" BORDER="0" CELLSPACING="0" CELLPADDING="0">
	...
	<td width="60%" align="center" valign="middle"><IMG SRC="Images/star_indemnity_logo.jpg" BORDER="0" ALT=""></td>
		...
		<td bgcolor="#336699" align="center" >
			...
			<TR>
				...
				Please use your User Name and Password to login to the application.
				</TD>
			</TR>
					...
					<TABLE WIDTH="90%" ALIGN="center" BORDER=1 CELLSPACING=0 CELLPADDING=0 bgcolor="#f1f1f1">
						<TR>
							<TD>&nbsp;
								...
								<tr>
									...
									UI
										...
										<select name="solartisTabView"  >
											...
											<option value="UI_3.0" selected="selected">UI 3.0</option>
 										</select>
									</td>
									<td colspan="2">&nbsp;
									</td>-->
							 ...
							 <tr>
								 	<td>
								 		<input type="hidden" name="solartisTabView" value="UI_3.0" >
								 	</td>
								 </tr> 
								<TR>
		...
		<%
		 ...
		 session.setAttribute("ownerId","14");
		 session.setAttribute("dbname","java:/jdbc/cvstarrds");
		 session.setAttribute("ReadDS","java:/jdbc/cvstarrds");
		 session.setAttribute("WriteDS","java:/jdbc/cvstarrds");
	...
	<tr>
	   <td>
		...
		<INPUT name="answer(Object::UserDetail::siteId)" type=hidden value="14"/>
		<INPUT name="answer(Object::UserDetail::ownerId)" type=hidden value="14"/>
		<INPUT name="answer(dbname)" type=hidden value="java:/jdbc/cvstarrds"/>
		<INPUT name=ownerId type=hidden value="14"/>
		<INPUT name=formName type=hidden value="form::LoginMICACARE"/>
		<INPUT name=page type=hidden value="1"/>
		<INPUT name=page type=hidden value="1"/>
		<INPUT name="answer(INSURANCE_TYPE)" type=hidden value="PC"/>
		<INPUT name="answer(Page::Title)" type=hidden value="Starr Online Quoting & Policy Administration System"/>
		<INPUT name="answer(FormLogo)" type=hidden value="formlogoCVStar left"/>
		<INPUT name="answer(ClientLogo)" type=hidden value="clientlogoCVStar left"/>
		<INPUT name="answer(PageLogo)" type=hidden value="../Images/star_indemnity_logo_inner.jpg" />
