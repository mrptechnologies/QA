...
<table WIDTH="100%" ALIGN="left" border="0" CELLSPACING="2"
	...
	<tr>
		...
		<table WIDTH="1200px" ALIGN="center" BORDER="0" CELLSPACING="0"
			CELLPADDING="0">
			<tr>
				<td class="NewSectionHead" colspan="4" align="center">ADD ALERT DEFINITION</td>
			</tr>
			...
			<tr>
				<td><html:form action="/AddAlertDefinitionAction.do"
					...
					<table WIDTH="90%" ALIGN="left" BORDER="0" CELLSPACING="0"
						...
						<tr>
							<td>&nbsp;</td>
							<td align="left"><html:submit value="Add"
