...
function addRisk(){
	...
	'&answer(recalculateneeded)='+recalculateneed+'&answer(IsApplicationDisabled)='+appEnabled+'&answer(Object::Agency::AgencyId)='+agencyId+'&answer(CustomerId)='+custId+
	...
	var par2 = '&answer(Object::UST::TankDescription__DMS_PROP_QUOTE_VER_PLAN_RISK_STORAGETANK_DETAIL~TANK_DESCRIPTION)='+tankDesc+'&answer(actionName)='+actionName+'&answer(Object::Risk::RiskName__DMS_PROP_QUOTE_VER_PLAN_RISK_STORAGETANK_DETAIL~RISK_NAME)='+RiskName;
	 autologout();
	...
	YAHOO.util.Event.on('submitButtonForPopUp', 'click', function(e) {	 
	 ...
	 YAHOO.util.Event.on('closeIcon3', 'click', function(e) {
	  ...
	  YAHOO.util.Event.on('CancelRisk1', 'click', function(e) {
	 	...
	 	YAHOO.example.container.dialog3.cancel();
	 	if((document.getElementById("RiskPopUpBody") != undefined) && (document.getElementById("RiskPopUpBody") != null))
		 	document.getElementById("RiskPopUpBody").innerHTML = " ";
		if((document.getElementById("RiskPopUp") != undefined) && (document.getElementById("RiskPopUp") != null))
		 	document.getElementById("RiskPopUp").style.display = "none";	
	 	ShowQuoteLocationTankListDiv(locId);
	 })
}
...
function doSpecificSuccessActionForPopUp(){
	...
	if(document.getElementById('Title')!=null && document.getElementById('quoteDocumentDiv')==null){
	...
	if(document.getElementById("newSubQuoteVerId") != undefined){
 	...
 	removeChild(activeTabId);
 	}
	else{
	var newLocName = "";
	if(document.getElementById("newLocationNameAssigned") != undefined){
	 newLocName = document.getElementById("newLocationNameAssigned").value;
	}
...
document.getElementById("LocList").innerHTML = '<table border="0" width="99%" id="table2" cellspacing="0" cellpadding="0"><tr><td class="todotab_yellowbox tab_yellowborder" ><div>&nbsp;</div><form name="locationListForm" id="locationListFormId"><table border="0" cellpadding="5" cellspacing="0"  width="98%" class="datadispborder" align=center id="Loc3TableData" ><tr><td><div id="LocationList1" class="locformbox1"></div></td></tr><tr><td align="right" style="display:none" id="deleteLocButton"><a href="javascript:void(0)" onclick="deleteQuoteLocations(document.getElementById(\'locationListFormId\'))" class="button2" style="width:100px">Delete</a></td></tr></table></form>';
...
function updateDivForAddLocation(){
	...
	'&OwnerId='+ownerId+'&answer(objectName)='+objectName+'&answer(applicationType)='+applicationType+'&answer(applicationSubType)='+applicationSubType+
	'&answer(IsSubApplicationCoveredByForm)='+IsSubApplicationCoveredByForm+'&answer(State)='+State+'&answer(riskTerritory)='+riskTerritory+'&answer(zone)='+zone+'&answer(ParentQuoteId)='+parentQuoteId+'&answer(ParentQuoteVerId)='+parentQuoteVerId+'&addedAppIndex='+addIndex+'&answer(Object::Risk::ComProperty::CustomerId)='+custId+'&answer(Object::Application::ApplicationType)='+objAppType+
	'&answer(recalculateneeded)='+recalculateneed+'&answer(IsApplicationDisabled)=Y&answer(Object::Agency::AgencyId)='+agencyId+'&answer(CustomerId)='+custId+'&answer(subQuoteId)='+subQuoteId+'&answer(Object::Agency::AgencyId)='+agencyId+'&answer(customerId)='+custId+'&answer(SubQuoteId)='+subQuoteId+
	'&answer(Object::Location::LocationId)='+locationId+'&answer(Object::Customer::CustomerId)='+custId+
	'&answer(actionName)='+actionName+'&answer(riskType)='+objectName+'&answer(objectType)='+objectType+'&answer(Object::Quote::PrevSubQuoteVerId)='+prevSubQuoteVerId+'&answer(Object::Quote::ProductFamilyId)='+FamilyId+'&answer(FamilyId)='+FamilyId;
	//var heading = '';
...
function getSpecificQuestions(tankType){
	...
	'&answer(recalculateneeded)='+recalculateneed+'&answer(IsApplicationDisabled)='+appEnabled+'&answer(Object::Agency::AgencyId)='+agencyId+'&answer(CustomerId)='+custId+'&answer(subQuoteId)='+subQuoteId+'&answer(SubQuoteId)='+subQuoteId+'&answer(Object::Agency::AgencyId)='+agencyId+'&answer(customerId)='+custId+'&answer(SubQuoteId)='+subQuoteId+
...
function editSpecificQuestions(tankType){
	...
	var pars1 = 'answer(objectId)='+objectId+'&answer(objectVerId)='+objectVerId+'&answer(IsApplicationEnabled)='+appEnabled+
	'&OwnerId='+ownerId+'&answer(objectName)='+objectName+'&answer(applicationType)='+applicationType+'&answer(applicationSubType)='+applicationSubType+
	...
	'&addedAppIndex='+addIndex+'&answer(Object::Risk::ComProperty::CustomerId)='+custId+'&answer(Object::Application::ApplicationType)='+objAppType+
	'&answer(recalculateneeded)='+recalculateneed+'&answer(IsApplicationDisabled)='+appEnabled+'&answer(Object::Agency::AgencyId)='+agencyId+'&answer(CustomerId)='+custId+'&answer(subQuoteId)='+subQuoteId+'&answer(Object::Agency::AgencyId)='+agencyId+'&answer(customerId)='+custId+'&answer(SubQuoteId)='+subQuoteId+
	'&answer(Object::Location::LocationId)='+locationId+
	'&answer(Object::Customer::CustomerId)='+custId+'&answer(actionName)='+actionName+'&answer(riskType)='+objectName+'&answer(objectType)='+objectType+'&answer(Object::Quote::PrevSubQuoteVerId)='+prevSubQuoteVerId+'&answer(Object::Quote::ProductFamilyId)='+FamilyId+'&answer(FamilyId)='+FamilyId;
	//var heading = '';
...
function geteditRiskPopUp(tankId,riskType){
	...
	if(IsApplicationDisabled == 'N'){
		appEnabled = 'Y';
		 heading = 'View/Edit Tank Information';
	}else{
		appEnabled = "N";	
		 heading = 'View Tank Information'; 
	}
	var agencyId = document.getElementById("agencyId").value;
	...
	'&addedAppIndex='+addIndex+'&answer(Object::Risk::ComProperty::CustomerId)='+custId+'&answer(Object::Application::ApplicationType)='+objAppType+
	'&answer(recalculateneeded)='+recalculateneed+'&answer(Object::Agency::AgencyId)='+agencyId+'&answer(CustomerId)='+custId+'&answer(subQuoteId)='+subQuoteId+'&answer(Object::Agency::AgencyId)='+agencyId+'&answer(customerId)='+custId+'&answer(SubQuoteId)='+subQuoteId+
	...
	'&answer(Object::Customer::CustomerId)='+custId+'&answer(actionName)='+actionName+'&answer(riskType)='+objectName+'&answer(objectType)='+objectType+'&answer(Object::Quote::PrevSubQuoteVerId)='+prevSubQuoteVerId+'&answer(Object::Quote::ProductFamilyId)='+FamilyId+'&answer(FamilyId)='+FamilyId;
	var par2 = '&answer(actionName)='+actionName;

	var url = '../GetSubmissionLocation.do?'+pars1;
	autologout();		
	new Ajax.Request(url, {method: 'post',asynchronous:true,parameters:par2,
		onFailure:function(){},
		onException:function(){},
		onComplete:function(transport){
		forwardToLoginPageIfInvalidSession(transport.responseText);
...
function showTab(data){
	...
	if(!addLocationDivActive){
		...
		if((document.getElementById("LocList") != null) && (document.getElementById("LocList") != undefined))
			document.getElementById("LocList").innerHTML = '<table border="0" width="99%" id="table2" cellspacing="0" cellpadding="0"><tr><td class="todotab_yellowbox tab_yellowborder" ><div>&nbsp;</div><form name="locationListForm" id="locationListFormId"><table border="0" cellpadding="5" cellspacing="0"  width="98%" class="datadispborder" align=center id="Loc3TableData" ><tr><td><div id="LocationList1" class="locformbox1"></div></td></tr><tr><td align="right" style="display:none" id="deleteLocButton"><a href="javascript:void(0)" onclick="deleteQuoteLocations(document.getElementById(\'locationListFormId\'))" class="button2" style="width:100px">Delete</a></td></tr></table></form>';
		loadQuoteLocationList1();
		if((document.getElementById("Loc3TableData") != null) && (document.getElementById("Loc3TableData") != undefined))
			document.getElementById("Loc3TableData").style.display = "block";	
		if((document.getElementById("AddLocationDiv") != null) && (document.getElementById("AddLocationDiv") != undefined))
			document.getElementById("AddLocationDiv").style.display = "none";
		if(document.getElementById("AddLocationDiv1") != undefined){
			document.getElementById("AddLocationDiv1").innerHTML = "";
		}

		if((document.getElementById("LocationAndTanksList") != null) && (document.getElementById("LocationAndTanksList") != undefined)) {
			document.getElementById("LocationAndTanksList").style.display = "none";
...
removeChild(addLocationId);//for closing the Add Location Tab


}
	 
	function deleteQuoteLocations(form){
	...
	if(count>0) {
		...
		if (ans){
			...
			//alert("deleteQuoteLocations")
			var parentQuoteId    = document.getElementById("parentQuoteId").value;
			var subQuoteId    = document.getElementById("subQuoteId11").value;
			var parentQuoteVerId = document.getElementById("parentQuoteVerId").value;
			var custId = document.getElementById("customerId").value;
			var pars1 = 'answer(Object::Quote::QuoteVerId)='+parentQuoteVerId+'&answer(subQuoteId)='+subQuoteId+'&answer(quoteId)='+parentQuoteId+'&answer(formName)=DeleteRisk&answer(Object::Customer::CustomerId)='+custId;
			var url = '../DeleteQuoteEILTank.do?'+pars1;		
			autologout();
			new Ajax.Request(url, {method: 'post',parameters:$(form).serialize(this),asynchronous:true,
			onFailure:function(){	document.body.style.cursor="default";
			},
			onException:function(){	document.body.style.cursor="default";
			},
			onComplete:function(transport){
				forwardToLoginPageIfInvalidSession(transport.responseText);
				loadQuoteLocationList1();
