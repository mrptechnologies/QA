...
<html:form action="/LinkAgencytoAgent.do">
...
<tr><td>
<table WIDTH="75%" ALIGN="Left" cellspacing=0 cellpadding="2">
...
<tr>
		...
		<a href="../AgencyForAgentSearchAction.do?TabPanelName=<%=""+request.getParameter("TabPanelName")%>&answer(ownerId)=<%=""+ownerId %>&LimitSearch=yes&answer(Object::Agency::PageNum)=<%=(Integer.parseInt(""+pagenum)-1)%>"><bean:message key="Common.Previous"/></a>
		</logic:present>
		</td>
		<td align="right" class="links" colspan="1">
		<logic:present name="moreAgency"  scope="request" >

		<a href="../AgencyForAgentSearchAction.do?TabPanelName=<%=""+request.getParameter("TabPanelName")%>&answer(ownerId)=<%=""+ownerId %>&LimitSearch=yes&answer(Object::Agency::PageNum)=<%=(Integer.parseInt(""+pagenum)+1)%>">Next&gt;&gt;</a>
		</logic:present>
		</td>
	</tr>
	<tr >
