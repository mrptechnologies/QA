...
<tr>
	<td>
		...
		<bean:parameter id="AgencyName" name="AgencyName" />
		<bean:parameter id="createdBy" name="createdby"  />		
		<%
		...
		<table ALIGN="left" BORDER="0" width="1000px" CELLSPACING="0" CELLPADDING="0">
			<tr>
				<td align="left" colspan=2>
					<table width="1000px" align="left" border="0" >
						<tr>
...
<!--##########################NEW QUOTE HEADER START #########################################-->
				...
				<div id="quoteheadercontainer">
					<div id="quoteheadernav" align="left">
						<table WIDTH="1000px" ALIGN="left" BORDER="0" CELLSPACING="0" CELLPADDING="0">
						<tr><td width="50%">
