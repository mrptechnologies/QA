...
<tr><td>&nbsp;</td></tr>
		<tr><td class="MH">GENERAL AGENCY</td></tr>
		<tr><td>&nbsp;</td></tr>
	<tr>
		<td class="TextMatter">
	...
	<tr><td class="links">
		...
		<dmshtml:dms_static_with_connector ruleName='privilage' property='<%=new String[]{"ADD_GENERAL_AGENCY_MENU"}%>' connector='or' negated="true">
		  ...
		  <a href="../GeneralAgencyLink.do?TabPanelName=<%=""+request.getParameter("TabPanelName") %>&clear=yes"  title="Click to go to the Add General Agency Page" />Add General Agency</a> 
		...
		<dmshtml:dms_static_with_connector ruleName='privilage' property='<%=new String[]{"FIND_GENERAL_AGENCY_MENU"}%>' connector='or' negated="true">
			<IMG SRC="../Images/bullxred.gif" WIDTH="20" HEIGHT="20" BORDER="0" ALT="">
		  <a href="../FindGenaralAgencyAction.do?TabPanelName=<%=""+request.getParameter("TabPanelName") %>&clear=yes"  title="Click to go to the Add General Agency Page" />Find General Agency</a> 
