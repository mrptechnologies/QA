...
<bean:define id="ownerId" property="answer(Object::UserDetail::ownerId)" name="LoginPage" scope="session"/>
 <table WIDTH="98%" ALIGN="center" BORDER="0" CELLSPACING="0" CELLPADDING="2">
		...
		<tr><td class="NewSectionHead" colspan="4" align="center">FIND UNDERWRITER USER</td></tr>
		<tr><td><hr size="1" noshade></td></tr>
		<tr><td>
<table WIDTH="90%" ALIGN="center" BORDER="0" CELLSPACING="0" CELLPADDING="2">

<tr><td class="sectionhead" colspan ="2" align="center" >UNDERWRITER USER DETAILS</td></tr>
		    <tr><td>&nbsp;</td></tr>
	<tr>
		<td width="40%" align="right" class="FormLabels">
		Underwriter User Name
		</td> 
	...
	<tr>
		<td></td>
		<td class="links">
		  <html:hidden name="FindUsers" property="answer(Object::UserDetail::Equals::primaryRoleId)" value="3"/>
		</td>
    </tr>
