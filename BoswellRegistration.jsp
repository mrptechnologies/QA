...
<body bgcolor="blue">
 ...
 <tr>
		                      ...
		                      &nbsp; <IMG SRC="/Images/BoswellLogo.jpg" BORDER="0" ALT="" height="70"></td>                           
	                           </td>
                           </tr>
 <tr>
 <td>
 ...
 <table WIDTH="99.9%" style="height:90%" ALIGN="right" BORDER="0" CELLSPACING="0" CELLPADDING="0" bgcolor="">
                           ...
                           <tr height="2%" >
							...
							<tr height="2%">
								...
								<td class="links">&nbsp;
									Yes&nbsp;<input type=radio   name="answer(Object::Customer::CurrentCoverege)" value = yes  id="currentCoverege"onclick='showCoveregeQuestions("Yes");'/>
									No&nbsp;<input type=radio   name="answer(Object::Customer::CurrentCoverege)" value = No  id="currentCoverege1" onclick='showCoveregeQuestions("No");'/>
				...
				<table WIDTH="99.9%" style="height:93%" ALIGN="right" BORDER="0" CELLSPACING="0" CELLPADDING="0" bgcolor="">
					<tr>
								...
								<td class="links">&nbsp;
									<input type=text class="txtbox"  name="answer(Object::CustomerAdditional::EOCoverage)" size="11" maxlength="11" id="contractDate"/>
								</td>
							...
							<tr>							
							    ...
							    <td class="links" style="Class:txtbox">&nbsp;
								    <input type="text" class="txtbox" name=answer(Object::Customer::Sponsor) size=30 maxlength=40 id=sponsor />
					...
					<tr>
					    ...
					    <input type=hidden name="answer(Object::Notification::Email::FromAddress)" value="dineshkumar_r@solartis.net" />                               
