...
<%@ page import="java.util.ArrayList"%>
   <div class="content"> 
	<div class="formpage01">
	 <html:form action="/UpdateQuoteSectionCoverageDetail.do" styleId="sectionCoverageForm">
		<div class="formheadnew"><h2 class="left"> Section Coverage Details</h2></div>
		  <div>&nbsp;</div>
			<table width= "100%">
					...
					<tr>
						<td class="field" width="30%" align = "right">Type Code :</td>
						<td width="1%">&nbsp;</td>
						<td width="69%' align="left">
						  <html:text property="answer(Object::SectionCoverages::coverageTypeCode)" name="FindOutBoundTransactions" />
						</td>
					</tr>
    	 			<tr>
						<td class="field" width="30%" align = "right">Rating Basis Code :</td>
						<td width="1%">&nbsp;</td>
						<td width="69%' align="left">
						  <html:text property="answer(Object::SectionCoverages::coverageRatingBasisCode)" name="FindOutBoundTransactions" />
						</td>
					</tr>
					<tr>
						<td class="field" width="30%" align = "right">Currency of Amounts :</td>
						<td width="1%">&nbsp;</td>
						<td width="69%' align="left">
						  <html:text property="answer(Object::SectionCoverages::coverageCurrencyofAmount)" name="FindOutBoundTransactions" />
						</td>
					</tr>
					<tr>
						<td class="field" width="30%" align = "right">Exchange Rate :</td>
						<td width="1%">&nbsp;</td>
						<td width="69%' align="left">
						  <html:text property="answer(Object::SectionCoverages::ExchangeRate)" name="FindOutBoundTransactions" />
						</td>
					</tr>
					<tr>
						...
						<td width="1%">&nbsp;</td>
						<td width="69%' align="left">
				 		<html:text property="answer(Object::SectionCoverages::coverageLimitAmount)" name="FindOutBoundTransactions" />
						</td>
					</tr>
					<tr>
						...
						<td width="1%">&nbsp;</td>
						<td width="69%' align="left">
				 		  <html:text property="answer(Object::SectionCoverages::coveargeDeductible01)" name="FindOutBoundTransactions" />
						</td>
					</tr>
					<tr>
						...
						<td width="1%">&nbsp;</td>
						<td width="69%' align="left">
				 		  <html:text property="answer(Object::SectionCoverages::coveargeDeductible02)" name="FindOutBoundTransactions"/>
						</td>
					</tr>
					<tr>
						...
						<td width="1%">&nbsp;</td>
						<td width="69%' align="left">
				 		  <html:text property="answer(Object::SectionCoverages::CoveragePremium)" name="FindOutBoundTransactions" />
						</td>
					</tr>
					<tr>
						...
						<td width="1%">&nbsp;</td>
						<td width="69%' align="left">
				 		  <html:text property="answer(Object::SectionCoverages::CoverageAnnualisedPremium)" name="FindOutBoundTransactions" />
						</td>
					</tr>
					<tr>
						<td class="field" width="30%" align = "right">Rating Basis Amount :</td>
						<td width="1%">&nbsp;</td>
						<td width="69%' align="left">
				 		  <html:text property="answer(Object::SectionCoverages::CoverageRatingBasisAmount)" name="FindOutBoundTransactions"/>
						</td>
					</tr>
				        ...
				        <tr><td colspan="2">&nbsp;</td></tr>
				         ...
				         <td width="25%">
				          <td width="75%" align="left">
				           <html:button styleClass="covbutton" value="Save" property="save" onclick="submitQuoteSectionCoverageDetails()" />
