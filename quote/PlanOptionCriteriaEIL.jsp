...
<html:form action="/RateEILV2.do" onsubmit="return validateCoverages(this);">
...
<html:hidden  property="activeTabName" value='<%="Coverage_Limits_Tab"%>'/>
<html:hidden  property="answer(activeTabName)" value='<%="Coverage_Limits_Tab"%>'/>
</TD>
</TR>
</TABLE>													
<div class="formpage1">	
...
<div class="formhead"><h2 class="left">Coverages and Limits</h2></div>  
	...
	<div style='margin-right: 5pt; display: block; float:left; margin:0 5px 0 0 ;padding-top:0'>
		<dmshtml:isFeatureAvailableForProductRoleStatus roleId='<%=Long.parseLong(""+objDescId) %>' productId='<%=Long.parseLong(""+prodId) %>' dbName='<%=com.dms.web.util.DbUtils.getReadDS(pageContext)%>' featureId="RATE_AVAILABLE" property='<%=new String[]{""}%>' value="" negated="true">
			<div class='navValue' title="<bean:message key='ToolTip.CoveragesLimits.Rate'/>"><INPUT TYPE='button'  value='Rate' class="covbutton left" id="RateTop" onclick="document.getElementById('fc').value = 'Rate';AJAXRateAndSave();" name='answer(form::ForwordControl1)'></div>
		</dmshtml:isFeatureAvailableForProductRoleStatus>	
			</div>
	<div style='margin-right: 5pt; display: block; float:left; margin:0 5px 0 0 ;padding-top:0'><div class='navValue' title="<bean:message key='ToolTip.CoveragesLimits.Save'/>"><INPUT TYPE='button' value='Save' class="covbutton left" id="SaveTop" onclick="document.getElementById('fc').value = 'Save';if(this.form.ExpiringPremium.value == ''){this.form.ExpiringPremium.value ='$0.00';};AJAXRateAndSave();" name='answer(form::ForwordControl1)'></div></div>
	</div>
	...
	<div id='savingcontent1' style="display:none">
	<IMG SRC="../Images/loader1.gif"  BORDER="0" align="top" id="loader">
	<IMG SRC="../Images/loader1.gif"  BORDER="0" align="top" id="loader">
	<IMG SRC="../Images/loader1.gif"  BORDER="0" align="top" id="loader">
	Saving....
...
<html:hidden property="answer(Object::Plan::TermInMonths)" />
	...
	<div style='margin-right: 5pt; display: block; float:left; margin:0 5px 0 0 ;padding-top:0'>
		<dmshtml:isFeatureAvailableForProductRoleStatus roleId='<%=Long.parseLong(""+objDescId) %>' productId='<%=Long.parseLong(""+prodId) %>' dbName='<%=com.dms.web.util.DbUtils.getReadDS(pageContext)%>' featureId="RATE_AVAILABLE" property='<%=new String[]{""}%>' value="" negated="true">
			<div class='navValue' title="<bean:message key='ToolTip.CoveragesLimits.Rate'/>"><INPUT TYPE='button'  value='Rate' class="covbutton left" id="RateBottom" onclick="document.getElementById('fc').value = 'Rate';AJAXRateAndSave();" name='answer(form::ForwordControl1)'></div>
		</dmshtml:isFeatureAvailableForProductRoleStatus>	
			</div>
	<div style='margin-right: 5pt; display: block; float:left; margin:0 5px 0 0 ;padding-top:0'><div class='navValue' title="<bean:message key='ToolTip.CoveragesLimits.Save'/>"><INPUT TYPE='button' value='Save' class="covbutton left" id="SaveBottom" onclick="document.getElementById('fc').value = 'Save';if(this.form.ExpiringPremium.value == ''){this.form.ExpiringPremium.value ='$0.00';};AJAXRateAndSave();" name='answer(form::ForwordControl1)'></div></div>
	</div>
	...
	<div id='savingcontent2' style="display:none">
	<IMG SRC="../Images/loader1.gif"  BORDER="0" align="top" id="loader">
	<IMG SRC="../Images/loader1.gif"  BORDER="0" align="top" id="loader">
	<IMG SRC="../Images/loader1.gif"  BORDER="0" align="top" id="loader">
	Saving....
