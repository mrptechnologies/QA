...
<template:put name='ProgressBar' content='/common/ProgressBarCovLimits.jsp' />
<template:put name='Header1' content='/submission/SubmissionHeaderBody.jsp' />
<template:put name='GeneralBody' content='/submission/SubmissionRequestedCoverageApplicationBody3.0.jsp' /> 
