...
<SCRIPT type="text/javascript" src="../Scripts/JScripts/FindOutBoundProcessedErrorTransactions.js"></SCRIPT>
...
<html:form action="/FindProcessedErrorTransDetails.do" onsubmit="return false;">
<div class="formpage01">
<div class="content">
<div class="formheadnew"><h2 class="left">Find Outbound Transaction Error Received from Genius</h2></div>
<div>&nbsp;</div>
...
<div class="field" style="width:431px">Transaction Type :
...
<div class="field" style="width:425px">Submission # :
 <input type="text" name="answer(Object::BatchLog::Equals::SubmissionNo)" maxlength="15" style="width:100px" id="SubmissionNo"/> 
</div>
<div class="field" style="width:425px">Policy # :
 <input type="text" name="answer(Object::BatchLog::Equals::PolicyNo)" maxlength="15" style="width:100px" id="PolicyNo"/> 
</div>
<div class="formcontent" style="width:50%;" align="center"><center>
<input type="submit" value="Find >" class="covbutton" onclick="FindProcessedErrorTransDetails('../FindProcessedErrorTransDetails.do')" style="width:90px;">	</center>
...
<div id="errorDetail">
	<div id="ERROR_CONT"></div><a class="container-close" href="javascript:void(0);" onclick="document.getElementById('ERROR_CONT').innerHTML='';YAHOO.example.container.errorDetail.hide();"></a>
</div>
</td>
</tr>
</table>
