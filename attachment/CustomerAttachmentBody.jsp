...
<input type="hidden" name="answer(Object::AttachmentObjectLink::ObjectType)" value="CUSTOMER" id="objType">
...
document.getElementById("Viewsuccess").style.display = 'block'
    ...
    document.getElementById("attachmentDesc").value = "";
     ...
     u.innerHTML="<input type='file' name='myFile' maxlength='127' size='43' value='' id='myFile'><input type='submit' value='Submit'></td></tr>&nbsp;<tr><td><iframe id='upload_target_iFrame' name='upload_target_iFrame' src='../common/MessageFromRule.jsp'  style='width:300px;height:30px;border:1px solid #ccc;' onload = 'refreshTree()' ></iframe>";
...
var ajax = new Ajax.Updater({success: 'success'},'../DeleteAttachment.do?',{method: 'get', parameters:pars},onComplete:function(){forwardToLoginPageIfInvalidSession(document.getElementById("success").innerHTML);});
