...
<bean:define id="ownerId" property="answer(Object::UserDetail::ownerId)" name="LoginPage" scope="session"/>
	...
	<table WIDTH="95%" ALIGN="center" BORDER="0" CELLSPACING="2" CELLPADDING="0">
		<tr><td>&nbsp;</td></tr>
		<tr><td class="NewSectionHead" align="center">
			AGENCIES
		</td></tr><tr><td>&nbsp;</td></tr>
		...
		<tr><td class="TextMatter" colspan="3">
				...
				<table WIDTH="85%" ALIGN="center" cellspacing=0 cellpadding="4">
					<tr><td class="links" colspan="3"><img SRC="../Images/rtg_rate.gif" alt="">&nbsp;&nbsp;<a href="../AgencyLink.do?TabPanelName=<%=""+request.getParameter("TabPanelName") %>&clear=yes" title="<bean:message key='ToolTip.AgencyList.AddAgency'/>"><bean:message key="Agencies.AddAgency"/></a></td></tr>
					...
					<logic:present name ='searchresultnewDisplay' scope ='request'>
						...
						<tr><td align="Left" class="links" colspan="3">
								...
								<a href="../ListOfAgency.do?TabPanelName=<%=""+request.getParameter("TabPanelName") %>&answer(ownerId)=<%=""+ownerId %>&LimitSearch=yes&answer(Object::Agency::PageNum)=<%=(Integer.parseInt(""+pagenum)-1)%>" title="<bean:message key='ToolTip.AgencyList.PrevPage'/>"><bean:message key="Common.Previous"/></a>
								</logic:present>
							</td>
							<td align="right" class="links" colspan="3">
								<logic:present name="moreAgency"  scope="request" >

								<a href="../ListOfAgency.do?TabPanelName=<%=""+request.getParameter("TabPanelName") %>&answer(ownerId)=<%=""+ownerId %>&LimitSearch=yes&answer(Object::Agency::PageNum)=<%=(Integer.parseInt(""+pagenum)+1)%>" title="<bean:message key='ToolTip.AgencyList.NextPage'/>">Next&gt;&gt;</a>
								</logic:present>
							</td>
						</tr>
						...
						<tr>
							...
							<td class="SearchResult" >
									<a href="../EditAgencies.do?TabPanelName=<%=""+request.getParameter("TabPanelName") %>&agencyId=<%=qmap.getString("Object::AGENCY::AGENCYID")%>&primaryObjectId=<%=qmap.getString("Object::AGENCY::AGENCYID")%>&primaryObjectType=AGENCY" title="<bean:message key='ToolTip.AgencyList.AgencyName'/>"><%=qmap.getEncodedString("Object::AGENCY::BUSINESSNAME")%></a>
