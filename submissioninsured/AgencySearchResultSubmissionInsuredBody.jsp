...
<html:form action="/LinkAgenttoInsuredSubAction1.do">
 <div class="formpage01">
	<table WIDTH="98%" ALIGN="center" BORDER="0" CELLSPACING="0" CELLPADDING="0">
		...
		<tr><td><html:hidden property="formName" value="form::SEARCHAGENT" /></td></tr>
      	<tr>
			<td colspan="4"><div class="formhead"><h2 class="left">AGENCIES FOUND IN SEARCH</h2></div></td>
		</tr>
		<tr><td>&nbsp;</td></tr>
		<tr>
  	...
  	<logic:present name ='searchresultnewDisplay' scope ='request'>
        <tr><td><h3>Total Number of Agencies Found &nbsp;&nbsp;<%=strcnt%></h3></td></tr>
		<tr><td>&nbsp;</td></tr>
		<tr>
			<td>
				<bean:define name="AddCustomer" property='answer(Source::PageName)' id="sourcePageName"/>
				<html:hidden property="answer(Source::PageName)" styleId="pageName" value="<%="" + sourcePageName %>" />
				<% if(("" + sourcePageName).equalsIgnoreCase("SubmissionSummary")){ %>
					<html:button styleClass="covbutton" style="width:300px" property="answer(gotoAgencySearchPage)" value="Go To Submission Agency Search Page" onclick="GoTOSubmissionAgencyFind()"/>
				<% } else if(("" + sourcePageName).equalsIgnoreCase("InsuredSummary")) { %>
					<html:button styleClass="covbutton" style="width:300px" property="answer(gotoAgencySearchPage)" value="Go To Insured Agency Search Page" onclick="GoTOInsuredAgencyFind()"/>
				<% } %>
			</td>
		</tr>
		<tr>
     	...
     	<tr>
     	 <td>
         	<table WIDTH="98%" ALIGN="center" class="loctable" cellspacing="2" cellpadding="2">
			 	<bean:define id="pagenum" name='pagenum' scope='request'/>
				<bean:define id="totpagenum" name='totpagenum' scope='request'/>
				<tr><td colspan="10">&nbsp;</td></tr>
	            <tr>
					<td align="right" colspan="10">
						<html:submit value="Select" property="answer(Select)" styleClass="covbutton"/>
					</td>
				</tr>
		        <tr>
					<td align="Left" class="links" colspan="5" >
						<logic:present name="firstAgency"  scope="request" >
							<a href="../AgencySearchInsuredSubAction1.do?TabPanelName=<%=""+request.getParameter("TabPanelName") %>&answer(ownerId)=<%=""+ownerId %>&LimitSearch=yes&answer(Object::Agency::PageNum)=0">&lt;&lt;First</a>
						</logic:present>&nbsp;&nbsp;
						<logic:present name="prevAgency"  scope="request" >
							<a href="../AgencySearchInsuredSubAction1.do?TabPanelName=<%=""+request.getParameter("TabPanelName") %>&answer(ownerId)=<%=""+ownerId %>&LimitSearch=yes&answer(Object::Agency::PageNum)=<%=(Integer.parseInt(""+pagenum)-1)%>"><bean:message key="Common.Previous"/></a>
						</logic:present>
					</td>
					<td align="right" class="links" colspan="5">
						<logic:present name="moreAgency"  scope="request" >
							<a href="../AgencySearchInsuredSubAction1.do?TabPanelName=<%=""+request.getParameter("TabPanelName") %>&answer(ownerId)=<%=""+ownerId %>&LimitSearch=yes&answer(Object::Agency::PageNum)=<%=(Integer.parseInt(""+pagenum)+1)%>">Next&gt;&gt;</a>
						</logic:present>&nbsp;&nbsp;
						<logic:present name="lastAgency"  scope="request" >
							<a href="../AgencySearchInsuredSubAction1.do?TabPanelName=<%=""+request.getParameter("TabPanelName") %>&answer(ownerId)=<%=""+ownerId %>&LimitSearch=yes&answer(Object::Agency::PageNum)=<%=(Integer.parseInt(""+totpagenum)-1)%>">Last&gt;&gt;</a>
						</logic:present>   
					</td>
				</tr>
 				<tr>
					...
					<!-- dmshtml:dms_static_with_connector ruleName='privilage' property='<%=new String[]{"DATABASE-ID-VIEW"}%>' connector='or' negated="true" -->	
		   	 	    <td  width="10%" align="center">Agency/Broker Code</td>		   	 	    
					<!-- /dmshtml:dms_static_with_connector -->
					
					<td  width="23%" align="center">Agency Name</td>
					
					<td  width="20%" align="center">Address 1</td>
					
					<td  width="20%" align="center">Address 2</td>
					
					<td width="10%" align="center">City</td>
					
					<td  width="2%" align="center">State</td>
				...
				<tr>
					...
					<td>
						...
						<%=qmap.getEncodedString("Object::AGENCY::BUSINESSNAME")%>
					</td>
					
					<td>
						<%=qmap.getEncodedString("Object::AGENCY::Address1")%>
					</td>
					
					<td>
						<%=qmap.getEncodedString("Object::AGENCY::Address2")%>
					</td>
					
					<td>
						<%=qmap.getEncodedString("Object::AGENCY::City")%>
					</td>
										
					<td align="center">
						<!--bean:write name="agencysearchresult" property="businessName" /-->
						<%=qmap.getEncodedString("Object::AGENCY::AddressState")%>
					</td>
					
					<td>
						<%=qmap.getEncodedString("Object::AGENCY::Zip")%>
					</td>
					
					<td  align="center">
						<%=qmap.getEncodedString("Object::AGENCY::Status")%>
					</td>
