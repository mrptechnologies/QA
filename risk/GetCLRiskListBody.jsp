							...
							<table WIDTH="1000px" ALIGN="center" BORDER="0" CELLSPACING="2" CELLPADDING="0">
								...
								<tr>
									<td class="links" align="left" colspan="2" width="20%">
										<a href="/AddResProperty1.do?answer(TabPanelName)=Insured_Panel&answer(Object::UserDetail::ownerId)=<%=""+ownerId%>&answer(OwnerId)=<%=""+ownerId%>&answer(Object::Risk::ComProperty::CustomerId)=<%=""+customerId%>&answer(objectId)=0&answer(Object::Risk::ComProperty::ComPropertyId)=-1&answer(objectVerId)=0&answer(objectName)=HOME_RISK&answer(applicationType)=RISK&answer(applicationSubType)=&Navigation=&answer(teritory)=<%=""%>&answer(state)=<%=""%>&answer(territoryName)=<%=""%>&answer(zone)=<%=""%>&answer(showOnetTab)=Y&tabNo=0&answer(Object::Agency::AgencyId)=<%=id.toString()%>&answer(Object::Risk::ComProperty::ComPropertyId)=-1&answer(SelectedRiskType)=COMMERCIAL<%=" "%>AUTO&answer(Object::Risk::ComProperty::CustomerId)=<%=""+customerId%>" title="Click to go to add a New Risk" />Add Risk</a>
									</td>
				...
				<td>
					<table WIDTH="1000px" ALIGN="center" border="0"CELLSPACING="0" CELLPADDING="2">
						...
						<logic:iterate id="arrOfInCompRiskQmap" name="ArrOfInCompRiskQmap" >
							...
							<tr>
								<td class="SearchResult" align="center">
									<a href="../EditCLRisk.do?TabPanelName=Insured_Panel&answer(Object::Risk::ComProperty::ComPropertyId)=&answer(Object::Risk::ComProperty::CustomerId)=<%=""+customerId %>&answer(Object::Agency::AgencyId)=<%=id.toString()%>&answer(objectId)=0&answer(objectVerId)=0&answer(objectName)=&answer(applicationType)=RISK&answer(applicationSubType)=&Navigation=&tabNo=0&answer(teritory)=&answer(territoryName)=&answer(zone)=&answer(showOnetTab)=Y&answer(state)=
