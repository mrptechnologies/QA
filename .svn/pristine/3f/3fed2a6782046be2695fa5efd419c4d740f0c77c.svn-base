...
var pars1='ObjectId='+ObjectId+'&OwnerId='+OwnerId;
			...
			var ajax = new Ajax.Updater({success: 'success1'},'../notes/NotesAdd.jsp',{method: 'post',onComplete:function(){forwardToLoginPageIfInvalidSession(document.getElementById("success").innerHTML);}});		
