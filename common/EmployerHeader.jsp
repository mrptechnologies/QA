				...
				<td valign="top">
					<table width="100%" align="Left" border="0" bgcolor="#C6DEEA" >
						...
						<tr>										
							...
							<td class="FormLabels" align="left" width="160px"><bean:message key="CustomerSearchResult.EmployerGroupNameHealthIns"/></td>
							...
							<bean:define id="customerDetailMap" name="customerDetail1" scope="request"
								...
								employerGroupStatus=customerDetailMap.getString("custStatus");
								...
								generalAgencyName=customerDetailMap.getString("generalagencyname");%>
									...
									<td class="sectionhead1" align="left" width="220px">
										<dmshtml:dms_static_with_connector ruleName='privilage' property='<%=new String[]{"VIEW_CUSTOMER"}%>' connector='or' negated="true">
											<a href="../GetCustomerAction.do?TabPanelName=Insured_Panel&customerId=<%=cId.toString()%>&answer(Object::Customer::CustomerId)=<%=cId.toString()%>&answer(Object::Agency::AgencyId)=<%=""+lngAgencyId%>" ><%=customerDetailMap.getString("custname")%></a>
										</dmshtml:dms_static_with_connector>
										<dmshtml:dms_static_with_connector ruleName='privilage' property='<%=new String[]{"VIEW_CUSTOMER"}%>' connector='or' negated="false">
											<%=customerDetailMap.getString("custname")%>
										</dmshtml:dms_static_with_connector>
								</td>
							</logic:present>
						 </tr>
						...
						<%} %>
								...
								<%
		     					String employerGroupStatus1=""+employerGroupStatus;
				...
				<td valign="top">
					<table width="100%" align="Left" border="0" bgcolor="#C6DEEA" >
						...
						<tr>
							...
							<td class="sectionhead1" align="left" width="50%">
							
								<%
								if(lngAgencyId>0){ %>
									<dmshtml:dms_static_with_connector ruleName='privilage' property='<%=new String[]{"AGENCY_VIEW"}%>' connector='or' negated="true">	
									<a href="../GetAgencySummary.do?ReadOnly=Yes&agencyId=<%=""+lngAgencyId%>&primaryObjectId=<%=""+lngAgencyId%>&primaryObjectType=AGENCY" onclick="return AgencyPopup(this,'Agency');" title="Agency" ><%=agencyName%></a>
									</dmshtml:dms_static_with_connector >
						...
						<tr>
							<td class="FormLabels" align="left" colspan="1">
								<bean:message key="Top.EmployerGroupStatus"/>
							</td> 
							<td class="sectionhead1" align="left" colspan="2">
								<%
								if(!employerGroupStatus.equals("")){%>
										<%=employerGroupStatus1%></a>							
								<%}%>
							</td>
						</tr>						
