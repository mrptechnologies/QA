...
<html:form action="/LinkOptionVerToProduct">
...
<tr><td>&nbsp;</td></tr>
<tr><td class="MH">
LINK OPTION VERSIONS AND PRODUCT VERSION
</td></tr>
<tr><td class="TextMatter">
Use this page to link options versions to product versions
<br>
</td></tr>
...
<td class="FormLabels" align="left">Select option version(s) to be linked to the product version</td></tr>
<tr><td>
...
<tr>
		<td width="15%"><dmshtml:get_available_product_ver_options nameInSession="arrOptions" ownerId="<%=Long.parseLong(""+ownerId)%>"
...
<td width="30%"><dmshtml:get_product_ver_options nameInSession="arrProdOptions" ownerId="<%=Long.parseLong(""+ownerId)%>" productVerId="<%=Long.parseLong(request.getParameter("answer(Object::Product::ProductVerId)").toString())%>" dbname="<%=com.dms.web.util.DbUtils.getReadDS(pageContext)%>"/>
		<dmshtml:dms_select  property="answer(Object::ProductOptions::OptionVerId)" styleId="chosen" multiple="true" size="7" >
...
<html:hidden property="answer(objectType)" value="productVerOption" />
