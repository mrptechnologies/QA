...
<title>Welcome to The Treiber Agency Group. LLC</title>
<!-- <html:base/> -->
...
<table WIDTH="100%" style="height:100%" ALIGN="center" BORDER="0" CELLSPACING="0" CELLPADDING="0">
	...
	<td width="60%" align="center" valign="middle"><IMG SRC="Images/tre.jpg" BORDER="0" ALT=""></td>
					...
					<TABLE WIDTH="90%" ALIGN="center" BORDER=1 CELLSPACING=0 CELLPADDING=0 bgcolor="#f1f1f1">
						<TR>
							<TD>&nbsp;
								...
								<input type="hidden" name="solartisTabView" value="UI_2.0">
								<!-- tr>
									<TD align="right" class="FormLabels">
									<b>
									UI
		...
		<%
		 ...
		 session.setAttribute("ownerId","9");
		 session.setAttribute("dbname","java:/jdbc/Treiberds");
		 session.setAttribute("ReadDS","java:/jdbc/Treiberds");
		 session.setAttribute("WriteDS","java:/jdbc/Treiberds");
	...
	<tr>
	   <td>
		...
		<INPUT name="answer(Object::UserDetail::siteId)" type=hidden value="9"/>
		<INPUT name="answer(Object::UserDetail::ownerId)" type=hidden value="9"/>
		<INPUT name="answer(dbname)" type=hidden value="java:/jdbc/Treiberds"/>
		<INPUT name=ownerId type=hidden value="9"/>
		<INPUT name=formName type=hidden value="form::LoginMICACARE"/>
		<INPUT name=page type=hidden value="1"/>
		<INPUT name=page type=hidden value="1"/>
		<INPUT name="answer(INSURANCE_TYPE)" type=hidden value="PC"/>
		<INPUT name="answer(Page::Title)" type=hidden value="The Treiber Agency Group. LLC"/>
		<INPUT name="answer(PageLogo)" type=hidden value="../Images/treiber_small_logo.jpg"/>
