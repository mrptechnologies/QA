...
<bean:define id="productId" property="answer(Object::Product::Document::PrdId)" name="AddProductDocumentVersionDetail" />
<bean:define id="productVerId" property="answer(Object::Product::Document::PrdVerId)" name="AddProductDocumentVersionDetail" />
<bean:define id="productDocType" property="answer(Object::Product::DocGroup::PrdDocType)" name="AddProductDocumentVersionDetail" />

<html:form action="/DocumentVersionAssociateToProductAction.do">
	<table WIDTH="90%" ALIGN="center" BORDER="0" CELLSPACING="0" CELLPADDING="2">
		...
		<tr><td class="NewSectionHead" colspan="4" align="center">ASSOCIATE DOCUMENT VERSION </td></tr>

		<tr><td>&nbsp;</td></tr>
		
		<logic:present name="DocumentAssociateToProductMessage">
			<tr><td width="40%" class="Error"><%= request.getAttribute("DocumentAssociateToProductMessage") %></td></tr>
		</logic:present>
		
		<tr><td height="15"></td></tr>
		
		<tr>
			<td width="30%" class="FormLabels" align="left">Associated Document List</td>
		</tr>
				...
				<table width="880px" ALIGN="center" BORDER="0" style="{border-width:1px; border-style:solid; border-color: #999999;}">		
					...
					<dmshtml:getAssociatedDocumentList nameInSession="AssociatedDocumentVersion"
						...
						<tr>
							...
							<td class="sectionheadLink" width="30%" align="center">Version Name</td>
						...
						<% int count=0; %>
							...
							<logic:iterate id="AssociatedDocumentVersion" name="AssociatedDocumentVersion" scope="request">
								...
								<tr>
									...
									<td class=<%=styleClass %> align="left" width="10%"><bean:write name="AssociatedDocumentVersion" property="documentNum" />&nbsp;</td>
									<td class=<%=styleClass %> align="left" width="30%"><bean:write name="AssociatedDocumentVersion" property="versionName" />&nbsp;</td>
									<td class=<%=styleClass %> align="left" width="10%"><bean:write name="AssociatedDocumentVersion" property="documentType" />&nbsp;</td>
									...
									<logic:present name="arrayOfProductVerDetailList">
										...
										%>										
										<td class=<%=styleClass %> align="left" width="2%"><%= ""+productDocumentDefinitionDetail.getOrderIndex() %></td>
										<td class=<%=styleClass %> align="left" width="2%"><%= ""+productDocumentDefinitionDetail.getMantatory() %></td>										
										<td class=<%=styleClass %> align="left" width="2%"><%= ""+productDocumentDefinitionDetail.getRepeatedDoc() %></td>																				
										<td class=<%=styleClass %> align="left" width="10%"><%= ""+productDocumentDefinitionDetail.getRuleName() %></td>
									</logic:present>
								</tr>
							</logic:iterate>			
					</logic:present>
		...
		<tr>
			<td width="30%" class="FormLabels" align="left">Selected Document Version List For Association</td>
		</tr>
							...
							<table width="880px" ALIGN="center" BORDER="0" style="{border-width:1px; border-style:solid; border-color: #999999;}">
								...
								<logic:present name="SelectedDocumentsDetails" scope="request">
									...
									<logic:iterate id="SelectedDocumentsDetails" name="SelectedDocumentsDetails">
										...
										<tr>
											...
											<td class='<%= styleClass %>' width="2%" ><%= ""+i %></td>
											<td class='<%= styleClass %>' width="5%" ><bean:write name="SelectedDocumentsDetails" property="documentNum" /></td>
											<td class='<%= styleClass %>' width="30%"><bean:write name="SelectedDocumentsDetails" property="versionName" /></td>					
								...
								<tr>
									<td>				
										...
										<html:hidden property="answer(IsVersionAssociation)" value="YES" />
