...
<style type="text/css">
  .locformpages{border:1px #f0aa39 solid;width:865px;margin:0 auto;padding:9px;background:url(D:/jboss/jboss-4.0.5.GA/server/default/deploy/ins.war/styles/ui3.0/i/bodybg1.gif)repeat-x;}
...
<%				 
 ...
 %>
 	 <logic:present name='ClassDetail'>
	 	<bean:define id="ClassId" name="ClassDetail" property="Object::Risk::RiskId" />
		<%strClassId =""+ClassId; %>
 	</logic:present>
 	<table class="yui-dt-table" cellspacing="0"  cellpadding="0" width="100%">  	
  	<tr><td>
	 	<div id="classHazardTab">
	 		 <a href="javascript:void(0);" id="ClassInformation" onclick="getEditClassPopUp('<%=""+strClassId%>');activateTabsClassHazards(this.id);" class="loctab_active left">	
			 <div id="ClassInformation">Class Information</div></a>
			 <a href="javascript:void(0);" id="hazardQuestion" onclick="showHazards(this.id);" class="loctab_inactive left">	
		 	 <div id="hazardQuestion">Hazards Question</div></a>
		     <a href="javascript:void(0);" id="hazardList" onclick="showHazardsList1(this.id);" class="loctab_inactive left">	
		 	 <div id="hazardList">Hazards List</div></a>
		</div>	
	</td></tr>
	<tr><td>
		<div class="todotab_yellowbox2" id="Loc3TableData" style="display:none;">		
		    <div id="ClassList1" class="locformbox1">
		         	<table class="yui-dt-table" cellspacing="0" cellpadding="0" width="100%">
		        	   ...
		        	   <logic:present name='ClassDetail'>	
		        	   <bean:define id="newClassName1"  property="Object::Risk::Class::ClassName" name="ClassDetail" />
		        	   <%  newClassName=""+newClassName1; %>
		        	   <bean:define id="ClassDescription" name="ClassDetail" property="Object::Risk::Class::ClassDescription" />
		        	   <%strClassDescription =""+ClassDescription; %>
		        	    <bean:define id="ClassId" name="ClassDetail" property="Object::Risk::RiskId" />
		        	   <%strClassId =""+ClassId; %>
		        	   <tr class="yui-dt-even">
		
		        	   		<td><div class="yui-dt-liner"><p class="tableData"><a href="javascript:void(0);" onclick="javascript:getEditClassPopUp();"><%=""+newClassName %></a></p></div></td>
		 ...
		 <div id="AddClassDiv" class="todotab_yellowbox2" style="width:870px;both;display:none;background-color:#fff;both;border-top: #F0AA3A 1px solid;">
			<div class="formpage4">
				<div class="content">
		 ...
		 <div id="dialog1" class="todotab_yellowbox2" style="border-top: #F0AA3A 1px solid;width:870px;">
   		 </div>
		<div id="benefitContent" class="todotab_yellowbox2" style="background-color:#fff;width:850px;both;border-top: #F0AA3A 1px solid;display:none;"></div>
		<div id='loadercontent2' style="display:none"><IMG
		...
		<div id="saveSuccess2" style="display:none;color:red;font-weight:bold;">
			Saved Successfully and recalculating
			
		</div>
	</td></tr>
	<tr><td><input type="hidden" id="classId" name="class" value="<%= ""+strClassId%>"/></td></tr>
	<tr><td><input type="hidden" id="className" name="className" value="<%= ""+newClassName%>"/></td></tr>
	</table>
