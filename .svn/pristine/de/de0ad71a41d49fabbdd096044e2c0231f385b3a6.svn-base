...
<h3 style="margin:20px 0 0 20px;">Schedule Of Aircraft</h3>
...
<script type="text/javascript" src="../cvstarr/scripts/AddOrEditAircraft.js"></script>
<style type="text/css">
...
<%				 
     ...
     int Number = 1;
 %>
 <html:form action="/DeleteAircraft.do" scope="request">
        	...
        	<logic:iterate id="AircraftListArray" name="AircraftListArray" >
        	   ...
        	   <%quoteId1=""+NewQuoteId; %>
               		...
               		<td><div class="yui-dt-liner"><p class="tableData"><a href="javascript:void(0);" onclick="getEditAircraftWindow('<%=""+AircraftRiskId%>')"><%=Year %></a></p></div></td>
        	   	   	...
        	   	   	<p class="tableData">
        	   	   	<html:checkbox property="answer(Object::Quote::Check)" onclick="return confirmDelete();" name="QuoteDetail" value="<%=""+AircraftRiskId %>"/>
        	   	   	</p>
        	   	   	</div>
        	   	   	</td>	
        	   	</tr>
	...
	<table> 
		<tr>
     		...
     		<div style="width:900px;">
     			<html:submit value="Delete" style="float:right;" styleClass="covbutton" onclick="return confirmDelete();"/>     			
     			<input type="button" style="float:right;" class="covbutton" value="Add" onclick="LoadNewQuoteAddEditAircraft();"/>
     		</div>
     		</td>
     	</tr>
</table>
