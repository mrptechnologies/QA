...
<SCRIPT type="text/javascript" >
	function navigate(nextOrPre)
	{
	 ...
	 formElement.action="../FindAllInsuredXml.do?answer(ownerId)=<%=""+ownerId %>&answer(Object::Customer::PageNum)="+nextOrPre;
...
<html:form action="/XMLGeneratorAction" >
	...
	<table WIDTH="1200px" ALIGN="center" BORDER="0" CELLSPACING="2" CELLPADDING="0">
		<tr>
			<td height="5"></td>
		</tr>
		...
		<dmshtml:dms_static_with_connector ruleName='privilage' property='<%=new String[]{"ADD_COM_INSURED_MENU"}%>' connector='or' negated="true">
			<dmshtml:dms_static_with_connector ruleName='privilage' property='<%=new String[]{"CUSTOMER_CREATE","CUSTOMER_MODIFY"}%>' connector='or' negated="true">	
				<tr>
					<td class="links" align="left" colspan="2"><a href="../AddInsuredCom.do?TabPanelName=Insured_Panel&clear=yes" >Add Insured</a></td></tr>
