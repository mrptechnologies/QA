...
<SCRIPT type="text/javascript" src="../Scripts/JScripts/FindOutBoundGetDataFeedTransactions.js"></SCRIPT>
...
<html:form action="/FindGetDataFeedTransactionDetails.do" onsubmit="return false;">
<div class="formpage01">
<div class="content">
<div class="formheadnew"><h2 class="left">Find GetDataFeed Batch Records sent to Genius</h2></div>
<div>&nbsp;</div>
...
<div class="field" style="width:485px">Transaction Status :
<html:select property="answer(Object::BatchLog::TransactionStatus)" styleClass="txtbox">
	...
	<html:option value ="TREATY_HOLD">Treaty Hold</html:option>
</html:select>
</div>
...
<input type="submit" value="Find >" class="covbutton" onclick="FindGetDataFeed('../FindGetDataFeedTransactionDetails.do')" style="width:90px;">	</center>
</div>
