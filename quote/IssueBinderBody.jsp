...
<% String planeState = (request.getParameter("answer(state)")).toString(); %>
	...
	<html:form action="/IssueBinder.do" onsubmit="return checksubmitandvalidatedate();">	
															...
															<table width="100%" border="0" align="left">
																...
																<dmshtml:dms_isPresent property='<%=new String[]{"Bind Request"}%>' value="<%="Bind Request"%>" negated="true">
																	...
																	<tr>
																		...
																		Effective Date
																		&nbsp;</td>
																		<td class="sectionhead1"><html:text value='<%=""+quoteStartDate%>' property="answer(Object::Quote::QuoteStartDate)" size="30" maxlength="30" styleId="txtDate" styleClass='txtbox' onchange="return validateDate('submit');" /></td>																		
																	</tr>																
