...
<title>Welcome to Temic, Inc.</title>
<!-- <html:base/> -->
...
<table WIDTH="100%" style="height:100%" ALIGN="center" BORDER="0" CELLSPACING="0" CELLPADDING="0">
	...
	<td width="60%" align="center" valign="middle"><IMG SRC="Images/cis_logo.gif" WIDTH="135" HEIGHT="135" BORDER="0" ALT=""></td>
		...
		<%
		 ...
		 session.setAttribute("ownerId","7");
	...
	<tr>
	   <td>
		...
		<INPUT name="answer(Object::UserDetail::siteId)" type=hidden value="7"/>
		<INPUT name="answer(Object::UserDetail::ownerId)" type=hidden value="7"/>
		<INPUT name="answer(dbname)" type=hidden value="java:/jdbc/solartisds"/>
		<INPUT name=ownerId type=hidden value="7"/>
		<INPUT name=formName type=hidden value="form::LoginMICACARE"/>
		<INPUT name=page type=hidden value="1"/>
		<INPUT name=page type=hidden value="1"/>
		<INPUT name="answer(INSURANCE_TYPE)" type=hidden value="Health"/>
		<INPUT name="answer(Page::Title)" type=hidden value="Temic, Inc."/>
		<INPUT name="answer(PageLogo)" type=hidden value="../Images/cis_logo.gif"/>
