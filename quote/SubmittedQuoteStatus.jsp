...
<template:put name='Header2' content='/common/QuoteHeaderSubmittedQuoteStatusCover.jsp' />
<template:put name='GeneralBody' content='/quote/SubmittedQuoteStatusBody.jsp' /> 
