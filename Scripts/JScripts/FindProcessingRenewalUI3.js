...
function findProcessingRenewals(dataSourceURL) {

	if(GoTOFindButton())
		listProcessingRenewals(dataSourceURL);	
}

function listProcessingRenewals(dataSourceURL) {
	...
	YAHOO.example.DynamicData = function() {	  		  
	    ...
	    var formatQuoteNumLink = function(elCell, oRecord, oColumn, sData) {	
	       	...
	       	var link="<a href='../GetEndorsementQuoteDetail.do?answer(Object::Customer::CustomerId)="+oRecord.getData("CustomerId")+
	       		...
	       		"&answer(policyNumber)="+oRecord.getData("RenewingPolicy")+
	       		"&answer(Object::Policy::ParentPolicyId)="+oRecord.getData("PolicyId")+
	       		"&answer(Object::Policy::ParentPolicyVerId)="+oRecord.getData("PolicyVerId")+
	       		"&answer(Object::Agency::AgencyId)="+oRecord.getData("agencyId")+
	       		"&answer(policyEffDate)="+oRecord.getData("RenewingPolicyEffectiveDate")+
	       		"&answer(policyExpDate)="+oRecord.getData("RenewingPolicyExpirationDate")+"'>"
	   ...
	   var formatRenewingPolicyTotalPremium = function(elCell, oRecord, oColumn, sData) {	
	    ...
	    var myColumnDefs = [ // sortable:true enables sorting 
	        ...
	        {key:"InsuredName", label:"Insured Name",formatter:formatLink,sortable:true,resizable:"false",width:90}, 
	        {key:"AgencyName", label:"Agency Name",sortable:true,resizable:"false",width:90}, 
	        ...
	        {key:"RenewingPolicy", label:"Policy #",resizable:"false",width:110,formatter:formatPolicyNumLink,sortable:true}, 
	        {key:"RenewingPolicyEffectiveDate", label:"Policy Eff Date",resizable:"false",width:80,sortable:true},
	        {key:"RenewingPolicyExpirationDate", label:"Policy Exp Date",resizable:"false",width:80,sortable:true},
	        {key:"RenewalPremium", label:"Total Premium",formatter:formatRenewingPolicyTotalPremium,resizable:"false",width:75,sortable:true}
	    ...
	    var myColumnDefsBroker = [ // sortable:true enables sorting 
	        {key:"SNo", label:"SNo", sortable:false,resizable:"false",width:30}, 
	        {key:"RenewalQuote", label:"Quote #",resizable:"false",width:40,formatter:formatQuoteNumLink, sortable:true}, 
	        {key:"InsuredName", label:"Insured Name",formatter:formatLink,sortable:true,resizable:"false",width:130}, 
	        {key:"AgencyName", label:"Agency Name",sortable:true,resizable:"false",width:125}, 
	        {key:"RenewalQuoteStatus", label:"Quote Status",resizable:"false",width:65, sortable:true}, 	    
	        {key:"RenewalQuoteEffectiveDate", label:"Quote Eff Date",resizable:"false",width:80,sortable:true},	    	    
	        {key:"RenewingPolicy", label:"Policy #",resizable:"false",width:110,formatter:formatPolicyNumLink,sortable:true}, 
	        {key:"RenewingPolicyEffectiveDate", label:"Policy Eff Date",resizable:"false",width:80,sortable:true},
	    ...
	    myDataSource.responseSchema = { 
	        ...
	        fields: [ 
	            ...
	            {key:"RenewalQuoteEffectiveDate"},
  	            ...
  	            {key:"RenewingPolicy"}, 
  	            {key:"RenewingPolicyEffectiveDate"},
  	            {key:"RenewingPolicyExpirationDate"},
  	            {key:"RenewingPolicyTotalPremium"},
  	            {key:"RenewingPolicyProductName"},
  	            {key:"PolicyId"},
  	            {key:"PolicyVerId"},
