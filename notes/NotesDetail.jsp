...
<table cellpadding="1" cellspacing="0" style="background:url(i/bodybg.gif) repeat-x #fff;">
   ...
   <tr>
             ...
             <td align=center>	<table><tr><td>
              <html:button property="Save" value=" Save " styleClass="subbutton" onclick="saveNotes()" styleId="save" onmouseover="" /></td>
             <td>
             ...
             <html:button property="Cancel" value="Cancel" styleClass="subbutton" onclick="hideNotes(document.getElementById('objectId').value,document.getElementById('ownerId').value, document.getElementById('objectType').value);" styleId="cancel" /></td></tr></table>
               </td>
              </tr>
             <tr><td>
