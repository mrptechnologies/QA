	...
	new Ajax.Request(url, {method: 'post',asynchronous:true,
		...
		onComplete:function(transport){
			...
			if(isInvalidSession == 0) {
				mywin = window.open(href, windowname, 'width=550, height=350, left=550, top=125, scrollbars=yes');
				mywin.focus();
		 	}
		},
...
function selectValue(radio){
	...
	//var elem1 = radio.form.elements[i].value;
     ...
     tempCountry=radio.form.elements[i+5].value;
