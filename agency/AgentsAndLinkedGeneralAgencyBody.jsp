...
<html:form action="/EntitiesDeleteLinkToObjectAction">

<bean:define id="ownerId" property="answer(Object::UserDetail::ownerId)" name="LoginPage" scope="session"/>

<table WIDTH="95%" ALIGN="center" BORDER="0" CELLSPACING="2" CELLPADDING="0">
	<tr><td>&nbsp;</td></tr>
	<tr><td class="MH">AGENTS LINKED WITH GENERAL AGENCIES</td></tr>
	<tr><td class="TextMatter">
		<bean:message key="AgentsList.GAModDesc"/>
	</td></tr>
	<tr><td><hr size="1" noshade ></td></tr>
	<tr><td>&nbsp;</td></tr>
	<tr><td>
		<table WIDTH="580px" ALIGN="center" cellspacing=0 cellpadding="2">
			<dmshtml:Get_users_byRoleId nameInSession="arrAgents" roleId="15" dbname='<%=com.dms.web.util.DbUtils.getReadDS(pageContext)%>' ownerId="<%=Long.parseLong(""+ownerId) %>"
" />
			<tr><td class="Error"><logic:notPresent name ='arrAgents' scope ='session'>Currently no agents linked with general agencies.
								 </logic:notPresent>
			</td></tr>
		<% int j=0; %>
...
" objectType="GENERAL_AGENCY"/>
			...
			<!-- <tr>-->
				 ...
				 <%if(j==0){%>
  			<tr><td class="Error">Currently no agents linked with general agencies.</td></tr>
 				<%}else{%>
			<tr><td align="center" class="Error"><bean:message key="AgentsList.ExistingAgentsAndGeneralAgencies"/></td></tr>
			<tr><td>
				...
				<tr>
					...
					<td class="display" width="150px">
							<bean:message key="AgentsList.AgentName" />
					</td>
...
" objectType="GENERAL_AGENCY"/>
				...
				<tr>
								...
								<td class="SearchResult">
									...
									<dmshtml:get_agency_detail nameInSession="agencyDetail" agencyId="<%=objectId.toString()%>" ownerId="<%=Long.parseLong(""+ownerId) %>"
...
<tr><td><html:hidden property="answer(objectType)" value="GENERAL_AGENCY" /></td></tr>
<tr><td><html:hidden property="answer(primaryRoleId)" value="10" />
