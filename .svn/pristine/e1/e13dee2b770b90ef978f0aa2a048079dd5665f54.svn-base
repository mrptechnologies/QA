			   			...
			   			<tr>
							...
							<bean:define id="productFeeId" name="findFee" property="Object::Product::Fee::Definition::ProductFeeId" />
				   			<td class="SearchResult" align="left" >
				   				<a href="/EditFeeDefinitionAction.do?TabPanelName=<%=""+request.getParameter("TabPanelName")%>&answer(Object::Product::Fee::Definition::OwnerId)=<%=""+ownerId%>&answer(Object::Product::Fee::Definition::ProductFeeId)=<%= ""+productFeeId%>">
