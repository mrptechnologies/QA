...
<html:form action="/LinkAgencytoUser">
				...
				<table WIDTH="85%" ALIGN="center" cellspacing=0 cellpadding="4">					
					...
					<logic:present name ='searchresultnewDisplay' scope ='request'>
						...
						<tr><td align="Left" class="links" colspan="3">
								...
								<a href="../ListOfAgencyForUser.do?TabPanelName=<%=""+request.getParameter("TabPanelName")%>&answer(ownerId)=<%=""+ownerId %>&LimitSearch=yes&answer(Object::Agency::PageNum)=<%=(Integer.parseInt(""+pagenum)-1)%>"><bean:message key="Common.Previous"/></a>
								</logic:present>
							</td>
							<td align="right" class="links" colspan="3">
								<logic:present name="moreAgency"  scope="request" >

								<a href="../ListOfAgencyForUser.do?TabPanelName=<%=""+request.getParameter("TabPanelName")%>&answer(ownerId)=<%=""+ownerId %>&LimitSearch=yes&answer(Object::Agency::PageNum)=<%=(Integer.parseInt(""+pagenum)+1)%>">Next&gt;&gt;</a>
								</logic:present>
							</td>
						</tr>
