			...
			<table WIDTH="100%" ALIGN="Left" cellspacing="2" cellpadding="2">
				...
				<tr>
					<td align="Left" class="links" colspan="5" >
						<logic:present name="firstAgency"  scope="request" >
							<a href="../AgencySearchInsuredAction.do?TabPanelName=<%=""+request.getParameter("TabPanelName") %>&answer(ownerId)=<%=""+ownerId %>&LimitSearch=yes&answer(Object::Agency::PageNum)=0">&lt;&lt;First</a>
						</logic:present>&nbsp;&nbsp;
						<logic:present name="prevAgency"  scope="request" >
							<a href="../AgencySearchInsuredAction.do?TabPanelName=<%=""+request.getParameter("TabPanelName") %>&answer(ownerId)=<%=""+ownerId %>&LimitSearch=yes&answer(Object::Agency::PageNum)=<%=(Integer.parseInt(""+pagenum)-1)%>"><bean:message key="Common.Previous"/></a>
						</logic:present>
					</td>
					
					<td align="right" class="links" colspan="5">
						<logic:present name="moreAgency"  scope="request" >
							<a href="../AgencySearchInsuredAction.do?TabPanelName=<%=""+request.getParameter("TabPanelName") %>&answer(ownerId)=<%=""+ownerId %>&LimitSearch=yes&answer(Object::Agency::PageNum)=<%=(Integer.parseInt(""+pagenum)+1)%>">Next&gt;&gt;</a>
						</logic:present>&nbsp;&nbsp;
						<logic:present name="lastAgency"  scope="request" >
							<a href="../AgencySearchInsuredAction.do?TabPanelName=<%=""+request.getParameter("TabPanelName") %>&answer(ownerId)=<%=""+ownerId %>&LimitSearch=yes&answer(Object::Agency::PageNum)=<%=(Integer.parseInt(""+totpagenum)-1)%>">Last&gt;&gt;</a>
						</logic:present>   
					</td>
				</tr>
				...
				<tr>
					<td class=<%= styleClass %>>
					  	 <%=++i%>
					  	 <% ++radioFlag; %>
						<bean:define id="agencySel" name="AddCustomer" property="answer(Agency::AgencyId)" scope="request"/>											
						<bean:define id="agentSel" name="AddCustomer" property="answer(Object::Entity::EntityId)" scope="request"/>						
						<%	  
