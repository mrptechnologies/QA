...
<%
	...
	if(cId!=null && (!cId.toString().equals(""))){%>
			...
			<tr>
				<td valign="top">
					<table width="520px" align="Left" border="0" bgcolor="#C6DEEA" >
						...
						<tr>
							...
							<bean:define id="customerDetailMap" name="customerDetail1" scope="request"
								...
								generalAgencyName=customerDetailMap.getString("generalagencyname");%>
									...
									<td class="sectionhead1" align="left" width="220px"><a href="../GetInsuredAction.do?TabPanelName=Insured_Panel&customerId=<%=cId.toString()%>&answer(Object::Customer::CustomerId)=<%=cId.toString()%>&answer(Object::Agency::AgencyId)=<%=""+lngAgencyId%>" ><%=customerDetailMap.getString("custname")%></a>
								</td>
							</logic:present>
						 </tr>
