...
function getClassBenefits(classId,newClassName){
 ...
 function appendClassToParentBenefits(classId,newClassName){
	 ...
	 if(showClassDiv){
		...
		var custId = document.getElementById("customerId").value;
 		var pars = 'answer(SubQuoteVerId)='+prevSubQuoteVerId+'&answer(Object::Quote::ClassBenefits::ClassBenefitsId)='+classId+'&answer(Object::Application::ApplicationId__DMS_PROP_QUOTE_VER_ADD_CLASS_BENEFITS~APPLICATION_ID)=242&answer(Object::Application::ApplicationVerId__DMS_PROP_QUOTE_VER_ADD_CLASS_BENEFITS~APPLICATION_VER_ID)=268&answer(DisplayValue_Object::AdditionalInsured::IsAddedInQuote)=Y&answer(objectId)=0&answer(objectVerId)=0&answer(Object::Application::ApplicationType)=QUOTE_APPLICATION&answer(objectName)=CLASSBENEFITS&answer(applicationType)=QUOTE&answer(applicationSubType)=&answer(isSubApplicationCoveredByForm)=Yes&answer(actionName)='+actName+'&answer(activateTabId)=ClassBenefits_Row&answer(isApplicationEnabled)='+appEnabled+
 				'&answer(riskTerritory)=&answer(Object::Quote::PrevSubQuoteVerId)='+prevSubQuoteVerId+'&answer(Object::Application::ApplicationId__DMS_PROP_QUOTE_VER_ADD_CLASS_BENEFITS~APPLICATION_ID)=242&answer(Object::Application::ApplicationVerId__DMS_PROP_QUOTE_VER_ADD_CLASS_BENEFITS~APPLICATION_VER_ID)=268&answer(Object::Quote::ProductFamilyId)='+FamilyId+'&answer(FamilyId)='+FamilyId+'&answer(QuoteId)='+parentQuoteId+'&answer(ObjectType)=QUOTE_CLASS_BENEFITS&answer(objectType)=QUOTE&answer(recalculateneeded)=recalculate&answer(Object::Agency::AgencyId)='+agencyId+	
 				'&answer(riskType)=ClassBenefits&answer(recalculateneeded)=recalculate&answer(Object::Customer::CustomerId)='+custId+'&answer(QuoteId)='+parentQuoteId+'&answer(CustomerId)='+custId+'&answer(subQuoteId)='+subQuoteId+'&answer(Object::Agency::AgencyId)='+agencyId+'&answer(customerId)='+custId+'&answer(SubQuoteId)='+subQuoteId+'&answer(ParentQuoteId)='+parentQuoteId+'&answer(ParentQuoteVerId)='+parentQuoteVerId+'&answer(parentQuoteId)='+parentQuoteId;
	...
	var custId = document.getElementById("customerId").value;
 	...
 	var pars = 'answer(SubQuoteVerId)='+prevSubQuoteVerId+'&answer(Object::Quote::ApplicationId__DMS_PROP_QUOTE_VER_ADD_BENEFITS~APPLICATION_ID)=262&answer(Object::Quote::ApplicationVerId__DMS_PROP_QUOTE_VER_ADD_BENEFITS~APPLICATION_VER_ID)=288&answer(DisplayValue_Object::AdditionalInsured::IsAddedInQuote)=Y&answer(objectId)=0&answer(objectVerId)=0&answer(Object::Application::ApplicationType)=QUOTE_APPLICATION&answer(objectName)=BENEFITS&answer(applicationType)=QUOTE&answer(applicationSubType)=&answer(isSubApplicationCoveredByForm)=Yes&answer(actionName)='+actName+'&answer(activateTabId)=ClassBenefits_Row&answer(isApplicationEnabled)='+appEnabled+
 				'&answer(riskTerritory)=&answer(Object::Quote::PrevSubQuoteVerId)='+prevSubQuoteVerId+'&answer(Object::Quote::ProductFamilyId)='+FamilyId+'&answer(FamilyId)='+FamilyId+'&answer(QuoteId)='+parentQuoteId+'&answer(ObjectType)=Benefits&answer(objectType)=QUOTE&answer(recalculateneeded)=recalculate&answer(Object::Agency::AgencyId)='+agencyId+	
 				'&answer(riskType)=Benefits&answer(recalculateneeded)=recalculate&answer(Object::Customer::CustomerId)='+custId+'&answer(QuoteId)='+parentQuoteId+'&answer(CustomerId)='+custId+'&answer(subQuoteId)='+subQuoteId+'&answer(Object::Agency::AgencyId)='+agencyId+'&answer(customerId)='+custId+'&answer(SubQuoteId)='+subQuoteId+'&answer(ParentQuoteId)='+parentQuoteId+'&answer(ParentQuoteVerId)='+parentQuoteVerId+'&answer(parentQuoteId)='+parentQuoteId+'&answer(openTabAPolicyInfo)=openTabClassBenefitsY';
