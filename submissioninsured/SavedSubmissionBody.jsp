...
%>
		<logic:present name='arrObjectDetail' scope='session'>
					...
					<tr>
						<td class="NewSectionHead" align="center">SUBMISSION INSURED SUMMARY</td>
					</tr>					
					</table></td></tr>
					<tr>
						<td>&nbsp;</td>
					...
					<tr><td><table width="95%">	
						<tr>
							<td class="links" width="50%">  <a href="../GetAllQuotes.do?TabPanelName=Quote_Panel&answer(Entity::Equals::OwnerId)=<%=ownerId.toString()%>&answer(Object::Customer::CustomerId)=<%=custid.toString()%>&answer(Object::Agency::AgencyId)=<%=""+id%>&answer(Object::Customer::State)=<%=custState.toString()%>" title="Click to go to Quotes" />Quotes</a>  
							</td>
							<%String polType="POLICY"; %>
							<td class="links" width="50%">
						...
						<table WIDTH="95%" ALIGN="center" BORDER="0" CELLSPACING="0"
							...
							<%if(isCompany.toString().equalsIgnoreCase("Y")){ %>
							 <tr>
								...
								<td class="TextMatter" align="left">:<bean:write
									name='AddCustomer'
									property='answer(Object::Customer::Business)' /></td>
