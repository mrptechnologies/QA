...
<form name="Attachment" method="post" action="/AddAttachment.go" enctype="multipart/form-data" target="upload_target_iFrame">
		...
		<div class="hd">Attach File here</div>
			<div class="bd">
				<table cellpadding="1" cellspacing="0">
					<tr>
						<td><h6>Name:</h6></td>
						<td><input type='text' name='answer(Object::Attachment::Name)' maxlength='47' size='40' value='' id='attachmentName'></td>
					</tr>
				  	<tr>
				  		<td><h6>Description:</h6></td>
					  	<td>
					  		<div id="text"> 
					  			<textarea name='answer(Object::Attachment::Description)' cols='50' rows='4' id='attachmentDesc'></textarea>
					  		</div>
					  	</td>
					 </tr>
					 <tr>
...
(function(){
	...
	var init = function() {
		...
		var  attachedDocs= new YAHOO.widget.HTMLNode("<html><head></head><body><table><tr><td>&nbsp;&nbsp;&nbsp;<a  href='javascript:void(0);' onclick='showList()'><img src='/Images/IconAttachment.gif' border='0' > <font color='blue'>Attached Files</font></a></td><td><div id='attachedStatus'></div></td></tr></table>", root, false);
...
document.getElementById("Viewsuccess").style.display = 'block'
    ...
    document.getElementById("attachmentDesc").value = "";
     ...
     u.innerHTML="<table><tr><td>&nbsp;&nbsp;&nbsp;</td></tr><tr><td><input type='file' name='myFile' maxlength='127' size='43' value='' id='myFile'></td></tr><tr><td><div id='frame'style='display: none; return: false;'><iframe id='upload_target_iFrame' name='upload_target_iFrame'   style='width:300px;height:30px;border:1px solid #ccc;' onload = 'refreshTree()' ></iframe></div></td></tr><tr><td></td></tr></table>";
...
function updateApprovalStatus(attachmentId,obj){
	...
	var answer = confirm('Are you sure,Do you want to '+status+' the Attachemnt' );
