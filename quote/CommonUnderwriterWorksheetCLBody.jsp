...
<tr>
			...
			<table width="764px" align="Left" border="0" >
				<tr>
					...
					<td width="60%" class="links" align="left">
						...
						<a href="../CLQuoteProposalPdf.go?TabPanelName=<%=""+request.getParameter("TabPanelName")%>&answer(DocumentType)=PROPOSAL&answer(QuoteId)=<%= ""+parentQuoteId%>&answer(Object::Quote::QuoteType)=<%=strParentQuoteType.toString()%>&answer(Object::Quote::ProductId)=<%= ProductId.toString() %>&answer(OwnerId)=<%=ownerId.toString()%>&answer(subQuoteId)=<%=subQuoteId.toString()%>&answer(Object::Customer::CustomerId)=<%=customerId.toString()%>&answer(Object::Agency::AgencyId)=<%=agencyId.toString()%>&answer(parentQuoteId)=<%=parentQuoteId.toString()%>&answer(DocumentType)='PROPOSAL'">
	...
	<tr><td>&nbsp;</td></tr>
				...
				<tr>
					...
					<td class="SearchResult" align="left" width="20%">
						<html:text styleId="RateModificationFactor" property="answer(Object::PlanFactor::RateModificationFactor)" style="TEXT-ALIGN: right" name="UWWorkSheet" styleClass="txtbox" maxlength="5" size="5"/>						
					</td>
				</tr>
				<tr>
					<td class="SearchResult" align="left" width="20%">
					...
					<%
						...
						if(isTerrorismCoverage.equalsIgnoreCase("y")){ %>
							<html:text styleId="TerrorismFactor" property="answer(Object::PlanFactor::TerrorismFactor)" style="TEXT-ALIGN: right"  name="UWWorkSheet" styleClass="txtbox" maxlength="5" size="5"/>
					<%}else{ %>
						<html:text styleId="TerrorismFactor" property="answer(Object::PlanFactor::TerrorismFactor)" style="TEXT-ALIGN: right"  disabled="true" name="UWWorkSheet" styleClass="txtbox" maxlength="5" size="5"/>
					<%} %>
					</td>
				</tr>
				<tr>
					...
					<td class="SearchResult" align="left" width="20%">
						<html:text styleId="JudgementFactor" property="answer(Object::PlanFactor::JudgementFactor)"  style="TEXT-ALIGN: right" name="UWWorkSheet" styleClass="txtbox" maxlength="5" size="5"/>
					</td>
				</tr>	
