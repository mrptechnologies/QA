...
<html:hidden property="answer(Object::Quote::PrevSubQuoteVerId)" name="AddRisk" styleId="prevSubQuoteVerId" />
...
<tr>
<td>
<% if(applicationEnabled.equals("Y")){ %>
...
objectVerId="0" objectName='<%=""%>' applicationType="RISK" applicationSubType="" objectType='<%="QUOTE_RISK" %>' isSubApplicationCoveredByForm="Yes"  actionName="/saveQuoteEILRiskApplicationAction.go?TabPanelName=Quote_Panel" isApplicationEnabled='<%=""+applicationEnabled%>'  showOneTabAtTime="N"/>
...
function addRisk(){
	...
	var atsSpecId = -1;
	var AppType = 'YUI'
	var actionName = '/saveQuoteEILRiskApplicationAction.go?TabPanelName=Quote_Panel';
	...
	var prevSubQuoteVerId = document.getElementById("prevSubQuoteVerId").value;	
	...
	'&answer(Object::Risk::BusinessType__DMS_PROP_QUOTE_VER_PLAN_RISK_STORAGETANK_DETAIL~BUSINESS_TYPE)='+BusinessTypeSelection+'&answer(Object::UST::TankContents__DMS_PROP_QUOTE_VER_PLAN_RISK_STORAGETANK_DETAIL~TANK_CONTENTS)=Diesel'+'&answer(PrimaryKey_ParentQuoteId)='+parentQuoteId+'&answer(PrimaryKey_ParentQuoteVerId)='+parentQuoteVerId+'&answer(APP_TAB_TYPE)='+AppType+
	'&answer(PrimaryKey_Object::Location::LocationId)='+locationId+'&answer(Object::Location::LocationId)='+locationId+'&answer(PrimaryKey_SubQuoteId)='+subQuoteId+
