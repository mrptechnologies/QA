...
<table width="98%">
	...
	<tr>
		<td class="links">
			<a href="../EndorsementQuoteSummaryAction.do?TabPanelName=Quote_Panel&answer(QuoteId)=<%=""+parentQuoteId%>&answer(parentQuoteId)=<%=""+parentQuoteId%>&answer(policyNumber)=<%=""+policyNumber%>&answer(Object::Policy::ParentPolicyId)=<%=""+parentPolicyId %>&answer(Object::Customer::CustomerId)=<%=customerId.toString()%>&answer(Object::Policy::ParentPolicyVerId)=<%=policyVerId.toString() %>">Quote Summary</a>			
		</td>
		<%--<td class="links">
	...
	<div id="dolphincontainer">
		...
		<div style="display:block;" id="Premium Effect" class="innercontent">&nbsp;&nbsp;
			<html:form action="/SaveEndorsementDetailAction.go" onsubmit="return maxLengthTextAreaDesc('Reason')">
				...
				<tr>
					<td class="FormLabels">Base Premium</td>
					<td class="TextMatter">
				...
				<tr>
					<td class="FormLabels">Cancellation Type</td>
					<td class="TextMatter">
				...
				<tr>
					<td class="FormLabels">Prorata Premium</td>
					<td class="Numeric">
						<%--<bean:write name="subQuoteDetailMap" property="Object::Plan::TotalBasePremium"/>--%>
				...
				<html:hidden property="answer(Object::Activity::ActivityMsg)" value='<%="Saved Cancel Details"%>' />
		...
		<div style="display:none;" id="Reason" class="innercontent">
			...
			<html:form action="/SaveEndorsementDetailAction.go" onsubmit="return validateReason()" styleId="Application1">
				<table class="FormLabelsApplication" width="60%" border="0" cellpadding="2" cellspacing="2" >
					<tr><td>&nbsp;</td></tr>
					<tr>
						<td class="FormLabels" width="40%" valign="middle">Cancel Reason</td>
					...
					<tr style="display:none" id="Other_Desc_Container">
						<td class="FormLabels" width="40%" valign="middle">If other please specify</td>
					...
					<dmshtml:dms_isPresent property="<%=new String[]{"In Progress","Bind Request"}%>" value="<%=paretQuoteStatus.toString()%>" negated="true" >
						...
						<html:hidden name="EndorsementDetail" property="answer(policyNumber)" value="<%=policyNumber.toString()%>"/>
						<html:hidden property="TabPanelName" value="<%=""+request.getParameter("TabPanelName") %>" />
						<html:hidden property="answer(Object::Activity::ActivityMsg)" value='<%="Saved Cancellation Reason"%>' />
						<html:hidden property="answer(Object::Activity::OwnerId)" value="<%=ownerId.toString()%>" /> 
				<html:hidden property="answer(Object::Activity::CreatedBy)" value="<%=userId.toString()%>" /> 
				<html:hidden property="answer(Object::Activity::UpdatedBy)" value="<%=userId.toString()%>" /> 
				<html:hidden property="answer(Object::Activity::ActivityType)" value='<%="cancel"%>' />
...
function showDesc(){
	...
	if(document.forms[1].Cancel_Reason.value=='Other'){
...
function validateReason(){
	...
	if(document.forms[1].Cancel_Reason.value==""){
		alert("Please Select the Cancel Reason");
		return false;
	}
	if(document.forms[1].Cancel_Reason.value=='Other' && document.forms[1].EndorsementDescription.value==""){
		alert("Please Enter the description for other");
		return false;
	}
	return true;
}
