...
<div class="formpagenew" style="margin:-30px 0 0 0px;background:url(i/bodybg1.gif) repeat-x top;">

<div align="left" id="PolicySummaryClassHazardsClassList">
	<jsp:include page="PolicySummaryClassHazardsClassListParent.jsp"/>
</div>
</div>
