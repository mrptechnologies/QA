...
<logic:present name='searchResultBatchLogStatus'>
	...
	<logic:iterate id="batchLogMap" name="searchResultBatchLogStatus">
		<%
			sNo=sNo+1;
		%>
		{"SNo":<%=sNo%>,"BatchId":"<bean:write name="batchLogMap" property="Object::BatchLog::BatchId"/>","TransactionType":"<bean:write name="batchLogMap" property="Object::BatchLog::TransactionType" />","TransactionStatus":"<bean:write name="batchLogMap" property="Object::BatchLog::Status"/>","TotalNoOfTransactions":"<bean:write name="batchLogMap" property="Object::BatchLog::TotalNoOfTransactions" />","NoOfTransactionProcessed":"<bean:write name="batchLogMap" property="Object::BatchLog::NoOfTransactionsProcessed" />","NoOfTransactionFailed"
		:"<bean:write name="batchLogMap" property="Object::BatchLog::NoOfTransactionsFailed" />","TotalPremium":"<bean:write name="batchLogMap" property="Object::BatchLog::TotalPremium" />","SuccessPremium"
		:"<bean:write name="batchLogMap" property="Object::BatchLog::SuccessPremium" />","FailedPremium":"<bean:write name="batchLogMap" property="Object::BatchLog::FailedPremium"/>","RespXmlPath":"<bean:write name="batchLogMap" property="Object::BatchLog::RespXmlPath" />","TotalRecords":"<%=totalRecords %>"
		}
