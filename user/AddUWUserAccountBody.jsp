...
<script type="text/javascript"language="JavaScript" src = "/Scripts/JScripts/AddUser.js"></script>
...
<%
	String status="";
	String entityIdStr = "";
	String entityVerIdStr = "";
%>
	
<html:form action="/AddUnderwriterEntities" onsubmit="return validateAddUser(this)" styleId="frmAddUser">
...
%>
	...
	<table WIDTH="95%" ALIGN="center" BORDER="0" CELLSPACING="0" CELLPADDING="0">
		...
		<tr><td class="NewSectionHead" colspan="4" align="center">ADD UNDERWRITER USER ACCOUNT</td></tr>
		
		<tr><td>&nbsp;</td></tr>
	
		<tr><td class="TextMatter">Use this page to add a new underwriter user account.</td></tr>
			...
			<td align="left">
				<table WIDTH="95%" ALIGN="center" BORDER="0" CELLSPACING="0" CELLPADDING="2">
					<tr>
						...
						<td>&nbsp; Underwriter
						<html:hidden property="answer(Object::UserDetail::roleName)" value='UNDERWRITER'/>
						</td>
					</tr>
					<tr><td>&nbsp;</td></tr>
					...
					<tr>
						...
						<td class="TextMatter">&nbsp;<html:text styleClass="txtbox"  property="answer(Object::Entity::FirstName)" styleId="FirstName" size="30" maxlength="50"/></td>
					</tr>
...
<!-- Business Address -->
					<tr><td colspan="2" align="center" class="sectionhead">Address Information</td></tr>
			
					<tr><td>&nbsp;</td></tr>
			
					<tr>
						<td class="FormLabels" align="right">&nbsp;&nbsp;<bean:message key="Appointment.Address"/>&nbsp;1</td>
						<td>&nbsp;<dmshtml:dms_textarea styleClass="txtarea"  property="answer(Object::Entity::Addresses::BUSINESS::Object::Address::Address1)" rows="2" cols="30"/></td>
					</tr>
	
					<tr>
						<td class="FormLabels" align="right">&nbsp;&nbsp;Address 2</td>
						<td>&nbsp;<dmshtml:dms_textarea styleClass="txtarea"  property="answer(Object::Entity::Addresses::BUSINESS::Object::Address::Address2)" rows="2" cols="30"/></td>
					</tr>
	
					<tr>
						<td class="FormLabels" align="right">&nbsp;&nbsp;<bean:message key="Appointment.City"/></td>
						<td>&nbsp;<dmshtml:dms_text styleClass="txtbox" styleId="City" property="answer(Object::Entity::Addresses::BUSINESS::Object::Address::City)" size="30" maxlength="30"/></td>
					</tr>
					...
					<tr>
						...
						<td class="TextMatter">&nbsp;
							<dmshtml:dms_radio property = "answer(Object::Entity::Addresses::BUSINESS::Object::Address::Country)" value="USA"  /> USA&nbsp;&nbsp;&nbsp;
							<dmshtml:dms_radio property = "answer(Object::Entity::Addresses::BUSINESS::Object::Address::Country)" value="Canada" /> Canada
						</td>
					</tr>
	
					<tr>
						<td class="FormLabels" align="right">&nbsp;&nbsp;<bean:message key="Appointment.Zip"/></td>
						<td>&nbsp;
					...
					<tr> <td colspan="2" align="center" class="sectionhead"><bean:message key="UserAccounts.UserAccount"/> </td> </tr>
					...
					<tr>
						...
						<td class="menulinks">
							&nbsp;<input id="passWord" type="password" name="answer(Object::UserDetail::passWord)" maxlength="12" size="12" class="txtbox" autocomplete="off">&nbsp;<bean:message key="UserAccounts.pwvalidation"/>
						</td>
					</tr>  
					...
					<tr>
						...
						<td>
							&nbsp;<input id="passWordConfirm" type="password" name="answer(Object::UserDetail::passWordConfirm)" maxlength="12" size="12" class="txtbox" autocomplete="off">
						</td>
					</tr>
