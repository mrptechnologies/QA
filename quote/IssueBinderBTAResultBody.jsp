...
<table WIDTH="100%" ALIGN="center" border="0" CELLSPACING="0" CELLPADDING="0">
													...
													<tr>
														...
														<dmshtml:dms_isPresent property='<%=new String[]{"RENEWAL"}%>' value="<%=QuoteType.toString()%>" negated="true" >
															<tr id="RenewalPolicyNo" >
																...
																<td align="left"> 
																	<input type="radio" value="Y" name="answer(Object::Quote::GeneratePolicyNumber)" checked="true">Yes
																	<input type="radio" value="N" name="answer(Object::Quote::GeneratePolicyNumber)">No
																</td>
															</tr>															
															<tr id="RenewalPolicyNo" >
									...
									<logic:notPresent name="QuoteTransactionStatus" scope="request">
										...
										%>
											...
											<td align="center" class="links" colspan="4">										
									   		<INPUT TYPE="Button" style="width:200px" value="Preview Invoice Document" class="covbigbutton1" onclick ='savePreviewBinder()'/>											
											</td>
												<td align="center" class="links" colspan="4">
	...
	<tr>
		<td>
			...
			<html:text property="answer(IsIssueBinderAction)" value="YES" />
...
url="/SavePreviewBinderBTAPdf.do";	
 panel="refreshDiv";
  new Ajax.Request(url, {method: 'post',parameters:$(document.forms[0]).serialize(this),onComplete:function(transport){},onSuccess:
   function(transport){
