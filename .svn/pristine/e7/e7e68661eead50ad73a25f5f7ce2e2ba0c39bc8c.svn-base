...
<html:form action="/UpdateAgentAction" focus="answer(Object::UserDetail::passWord)">
...
<table WIDTH="550px" ALIGN="center" BORDER="0" CELLSPACING="0" CELLPADDING="2">
	...
	<tr>
		...
		<html:submit value="Submit" styleClass="sbttn" onclick="if(validateFields()) {checkForInvalidSessionCloseAndForward('Y');} else {return false;} "/>
		&nbsp;&nbsp;&nbsp;
		<html:reset value="Clear" styleClass="sbttn" onclick="checkForInvalidSessionCloseAndForward('N')"/>
		&nbsp;&nbsp;&nbsp;</td>
