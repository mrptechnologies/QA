...
<html:hidden property="answer(dbName)" value="java:/jdbc/allrisks"/>

<bean:define id="usernameId" property="answer(Object::UserDetail::userName)" name="LoginPage" scope="session"/>
<bean:define id="riskId" property="answer(Object::Risk::ResProperty::ResPropertyId)" name="AddRisk"></bean:define> 
<bean:define id="customerId" name="AddRisk" property="answer(Object::Risk::ResProperty::CustomerId)"></bean:define>
...
<table WIDTH="100%" ALIGN="left" border="0"CELLSPACING="2" CELLPADDING="0">
	...
	<tr>
		<td>
			<table WIDTH="1100px" ALIGN="center" border="0"CELLSPACING="0" CELLPADDING="2" bgcolor="#C6DEEA">
				<tr>
					<td valign="top">
			...
			<table WIDTH="1100px" ALIGN="center" BORDER="0" CELLSPACING="0" CELLPADDING="0">
				...
				<tr>
					<td>
				   	 <table width="1100px" align="Left" border="0">
				    	 <tr>
				      		<td>
				      			<jsp:include page="../common/RiskHeader.jsp">
				      			 	<jsp:param name="parentRiskId" value="<%=riskId.toString()%>" />
					...
					<td>
						<table width="100%" align="center" border="0">
							<tr>
								...
								<td class="links" width="20%" align="right">  
				...
				<tr>
					<td>
						...
						<table width="100%" align="center" border="0">
							<tr>
								<td class="links" width="20%">  
									<a href="/AddOrEditRiskLHInfo.do?answer(TabPanelName)=Insured_Panel&answer(Object::Risk::ResPropertyId)=<bean:write name="AddRisk" property="answer(Object::Risk::ResProperty::ResPropertyId)" />&answer(Object::Customer::CustomerId)=<%=customerId.toString()%>&answer(Object::Agency::AgencyId)=<%=id.toString()%>"/>Add/Edit - Loss History</a>
					  			</td>
							 	 <td class="links" width="20%">  
					  				<a href="/ListAdditionalInterest.do?answer(TabPanelName)=Insured_Panel&answer(Object::Risk::ResPropertyId)=<bean:write name="AddRisk" property="answer(Object::Risk::ResProperty::ResPropertyId)" />&answer(Object::Customer::CustomerId)=<%=customerId.toString()%>&answer(Object::Agency::AgencyId)=<%=id.toString()%>" />Add/Edit - Additional Interests</a>
					 			</td>
					 			<td class="links" width="20%">
					 				&nbsp;
					 			</td>
			...
			<logic:present name="addOrEditDataSubmissionMsg"  scope="request">
			<tr>
				<td class="Error">
					Save/Update Failed
				</td>
			...
			<logic:present name="arrOfRiskDetail"  scope="request">
			<tr>
				<td class="Error" >
			...
			<logic:present name="DuplicateRisk"  scope="request">
			<tr>
				<td class="Error" >
					* Save/Update Failed-- Duplicate RiskName or RiskNumber
				</td>
			</tr>
			<tr><td>&nbsp;</td></tr>
			</logic:present>			
			<logic:present name="MultipleZIP"  scope="request">
			<tr>
				<td class="Error">
					* Multiple Zip Code Found - Please select Zipcode/City/County
				</td>
			</tr>
			<tr><td>&nbsp;</td></tr>
			</logic:present>
					...
					<td>
						<table WIDTH="100%" ALIGN="right" BORDER="0" CELLSPACING="0" CELLPADDING="2">
							...
							<tr>
								...
								<td class="links">
									<html:text property="answer(Object::Risk::ResProperty::DateBuilt)" styleId="YearBuilt" onfocus="isOther(this.form, this.document);" size="4" maxlength="4" styleClass="txtbox" />
								</td>
							</tr>
				...
				<tr>
					<td>
						<table WIDTH="100%" ALIGN="right" BORDER="0" CELLSPACING="0" CELLPADDING="2">				
							...
							<tr>
								<td class="FormLabels" align="left" width="39%">&nbsp;&nbsp;a)&nbsp;Roof</td> 
								<td class="links">
						...
						<table WIDTH="100%" ALIGN="right" BORDER="0" CELLSPACING="0" CELLPADDING="2">
							...
							<tr>
								...
								<td class="TextMatter1" >
									...
									<html:radio value="N" property="answer(Object::Risk::ResProperty::ChildCareBusiness)">No</html:radio>
								</td>
							</tr>
							...
							<tr>
								...
								<td class="TextMatter1">
									...
									<html:radio value="N" property="answer(Object::Risk::ResProperty::OtherBusiness)">No</html:radio>
								</td>
							</tr>
							...
							<tr>
								...
								<td class="TextMatter1">
									...
									<html:radio value="N" property="answer(Object::Risk::ResProperty::MobileHome)">No</html:radio>
								</td>
							</tr>
							...
							<tr>
								...
								<td class="TextMatter1">
									...
									<html:radio value="N" property="answer(Object::Risk::ResProperty::Trampoline)">No</html:radio>
								</td>
							</tr>
							...
							<tr>
								...
								<td class="TextMatter1">
									...
									<html:radio value="N" property="answer(Object::Risk::ResProperty::Animals)">No</html:radio>
								</td>
							</tr>
							...
							<tr>
								...
								<td class="TextMatter1">
									...
									<html:radio value="N" property="answer(Object::Risk::ResProperty::DogBreeds)">No</html:radio>
								</td>
							</tr>
						</table>
					</td>
					...
					<td align="left" colspan="2">
						<table WIDTH="100%" ALIGN="left" BORDER="0" CELLSPACING="0" CELLPADDING="2">
							...
							<tr>
								...
								<td class="links">
									<a href="/AddOrEditRiskLHInfo.do?TabPanelName=Insured_Panel&answer(Object::Risk::ResPropertyId)=<bean:write name="AddRisk" property="answer(Object::Risk::ResProperty::ResPropertyId)" />&answer(Object::Customer::CustomerId)=<%=customerId.toString()%>&answer(Object::Agency::AgencyId)=<%=id.toString()%>">Claim Details</a>
								</td>
							</tr>					
						</table>
					</td>
						...
						<table WIDTH="100%" ALIGN="left" BORDER="0" CELLSPACING="0" CELLPADDING="2">
							...
							<tr>
								...
								<td class="TextMatter1">
									...
									<html:radio value="N" property="answer(Object::Risk::ResProperty::ClaimGTAmount)">No</html:radio>
								</td>
							</tr>
						</table>
					</td>
					...
					<td align="left" colspan="2">
						<table WIDTH="100%" ALIGN="left" BORDER="0" CELLSPACING="0" CELLPADDING="2">
							...
							<tr>
								...
								<td class="links">
									<a href="/ListAdditionalInterest.do?TabPanelName=Insured_Panel&&answer(Object::Risk::ResPropertyId)=<bean:write name="AddRisk" property="answer(Object::Risk::ResProperty::ResPropertyId)" />&answer(Object::Customer::CustomerId)=<%=customerId.toString()%>&answer(Object::Agency::AgencyId)=<%=id.toString()%>">Additional Interest Details</a>
								</td>
							</tr>					
						</table>
					</td>
						...
						<table WIDTH="100%" ALIGN="left" BORDER="0" CELLSPACING="0" CELLPADDING="2">
							<tr>
								...
								<td class="TextMatter1">
									...
									<html:radio value="N" property="answer(Object::Risk::ResProperty::AdditionalInterest)">No</html:radio>
								</td>
							</tr>
						</table>
					</td>
			...
			<table WIDTH="60%" ALIGN="center" BORDER="0" CELLSPACING="0" CELLPADDING="2">
				...
				<tr>
					...
					<td>
						...
						<html:hidden property="answer(Object::Risk::ResProperty::RuleCheck)" styleId="ruleCheck" value="EditN"/>
						...
						<html:hidden property="answer(MultipleZIP)" styleId="reqVal" value="<%=""+request.getAttribute("MultipleZIP")%>"/>
