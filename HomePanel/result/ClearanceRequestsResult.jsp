...
java.lang.String broker = subQMap.getEncodedString("Object::Submission::AgencyName");
...
if(i==0){%>
<%="Assignee"+"____~____*"+"Date"+"____~____*"+"Submission #"+"____~____*"+"Insured Name"+"____~____*"+"State"+"____~____*"+"SubmissionId"+"____~____*"+"SubmissionVerId"+"____~____*"+"Broker"+"____~____*"+"Priority"+"____~____*"+"Delete"+"____~____*"+"Url"+"____~____*"+"CustomerId"+"____~____*"+"PanelName"+"____~____*"+"AlertId"+"\n"%>
<%}%>
 <%=assignee+"____~____*"+updatedDate+"____~____*"+submissionNum+"____~____*"+insuredName+"____~____*"+state+"____~____*"+submissionId+"____~____*"+submissionVerId+"____~____*"+broker+"____~____*"+ "" +"____~____*"+""+"____~____*"+submissionLink+"____~____*"+custId+"____~____*"+"Submission_Panel"+"____~____*"+alertId+"\n"%>
<%}%>
<%}%>
