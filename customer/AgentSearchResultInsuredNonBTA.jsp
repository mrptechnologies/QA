...
<template:put name='ProgressBar' content='/common/ProgressBarSelectAgentNonBTA.jsp' />
<template:put name='GeneralBody' content='/customer/AgentSearchResultInsuredNonBTABody.jsp' /> 
