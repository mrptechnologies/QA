...
import mx.controls.RadioButton;
	...
	var spouseCheckHolderMap:HashMap = new HashMap();
	var MandatoryIdentifierValue:HashMap = new HashMap();
	...
	Object__Employee__PolicyHolder__DivorcedDate___DMS_EMPLOYEE____DIVORCED_DATE.setStyle("styleName", "mydateField_Style");
...
verNum_ActionReq.text = major_Ver_Number+minor_Ver_Number;
	...
	for(parentIndex = 0;parentIndex < global_employee_XML.firstChild.childNodes.length;parentIndex++){
		for(childIndex=0;childIndex < global_employee_XML.firstChild.childNodes[parentIndex].childNodes.length;childIndex++){
			...
			else if(nameElement=="Object__Employee__ActionRequested__LifeInsurance" and valueElement != null){
					Object__Employee__ActionRequested__LifeInsurance___DMS_EMPLOYEE_ACTIONREQUESTED____LIFE_INS_COVERAGE.selected = true;
					Object__Employee__ActionRequested__LifeInsuranceName___DMS_EMPLOYEE_ACTIONREQUESTED____LIFE_INS_PRODUCT_NAME.enabled = true;
			}
			else if(nameElement=="Object__Employee__ActionRequested__LifeInsuranceName" and valueElement != null){
				Object__Employee__ActionRequested__LifeInsuranceName___DMS_EMPLOYEE_ACTIONREQUESTED____LIFE_INS_PRODUCT_NAME.text = valueElement;
			}
 ...
 verNum_InsWaiver.text = major_Ver_Number+minor_Ver_Number;
	 Object__Employee__InsWaiver__EmployeeName___DMS_EMPLOYEE_INS_WAIVER____EMPLOYEE_NAME.enabled=true;	 
	 Object__Employee__InsWaiver__SpouseName___DMS_EMPLOYEE_INS_WAIVER____SPOUSE_NAME.enabled=true;
	...
	for(parentIndex = 0;parentIndex<global_employee_XML_Extended.firstChild.childNodes.length;parentIndex++){
		for(childIndex=0;childIndex<global_employee_XML_Extended.firstChild.childNodes[parentIndex].childNodes.length;childIndex++){
			...
			else if(nameElement=="Object__Employee__InsWaiver__MMO" and valueElement != null){
				Object__Employee__InsWaiver__MMO___DMS_EMPLOYEE_INS_WAIVER____MMO_GROUP_NUMBER.text = valueElement;
			}
			...
			else if(nameElement=="Object__Employee__InsWaiver__SignedDate" and valueElement != null and valueElement!="0000-00-00"){
...
retreiveOtherCoverage = function(){
	...
	verNum_OtherCvg.text = major_Ver_Number+minor_Ver_Number;
...
/*Retrieving method for retrieve attributes data in Policy Holder Tab*/
 retrieveData = function(){
	 ...
	 verNum_PolHolder.text = major_Ver_Number+minor_Ver_Number;
	var subApplChildNode = global_employee_XML.firstChild.firstChild.childNodes;				
...
//				var valEMPLOYEE_DOB = index[1]+"/"+index[2]+"/"+index[0];
			...
			else if(nameElement =="Object__Employee__PolicyHolder__DivorcedDate" and valueElement != null and valueElement!="0000-00-00"){
				var valueEffectiveDate1 = valueElement;
				var index1 = valueEffectiveDate1.split("-");
				Object__Employee__PolicyHolder__DivorcedMonth.text=index1[1];
				Object__Employee__PolicyHolder__DivorcedDate.text=index1[2];
				Object__Employee__PolicyHolder__DivorcedYear.text=index1[0];
			}
			...
			/*else if(nameElement =="Object__Employee__PolicyHolder__State" and valueElement != null){				
				...
				var addressCode   = valueElement.substr(3,3);
				var homePhoneNumber = valueElement.substr(6,4);
...
getStateValue = function():String{
	var subApplChildNode = global_employee_XML.firstChild.firstChild.childNodes;				
	for(j = 0;j<global_employee_XML.firstChild.childNodes.length;j++){
		for(i=0;i<global_employee_XML.firstChild.childNodes[j].childNodes.length;i++){
			var nameElement:String = global_employee_XML.firstChild.childNodes[j].childNodes[i].firstChild.firstChild.nodeValue;
			var valueElement:String = global_employee_XML.firstChild.childNodes[j].childNodes[i].lastChild.lastChild.nodeValue;
			if(nameElement =="Object__Employee__PolicyHolder__State" and valueElement != null){
				return valueElement;
			}
		}
	}	
...
retrieveFortDearBornData = function(){
	verNum_Fort.text = major_Ver_Number+minor_Ver_Number;
	for(j = 0;j<global_employee_XML.firstChild.childNodes.length;j++){
		...
		if(subApplicationName=="Dearborn") {				
			for(i=0;i<global_employee_XML.firstChild.childNodes[j].childNodes.length;i++){
				...
				else if(nameElement == "Object__Employee__DearBorn__JobTitle" and valueElement != null){
					Object__Employee__DearBorn__JobTitle___DMS_EMPLOYEE_DEARBORN____JOB_TITLE.text = valueElement;
				}				
				
				else if(nameElement == "Object__Employee__DearBorn__VoluntaryShortTermDisability" and valueElement != null){
						Object__Employee__DearBorn__VoluntaryShortTermDisability___DMS_EMPLOYEE_DEARBORN____VOLUNTARY_SHORT_TERM_DISABILITY.selected = true;
				}
				else if(nameElement =="Object__Employee__DearBorn__OriginalDateOfHire" and valueElement != null){
					Object__Employee__DearBorn__OriginalDateOfHire___DMS_EMPLOYEE_DEARBORN____DATE_OF_HIRE.text = valueElement;			
				}
				...
				//newly added primary  n contingency fields - start
				else if(nameElement == "Object__Employee__DearBorn__PrimaryLastName1" and valueElement != null){
					Object__Employee__DearBorn__PrimaryLastName1___DMS_EMPLOYEE_DEARBORN____PRIMARY_LAST_NAME1.text = valueElement;
				}
				else if(nameElement == "Object__Employee__DearBorn__PrimaryFirstName1" and valueElement != null){
					Object__Employee__DearBorn__PrimaryFirstName1___DMS_EMPLOYEE_DEARBORN____PRIMARY_FIRST_NAME1.text = valueElement;
				}
				else if(nameElement == "Object__Employee__DearBorn__PrimaryDOB1" and valueElement != null and valueElement!="0000-00-00"){
					var valuePRIMARY_DOB = valueElement;
					var index = valuePRIMARY_DOB.split("-");
					Object__Employee__DearBorn__PrimaryDOBMonth1.text = index[1];
					Object__Employee__DearBorn__PrimaryDOBDate1.text = index[2];
					Object__Employee__DearBorn__PrimaryDOBYear1.text = index[0];					
				}
				else if(nameElement == "Object__Employee__DearBorn__PrimaryRelationship1" and valueElement != null){
					Object__Employee__DearBorn__PrimaryRelationship1___DMS_EMPLOYEE_DEARBORN____PRIMARY_RELATIONSHIP1.text = valueElement;
				}
				else if(nameElement == "Object__Employee__DearBorn__PrimaryBenefitSplit1" and valueElement != null){
					Object__Employee__DearBorn__PrimaryBenefitSplit1___DMS_EMPLOYEE_DEARBORN____PRIMARY_BENEFIT_SPLIT1.text = valueElement;
				}
				else if(nameElement == "Object__Employee__DearBorn__SecondaryLastName1" and valueElement != null){
					Object__Employee__DearBorn__SecondaryLastName1___DMS_EMPLOYEE_DEARBORN____SECONDARY_LAST_NAME1.text = valueElement;
				}
				else if(nameElement == "Object__Employee__DearBorn__SecondaryFirstName1" and valueElement != null){
					Object__Employee__DearBorn__SecondaryFirstName1___DMS_EMPLOYEE_DEARBORN____SECONDARY_FIRST_NAME1.text = valueElement;
				}
				else if(nameElement == "Object__Employee__DearBorn__SecondaryDOB1" and valueElement != null and valueElement!="0000-00-00"){
					var valueSECONDARY_DOB = valueElement;
					var index1 = valueSECONDARY_DOB.split("-");
					Object__Employee__DearBorn__SecondaryDOBMonth1.text = index1[1];
					Object__Employee__DearBorn__SecondaryDOBDate1.text = index1[2];
					Object__Employee__DearBorn__SecondaryDOBYear1.text = index1[0];
					/*var valSECONDARY_DOB = index[1]+"/"+index[2]+"/"+index[0];
					Object__Employee__DearBorn__SecondaryDOB___DMS_EMPLOYEE_DEARBORN____SECONDARY_DOB.text = valSECONDARY_DOB;*/
				}
				else if(nameElement == "Object__Employee__DearBorn__SecondaryRelationship1" and valueElement != null){
					Object__Employee__DearBorn__SecondaryRelationship1___DMS_EMPLOYEE_DEARBORN____SECONDARY_RELATIONSHIP1.text = valueElement;
				}
				
				else if(nameElement == "Object__Employee__DearBorn__SecondaryBenefitSplit1" and valueElement != null){
					Object__Employee__DearBorn__SecondaryBenefitSplit1___DMS_EMPLOYEE_DEARBORN____SECONDARY_BENEFIT_SPLIT1.text = valueElement;
				}
				//newly added primary  n contingency fields - end
...
retrieveAboutNeedsData = function(){
	verNum_AbtNeeds.text = major_Ver_Number+minor_Ver_Number;
	for(j = 0;j<global_employee_XML_Extended.firstChild.childNodes.length;j++){
		for(i=0;i<global_employee_XML_Extended.firstChild.childNodes[j].childNodes.length;i++){
			...
			if(nameElement == "Object__Employee__AboutNeeds__HearingImpaired" and valueElement != null){
				...
				if(valueElement=='Y'){
					Object__Employee__AboutNeeds__OtherPrimaryLanguage___DMS_EMPLOYEE_OTHER_NEEDS____OTHER_PRIMARY_LANGUAGE.enabled = true;
				}else{
					Object__Employee__AboutNeeds__OtherPrimaryLanguage___DMS_EMPLOYEE_OTHER_NEEDS____OTHER_PRIMARY_LANGUAGE.text="";
					Object__Employee__AboutNeeds__OtherPrimaryLanguage___DMS_EMPLOYEE_OTHER_NEEDS____OTHER_PRIMARY_LANGUAGE.enabled = false;
				}
			}
				...
				if(valueElement=='Y'){
					Object__Employee__AboutNeeds__OtherCulturalNeed___DMS_EMPLOYEE_OTHER_NEEDS____OTHER_CULTURAL_NEED.enabled = true;
				}else{
					Object__Employee__AboutNeeds__OtherCulturalNeed___DMS_EMPLOYEE_OTHER_NEEDS____OTHER_CULTURAL_NEED.text="";
					Object__Employee__AboutNeeds__OtherCulturalNeed___DMS_EMPLOYEE_OTHER_NEEDS____OTHER_CULTURAL_NEED.enabled = false;
				}
...
retreiveCoveredDependents = function(){
	verNum_CovDept.text = major_Ver_Number+minor_Ver_Number;
	var employee_OtherCovXML1:XML = new XML();
	var subApplicationName :String;
	nameElementArray = new Array();
	valuElementArray = new Array();
	...
	for(parentIndex = 0;parentIndex < employee_OtherCovXML.firstChild.childNodes.length;parentIndex++){
		...
		if(subApplicationName == "Policy")  {
			for(childIndex=0;childIndex < employee_OtherCovXML.firstChild.childNodes[parentIndex].childNodes.length;childIndex++){
				...
				if(nameElement == "Object__Employee__PolicyHolder__MaritalStatus" and valueElement != null){
					if(valueElement=="Single"){
						Object__Employee__CoverageDept__Spouse__Spouse___DMS_EMPLOYEE_COVERED_SPOUSE____SPOUSE.enabled = false;
						Object__Employee__CoverageDept__Spouse__FName___DMS_EMPLOYEE_COVERED_SPOUSE____FIRST_NAME.enabled = false;
						Object__Employee__CoverageDept__Spouse__LName___DMS_EMPLOYEE_COVERED_SPOUSE____LAST_NAME.enabled = false;
						Object__Employee__CoverageDept__Spouse__SSNOne.enabled = false;
						Object__Employee__CoverageDept__Spouse__SSNTwo.enabled = false;
						Object__Employee__CoverageDept__Spouse__SSNThree.enabled = false;
						Object__Employee__CoverageDept__Spouse__Month.enabled = false;
						Object__Employee__CoverageDept__Spouse__Date.enabled = false;
						Object__Employee__CoverageDept__Spouse__Year.enabled = false;
						Object__Employee__CoverageDept__Spouse__PrimaryCarePhysican___DMS_EMPLOYEE_COVERED_SPOUSE____PRIMARY_CARE_PHYSICIAN.enabled = false;
					}					
				}
			}
		}
			...
			if(subApplicationName == "Spouse Details"){
				for(childIndex=0;childIndex < employee_OtherCovXML.firstChild.childNodes[parentIndex].childNodes.length;childIndex++){
					...
					if(nameElement == "Object__Employee__CoverageDept__Spouse__Spouse" and valueElement != null){
						...
						spouseCheckHolderMap.put(nameElement,valueElement);
	  ...
	  if(spouseCheckHolderMap.containsKey("Object__Employee__CoverageDept__Spouse__Spouse") && 
										spouseCheckHolderMap.get("Object__Employee__CoverageDept__Spouse__Spouse")=="Spouse"){
		retreiveCoveredDependentsSpouseDetail();
//		isSpouseCheckBoxSelected();
	  }
}

isSpouseCheckBoxSelected = function(){
		if(spouseCheckHolderMap.get("Object__Employee__CoverageDept__Spouse__SSN")!="undefined" && spouseCheckHolderMap.get("Object__Employee__CoverageDept__Spouse__SSN")!=undefined && 
						spouseCheckHolderMap.get("Object__Employee__CoverageDept__Spouse__SSN")!=""){
		var SSN = spouseCheckHolderMap.get("Object__Employee__CoverageDept__Spouse__SSN");
		var spouseSSNOne   = SSN.substr(0,3);
		var spouseSSNTwo   = SSN.substr(3,2);
		var spouseSSNThree = SSN.substr(5,4);
		Object__Employee__CoverageDept__Spouse__SSNOne.text = spouseSSNOne;
		Object__Employee__CoverageDept__Spouse__SSNTwo.text = spouseSSNTwo;
		Object__Employee__CoverageDept__Spouse__SSNThree.text = spouseSSNThree;
	}
...
retrieveMedicalQuestionnaireData = function(){
	verNum_MHQ.text = major_Ver_Number+minor_Ver_Number;
...
getSelfValuefromXML = function(relationXML:XML){
	...
	for(parentIndex = 0;parentIndex<relationXML.firstChild.childNodes.length;parentIndex++){
		...
		if(subApplicationName == "Dependent"){
			...
			relationshipArray = new Array();
			dataprovider_MedHealthDependent = new Array();
			
			lNameValueArray = new Array();var keyIndx:Number = 0;var valIndx:Number=0; var relIndx:Number = 0;
			for(childIndex=0;childIndex < relationXML.firstChild.childNodes[parentIndex].childNodes.length;childIndex++){
			...
			for(attArrIndx:Number = 0; attArrIndx < covDeptKeyElementArray.length; attArrIndx++){				
				...
				//Alert.show("Outside relation",Alert.YES);
				if(covDeptKeyElementArray[attArrIndx].indexOf("Object__Employee__CoverageDept__Relationship")!=-1){
					if(covDeptValuElementArray[attArrIndx]!=undefined){
					  	relationshipArray[relIndx++] = covDeptValuElementArray[attArrIndx];
					}else{
					 	 relationshipArray[relIndx++] = "Child";
					}					
					//Alert.show("Inside relation"+relationshipArray[relIndx],Alert.YES);
				}				
			}
	...
	for(j = 0;j<medHealthXML.firstChild.childNodes.length;j++){
		...
		if(subApplicationName == "HealthQ's"){
			...
			var colCount:Number = 0;
				...
				var smokerValue:String="Yes"; var relationshipValue:String;
			...
			for(attArrIndx:Number = 0; attArrIndx < nameElementArray.length; attArrIndx++){
				...
				if(nameElementArray[attArrIndx].indexOf("Object__Employee__MedHealthQuestion__Relationship")!=-1){
					relationshipValue = valuElementArray[attArrIndx];//dependentNameArray[nameCount++];						
				}
				...
				// if the colcount is the multiples of the number of columns, then push the array with values.
				if(colCount % 5 ==0){
					myDP_array.push({Relationship:relationshipValue,Name:nameValue, Height:heightValue, Weight:weightValue,Smoker:smokerValue});
			...
			{	
				for(tempIndx=0;tempIndx<dependentNameArray.length;tempIndx++){							
					dependent_DataGrid.dataProvider.addItem({Relationship:relationshipArray[tempIndx],Name:dependentNameArray[tempIndx], Height:"", Weight:"",Smoker:"No"});
				}
				nameColumn.editable = false;
			}
				...
				for(var checkCnt=dependent_DataGrid.length;checkCnt<dependentNameArray.length;checkCnt++){
					dependent_DataGrid.dataProvider.addItem({Relationship:relationshipArray[checkCnt],Name:dependentNameArray[checkCnt], Height:"", Weight:"",Smoker:"No"});
				}
			}
		...
		if(subApplicationName == "MandatoryExplMap"){
			var MandatoryValueSet:HashMap = new HashMap();
			for(i=0;i<global_employee_XML_Extended.firstChild.childNodes[j].childNodes.length;i++){
					var nameElement:String = global_employee_XML_Extended.firstChild.childNodes[j].childNodes[i].firstChild.firstChild.nodeValue;
					var valueElement:String = global_employee_XML_Extended.firstChild.childNodes[j].childNodes[i].lastChild.lastChild.nodeValue;
					//Alert.show("valueElement : Name element "+valueElement+": "+nameElement,Alert.YES);
							var identifier = nameElement.substr(0,nameElement.indexOf("Madatory"));
						     
							var identifierValue = identifier+"Value";
							var btn1 = _root["btn_"+identifier];
							var btn2 = _root["btn_"+identifier+"Yellow"];
							var valueSet = identifier+"Valueset";
							//Alert.show(" MandatoryIdentifierValue.get(identifierValue) "+MandatoryIdentifierValue.get(identifierValue),Alert.YES);
							if(MandatoryIdentifierValue.get(identifierValue) == "Y" && valueElement == "Yes"){
								//Alert.show("valueElement :YES"+identifier,Alert.YES);
								btn1._visible = false;
								btn2._visible = true;
								MandatoryValueSet.put(valueSet,"true");
							}if(valueElement == "No"){
								//Alert.show("valueElement :NO"+identifier,Alert.YES);
								btn1._visible = true;
								btn2._visible = false;
								MandatoryValueSet.put(valueSet,"true");
							}
			...
			var identifierArr:Array = new Array('CANCER','LEUKEMIA','LYMPHOMA','CHEMOTHEROPHY','RADIATION','ALLERGIES','ASTHMA','CYSTIC','EMPHYSEMA','DISCDISEASE','FIBROMYALGIA','HERNIATEDDISC','OSETEO','RHEUMATOID','JOIN','ANEURYSM','CAD_ANGINA','ANGIOPLASTY','BYPASSSURGERY','CONGESTIVE','HEARTATTACK','PACEMAKER','STROKE','BLOODCLOT','IRREGULARHEARTBEAT','VASCULAR','ANIEMA','OTHERBLOODDISORDER','HYPERTENSIION','HIGHCHOLESTROL','VOLVEDISORDER','DIABETESINSULIN','DIABETES_ORAL','DIABETES_EXERCISE','DIROIDDISORDER','CEREBRALPALSY','EPILEPSY','MULTIPLESCLEROSIS','PARKINSON','DEPRESSION','BIPOLAR','HOSPITAL','SUCIDE_ATTEMPT','ABNORMAL_PAP','NORMAL_FOLLOWUP','COLON','ULCERATIVE','GASTRICREFLUX','ENLARGEDPROSTATE','KIDNEY','INFERTILITY','POLYCRYSTIC','ENDOMETRIOSIS','ENDSTAGE','TRANSPLANT','HEMOPHILIA','LUPUS','HEPATITIS','MISCOTHER','TREATEDBEFORE','HOSPITALIZEDBEFORE','OPERATIONADVISED','OPERATIONADVISED2','PREGNANT','CURRENTMEDICATION','CURRENTMEDICATION2');
			for(i=0;i<identifierArr.length;i++){
							var iden = identifierArr [i];
							var identifierValue = iden+"Value";
							var btn1 = _root["btn_"+iden];
							var btn2 = _root["btn_"+iden+"Yellow"];
							var valueSet = iden+"Valueset";
						if(MandatoryValueSet.get(valueSet)!="true" && MandatoryIdentifierValue.get(identifierValue) == "Y"){
							//Alert.show("333 :"+identifierValue,Alert.YES);
							btn1._visible = false;
							btn2._visible = true;
						}else if( MandatoryIdentifierValue.get(identifierValue) == "N"){
							btn1._visible = false;
							btn2._visible = false;
						}
			}
			...
			if(explDP_array.length>0) {
			 ...
			 if(isNeedNormalFormRetrieve){
					...
					if(nameElement == "Object__Employee__MedicalCondition__Cancer" and valueElement != null){
						...
						if(Object__Employee__MedicalCondition__Cancer___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____CANCER.getValue() == 'Y'){
							btn_CancerY._visible = true;
							MandatoryIdentifierValue.put("CANCERValue","Y");
						}else{
							btn_CancerY._visible = false;
							MandatoryIdentifierValue.put("CANCERValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__Leukemia___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____LEUKEMIA.getValue() == 'Y'){
							MandatoryIdentifierValue.put("LEUKEMIAValue","Y");
							//button_Leukemia._visible = true;
						}else{
							//button_Leukemia._visible = false;
							MandatoryIdentifierValue.put("LEUKEMIAValue","N");
						}
						...
						if(Object__Employee__MedicalCondition__Lymphoma___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____LYMPHOMA.getValue() == "Y"){
							MandatoryIdentifierValue.put("LYMPHOMAValue","Y");
						}else{
							MandatoryIdentifierValue.put("LYMPHOMAValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__Chemotherapy___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____CHEMOTHERAPY.getValue()=="Y"){
							MandatoryIdentifierValue.put("CHEMOTHEROPHYValue","Y");
						}else{
							MandatoryIdentifierValue.put("CHEMOTHEROPHYValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__Radiation___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____RADIATION.getValue()=="Y"){
							MandatoryIdentifierValue.put("RADIATIONValue","Y");
						}else{
							MandatoryIdentifierValue.put("RADIATIONValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__Allergies___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____ALLERGIES.getValue() == "Y"){
							MandatoryIdentifierValue.put("ALLERGIESValue","Y");
						}else{
							MandatoryIdentifierValue.put("ALLERGIESValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__Asthma___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____ASTHMA.getValue()=="Y"){
							MandatoryIdentifierValue.put("ASTHMAValue","Y");
						}else{
							MandatoryIdentifierValue.put("ASTHMAValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__CysticFibrosis___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____CYSTICFIBROSIS.getValue()=="Y"){
							MandatoryIdentifierValue.put("CYSTICValue","Y");
						}else{
							MandatoryIdentifierValue.put("CYSTICValue","N");
						}
						...
						if(Object__Employee__MedicalCondition__Emphysema___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____EMPHYSEMA.getValue() == "Y"){
							MandatoryIdentifierValue.put("EMPHYSEMAValue","Y");
						}else{
							MandatoryIdentifierValue.put("EMPHYSEMAValue","N");
						}
						...
						if(Object__Employee__MedicalCondition__DegenerativeDiscDisease___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____DEGENERATIVE_DISC_DISEASE.getValue() == "Y"){
							MandatoryIdentifierValue.put("DISCDISEASEValue","Y");
						}else{
							MandatoryIdentifierValue.put("DISCDISEASEValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__Fibromyalgia___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____FIBROMYALGIA.getValue()=="Y"){
							MandatoryIdentifierValue.put("FIBROMYALGIAValue","Y");
						}else{
							MandatoryIdentifierValue.put("FIBROMYALGIAValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__HerniatedDisc___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____HERNIATED_DISC.getValue() =="Y"){
							MandatoryIdentifierValue.put("HERNIATEDDISCValue","Y");
						}else{
							MandatoryIdentifierValue.put("HERNIATEDDISCValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__OsteoArthritis___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____OSTEO_ARTHRITIS.getValue()=="Y"){
							MandatoryIdentifierValue.put("OSETEOValue","Y");
						}else{
							MandatoryIdentifierValue.put("OSETEOValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__RheumatoidArthritis___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____RHEUMATOIDARTHRITIS.getValue()=="Y"){
							MandatoryIdentifierValue.put("RHEUMATOIDValue","Y");
						}else{
							MandatoryIdentifierValue.put("RHEUMATOIDValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__JointReplacement___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____JOINT_REPLACEMENT.getValue() == "Y"){
							MandatoryIdentifierValue.put("JOINValue","Y");

						}else{
							MandatoryIdentifierValue.put("JOINValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__Aneurysm___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____ANEURYSM.getValue() == "Y"){
							MandatoryIdentifierValue.put("ANEURYSMValue","Y");
						}else{
							MandatoryIdentifierValue.put("ANEURYSMValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__CADAngina___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____CADANGINA.getValue() == "Y"){
							MandatoryIdentifierValue.put("CAD_ANGINAValue","Y");
						}else{
							MandatoryIdentifierValue.put("CAD_ANGINAValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__Angioplasty___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____ANGIOPLASTY.getValue() == "Y"){
							MandatoryIdentifierValue.put("ANGIOPLASTYValue","Y");
						}else{
							MandatoryIdentifierValue.put("ANGIOPLASTYValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__BypassSurgery___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____BYPASS_SURGERY.getValue() == "Y"){
							MandatoryIdentifierValue.put("BYPASSSURGERYValue","Y");
						}else{
							MandatoryIdentifierValue.put("BYPASSSURGERYValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__CongestiveHeartFailure___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____CONGESTIVE_HEART_FAILURE.getValue() == "Y"){
							MandatoryIdentifierValue.put("CONGESTIVEValue","Y");
						}else{
							MandatoryIdentifierValue.put("CONGESTIVEValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__HeartAttack___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____HEARTATTACK.getValue() == "Y"){
							MandatoryIdentifierValue.put("HEARTATTACKValue","Y");
						}else{
							MandatoryIdentifierValue.put("HEARTATTACKValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__PacemakerICD___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____PACEMAKER_ICD.getValue() == "Y"){
							MandatoryIdentifierValue.put("PACEMAKERValue","Y");
						}else{
							MandatoryIdentifierValue.put("PACEMAKERValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__Stroke___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____STROKE.getValue() == "Y"){
							MandatoryIdentifierValue.put("STROKEValue","Y");
						}else{
						MandatoryIdentifierValue.put("STROKEValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__BloodClot___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____BLOODCLOT.getValue() == "Y"){
							MandatoryIdentifierValue.put("BLOODCLOTValue","Y");
						}else{
							MandatoryIdentifierValue.put("BLOODCLOTValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__IrregularHeartBeat___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____IRREGULAR_HEARTBEAT.getValue() == "Y"){
							MandatoryIdentifierValue.put("IRREGULARHEARTBEATValue","Y");
						}else{
							MandatoryIdentifierValue.put("IRREGULARHEARTBEATValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__PeripheralVascular___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____PERIPHERAL_VASCULAR.getValue() =="Y"){
							MandatoryIdentifierValue.put("VASCULARValue","Y");
						}else{
							MandatoryIdentifierValue.put("VASCULARValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__Anemia___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____ANEMIA.getValue() == "Y"){
							MandatoryIdentifierValue.put("ANIEMAValue","Y");
						}else{
							MandatoryIdentifierValue.put("ANIEMAValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__OtherBloodDisorder___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____OTHERBLOOD_DISORDER.getValue() == "Y"){
							MandatoryIdentifierValue.put("OTHERBLOODDISORDERValue","Y");
						}else{
							MandatoryIdentifierValue.put("OTHERBLOODDISORDERValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__Hypertension___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____HYPER_TENSION.getValue() == "Y"){
							MandatoryIdentifierValue.put("HYPERTENSIIONValue","Y");
						}else{
							MandatoryIdentifierValue.put("HYPERTENSIIONValue","N");
						}
					}
					else if(nameElement == "Object__Employee__MedicalCondition__BPReading1" and valueElement != null){
						Object__Employee__MedicalCondition__BPReading1___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____BPREADING1.text = valueElement;
					}
					else if(nameElement == "Object__Employee__MedicalCondition__BPReading2" and valueElement != null){
						Object__Employee__MedicalCondition__BPReading2___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____BPREADING2.text = valueElement;
					}
					else if(nameElement == "Object__Employee__MedicalCondition__BPReading3" and valueElement != null){
						Object__Employee__MedicalCondition__BPReading3___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____BPREADING3.text = valueElement;
					}
						...
						if(Object__Employee__MedicalCondition__HighCholesterol___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____HIGHCHOLESTEROL.getValue() == "Y"){
							MandatoryIdentifierValue.put("HIGHCHOLESTROLValue","Y");
						}else{
							MandatoryIdentifierValue.put("HIGHCHOLESTROLValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__HeartValveDisorder___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____HEART_VALVE_DISORDER.getValue() == "Y"){
							MandatoryIdentifierValue.put("VOLVEDISORDERValue","Y");
						}else{
							MandatoryIdentifierValue.put("VOLVEDISORDERValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__DiabetesInsulin___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____DIABETES_INSULIN.getValue() == "Y"){
							MandatoryIdentifierValue.put("DIABETESINSULINValue","Y");
						}else{
							MandatoryIdentifierValue.put("DIABETESINSULINValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__DiabetesOral___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____DIABETES_ORAL.getValue() == "Y"){
							MandatoryIdentifierValue.put("DIABETES_ORALValue","Y");
						}else{
							MandatoryIdentifierValue.put("DIABETES_ORALValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__DiabetesDietExercise___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____DIABETES_DIET_EXERCISE.getValue() == "Y"){
							MandatoryIdentifierValue.put("DIABETES_EXERCISEValue","Y");
						}else{
							MandatoryIdentifierValue.put("DIABETES_EXERCISEValue","N");
						}
					}
					else if(nameElement == "Object__Employee__MedicalCondition__BSRdgsHGB1" and valueElement != null){
						Object__Employee__MedicalCondition__BSRdgsHGB1___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____BS_RDGS_HGB1.text = valueElement;
					}
					else if(nameElement == "Object__Employee__MedicalCondition__BSRdgsHGB2" and valueElement != null){
						Object__Employee__MedicalCondition__BSRdgsHGB2___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____BS_RDGS_HGB2.text = valueElement;
					}
					else if(nameElement == "Object__Employee__MedicalCondition__BSRdgsHGB3" and valueElement != null){
						Object__Employee__MedicalCondition__BSRdgsHGB3___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____BS_RDGS_HGB3.text = valueElement;
					}
						...
						if(Object__Employee__MedicalCondition__ThyroidDisorder___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____THYROID_DISORDER.getValue() == "Y"){
							MandatoryIdentifierValue.put("DIROIDDISORDERValue","Y");
						}else{
							MandatoryIdentifierValue.put("DIROIDDISORDERValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__CerebralPalsy___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____CEREBRAL_PALSY.getValue() == "Y"){
							MandatoryIdentifierValue.put("CEREBRALPALSYValue","Y");
						}else{
							MandatoryIdentifierValue.put("CEREBRALPALSYValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__Epilepsy___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____EPILEPSY.getValue() =="Y"){
							MandatoryIdentifierValue.put("EPILEPSYValue","Y");
						}else{
							MandatoryIdentifierValue.put("EPILEPSYValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__MultipleSclerosis___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____MULTIPLE_SCLEROSIS.getValue() == "Y"){
							MandatoryIdentifierValue.put("MULTIPLESCLEROSISValue","Y");
						}else{
							MandatoryIdentifierValue.put("MULTIPLESCLEROSISValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__ParkinsonDisease___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____PARKINSON_DISEASE.getValue() == "Y"){
							MandatoryIdentifierValue.put("PARKINSONValue","Y");
						}else{
							MandatoryIdentifierValue.put("PARKINSONValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__DepressionAnxiety___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____DEPRESSION_ANXIETY.getValue() == "Y"){
							MandatoryIdentifierValue.put("DEPRESSIONValue","Y");
						}else{
							MandatoryIdentifierValue.put("DEPRESSIONValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__BipolorSchizophrenia___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____BIPOLOR_SCHIZOPHRENIA.getValue() == "Y"){
							MandatoryIdentifierValue.put("BIPOLARValue","Y");
						}else{
							MandatoryIdentifierValue.put("BIPOLARValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__Hospitalized___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____HOSPITALIZED.getValue() == "Y"){
							MandatoryIdentifierValue.put("HOSPITALValue","Y");
						}else{
							MandatoryIdentifierValue.put("HOSPITALValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__SuicideAttempt___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____SUICIDE_ATTEMPT.getValue() == "Y"){
							MandatoryIdentifierValue.put("SUCIDE_ATTEMPTValue","Y");
						}else{
							MandatoryIdentifierValue.put("SUCIDE_ATTEMPTValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__AbnormalPap___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____ABNORMAL_PAP.getValue() == "Y"){
							MandatoryIdentifierValue.put("ABNORMAL_PAPValue","Y");
						}else{
							MandatoryIdentifierValue.put("ABNORMAL_PAPValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__NormalFollowupPap___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____NORMAL_FOLLOWUP_PAP.getValue() == "Y"){
							MandatoryIdentifierValue.put("NORMAL_FOLLOWUPValue","Y");
						}else{
							MandatoryIdentifierValue.put("NORMAL_FOLLOWUPValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__ColonPolypsDiverticulitis___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____COLON_POLYPS_DIVERTICULITIS.getValue() == "Y"){
							MandatoryIdentifierValue.put("COLONValue","Y");
						}else{
							MandatoryIdentifierValue.put("COLONValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__CrohnUlcerativeColitis___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____CROHN_ULCERATIVE_COLITIS.getValue() == "Y"){
							MandatoryIdentifierValue.put("ULCERATIVEValue","Y");
						}else{
							MandatoryIdentifierValue.put("ULCERATIVEValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__GastricRefluxUlcer___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____GASTRIC_REFLUX_ULCER.getValue() == "Y"){
							MandatoryIdentifierValue.put("GASTRICREFLUXValue","Y");
						}else{
							MandatoryIdentifierValue.put("GASTRICREFLUXValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__EnlargedProstate___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____ENLARGED_PROSTATE.getValue() == "Y"){
							MandatoryIdentifierValue.put("ENLARGEDPROSTATEValue","Y");
						}else{
							MandatoryIdentifierValue.put("ENLARGEDPROSTATEValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__KidneyStones___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____KIDNEY_STONES.getValue() == "Y"){
							MandatoryIdentifierValue.put("KIDNEYValue","Y");
						}else{
							MandatoryIdentifierValue.put("KIDNEYValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__InfertilitityTreatments___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____INFERTILITITY_TREATMENTS.getValue() == "Y"){
							MandatoryIdentifierValue.put("INFERTILITYValue","Y");
						}else{
							MandatoryIdentifierValue.put("INFERTILITYValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__PolycysticOvarianSyndrome___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____POLYCYSTIC_OVARIAN_SYNDROME.getValue() == "Y"){
							MandatoryIdentifierValue.put("POLYCRYSTICValue","Y");
						}else{
							MandatoryIdentifierValue.put("POLYCRYSTICValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__Endometriosis___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____ENDOMETRIOSIS.getValue() == "Y"){
							MandatoryIdentifierValue.put("ENDOMETRIOSISValue","Y");
						}else{
							MandatoryIdentifierValue.put("ENDOMETRIOSISValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__EndStageRenalFailure___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____ENDSTAGE_RENAL_FAILURE.getValue() == "Y"){
							MandatoryIdentifierValue.put("ENDSTAGEValue","Y");
						}else{
							MandatoryIdentifierValue.put("ENDSTAGEValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__Transplant___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____TRANSPLANT.getValue() == "Y"){
							MandatoryIdentifierValue.put("TRANSPLANTValue","Y");
						}else{
							MandatoryIdentifierValue.put("TRANSPLANTValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__HIV___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____HIV.getValue()=="Y"){
							MandatoryIdentifierValue.put("OPERATIONADVISED2Value","Y");
						}else{
							MandatoryIdentifierValue.put("OPERATIONADVISED2Value","N");
						}
						...
						if(Object__Employee__MedicalCondition__Hemophilia___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____HEMOPHILIA.getValue() == "Y"){
							MandatoryIdentifierValue.put("HEMOPHILIAValue","Y");
						}else{
							MandatoryIdentifierValue.put("HEMOPHILIAValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__Lupus___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____LUPUS.getValue() == "Y"){
							MandatoryIdentifierValue.put("LUPUSValue","Y");
						}else{
							MandatoryIdentifierValue.put("LUPUSValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__Hepatitis___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____HEPATITIS.getValue() == "Y"){
							MandatoryIdentifierValue.put("HEPATITISValue","Y");
						}else{
							MandatoryIdentifierValue.put("HEPATITISValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__MiscOther___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____MISC_OTHER.getValue() == "Y"){
							MandatoryIdentifierValue.put("MISCOTHERValue","Y");
						}else{
							MandatoryIdentifierValue.put("MISCOTHERValue","N");
						}
					}
						...
						if(Object__Employee__MedicalQuestion__DiseaseTreatedBefore___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____DISEASE_TREATED_BEFORE.getValue() == "Y"){
							MandatoryIdentifierValue.put("TREATEDBEFOREValue","Y");
						}else{
							MandatoryIdentifierValue.put("TREATEDBEFOREValue","N");
						}
					}
						...
						if(Object__Employee__MedicalQuestion__OperatedHospitalizedBefore___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____OPERATED_HOSPITALIZED_BEFORE.getValue() == "Y"){
							MandatoryIdentifierValue.put("HOSPITALIZEDBEFOREValue","Y");
						}else{
							MandatoryIdentifierValue.put("HOSPITALIZEDBEFOREValue","N");
						}
					}
						...
						if(Object__Employee__MedicalQuestion__AdvisedFurtherTreatment___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____ADVISED_FURTHER_TREATMENT.getValue() == "Y"){
							MandatoryIdentifierValue.put("OPERATIONADVISEDValue","Y");
						}else{
							MandatoryIdentifierValue.put("OPERATIONADVISEDValue","N");
						}
					}
						...
						if(Object__Employee__MedicalQuestion__CurrentlyPregnant___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____CURRENTLY_PREGNANT.getValue() =="Y"){
							MandatoryIdentifierValue.put("PREGNANTValue","Y");
						}else{
							MandatoryIdentifierValue.put("PREGNANTValue","N");
						}
						if(Object__Employee__MedicalQuestion__CurrentlyPregnant___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____CURRENTLY_PREGNANT.getValue() == "N"){
							Object__Employee__MedicalQuestion__PregnantPersonName___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____PREGNANT_PERSON_NAME.enabled = false;
							Object__Employee__MedicalQuestion__DelivaryDueDateMonth.enabled = false;
							Object__Employee__MedicalQuestion__DelivaryDueDateDate.enabled = false;
							Object__Employee__MedicalQuestion__DelivaryDueDateYear.enabled = false;
							risk_yes.enabled = false;
							risk_no.enabled = false;
						}
					}
						...
						if(Object__Employee__MedicalQuestion__AnyMedication___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____ANY_MEDICATION.getValue() == "Y"){
							MandatoryIdentifierValue.put("CURRENTMEDICATIONValue","Y");
						}else{
							MandatoryIdentifierValue.put("CURRENTMEDICATIONValue","N");
						}
					}
						...
						if(Object__Employee__MedicalQuestion__WorkerCompensation___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____WORKER_COMPENSATION.getValue() == "Y"){
							MandatoryIdentifierValue.put("CURRENTMEDICATION2Value","Y");
						}else{
							MandatoryIdentifierValue.put("CURRENTMEDICATION2Value","N");
						}
						if(Object__Employee__MedicalQuestion__WorkerCompensation___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____WORKER_COMPENSATION.getValue() == "N"){
							Object__Employee__MedicalQuestion__CompensationCaseNumber___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____COMPENSATION_CASE_NUMBER.enabled = false;
						}
					}
...
var isSpouseCovered:Boolean = false;
retrieveTermsNCondition = function(){	
	verNum_TnC.text = major_Ver_Number+minor_Ver_Number;
	for(j = 0;j<global_employee_XML_Extended.firstChild.childNodes.length;j++){
		for(i=0;i<global_employee_XML_Extended.firstChild.childNodes[j].childNodes.length;i++){
			var nameElement:String = global_employee_XML_Extended.firstChild.childNodes[j].childNodes[i].firstChild.firstChild.nodeValue;
			var valueElement:String = global_employee_XML_Extended.firstChild.childNodes[j].childNodes[i].lastChild.lastChild.nodeValue;
	...
	for(j = 0;j<global_employee_XML.firstChild.childNodes.length;j++){
		for(i=0;i<global_employee_XML.firstChild.childNodes[j].childNodes.length;i++){
			var nameElement:String = global_employee_XML.firstChild.childNodes[j].childNodes[i].firstChild.firstChild.nodeValue;
			var valueElement:String = global_employee_XML.firstChild.childNodes[j].childNodes[i].lastChild.lastChild.nodeValue;
			if(nameElement == "Object__Employee__CoverageDept__Spouse__Spouse" and valueElement != undefined){
				if(valueElement=="Spouse"){
...
validateDateField = function(monthValue,dateValue,yearValue){	
	if(isNaN(monthValue) || isNaN(dateValue) || isNaN(yearValue)){
		...
		if(monthValue>12 || monthValue<1 || dateValue<1 || dateValue > 31 || yearValue.length<4 || yearValue.length>4 || yearValue<1900 || yearValue>2100 || yearValue==0000){
			return true;
		}
		else{
			return false;
...
retrieveEmployeeMedicalHealthDetail = function(medicalQuestionIdentifier:String){
	globalIdentifier = medicalQuestionIdentifier;
	var subApplicationName :String;
	nameElementArray = new Array();
	valuElementArray = new Array();
	...
	for(j = 0;j<global_employee_XML_Extended.firstChild.childNodes.length;j++){
		...
		trace("subApplicationName:>"+subApplicationName);
		//Alert.show("subApplicationName : "+subApplicationName+": "+nameElement,Alert.YES);
		if(subApplicationName == "MandatoryExplMap"){
			var MandatoryValueSet:HashMap = new HashMap();
			for(i=0;i<global_employee_XML_Extended.firstChild.childNodes[j].childNodes.length;i++){
					var nameElement:String = global_employee_XML_Extended.firstChild.childNodes[j].childNodes[i].firstChild.firstChild.nodeValue;
					...
					//Alert.show("valueElement : Name element "+valueElement+": "+nameElement,Alert.YES);
							var identifier = nameElement.substr(0,nameElement.indexOf("Madatory"));
						    // Alert.show("identifier :"+identifier,Alert.YES);
							var identifierValue = identifier+"Value";
							var btn1 = _root["btn_"+identifier];
							var btn2 = _root["btn_"+identifier+"Yellow"];
							var valueSet = identifier+"Valueset";
							//Alert.show(" MandatoryIdentifierValue.get(identifierValue) "+MandatoryIdentifierValue.get(identifierValue),Alert.YES);
							if( valueElement == "Yes" && medicalQuestionIdentifier == identifier){
								//Alert.show("valueElement :"+valueElement,Alert.YES);
								btn1._visible = false;
								btn2._visible = true;
								MandatoryValueSet.put(valueSet,"true");
							}else if( valueElement == "No" && medicalQuestionIdentifier == identifier){
								//Alert.show("valueElement :"+valueElement,Alert.YES);
								btn1._visible = true;
								btn2._visible = false;
								MandatoryValueSet.put(valueSet,"true");
			...
			for(i=0;i<identifierArr.length;i++){
							...
							var btn2 = _root["btn_"+iden+"Yellow"];
							var valueSet = iden+"Valueset";
							//Alert.show("valueSet "+valueSet,Alert.YES);
						if(MandatoryValueSet.get(valueSet)!="true" && medicalQuestionIdentifier == iden){
							//Alert.show("333 :"+MandatoryValueSet.get(valueSet),Alert.YES);
							btn1._visible = false;
							btn2._visible = true;
						}
			}
		...
		if(subApplicationName == "Expl"){
			...
			var quesIndx:Number = 0;
			//Loop to extract the question Identifier from the Array built from XML.
			for(keyQIndx=0;keyQIndx<nameElementArray.length;keyQIndx++){
				if(nameElementArray[keyQIndx].indexOf("Object__Employee__MedExplanation__QuestionIdentifier")!=-1){
			...
			for(attArrIndx:Number = 0; attArrIndx < nameElementArray.length; attArrIndx++){
				if(pKeyCheckArr[keyIndex]==nameElementArray[attArrIndx].substr(nameElementArray[attArrIndx].indexOf("_____")+5,nameElementArray[attArrIndx].length)){
					if(nameElementArray[attArrIndx].indexOf("Object__Employee__MedExplanation__PatientName")!=-1){
						//Alert.show("pat name :"+valuElementArray[attArrIndx]);
						patientName = valuElementArray[attArrIndx];												
					}
					else if(nameElementArray[attArrIndx].indexOf("Object__Employee__MedExplanation__PatientCondition")!=-1){
						if(valuElementArray[attArrIndx]  == undefined){
							//Alert.show("undefined",Alert.YES);
							patientCondition = "";
						}else{
						...
						//Alert.show("treatmentStartDate :"+valuElementArray[attArrIndx]);
					}
					else if(nameElementArray[attArrIndx].indexOf("Object__Employee__MedExplanation__TreatmentEndDate")!=-1){
						treatmentEndDate = valuElementArray[attArrIndx];						
						//Alert.show("treatmentEndDate :"+valuElementArray[attArrIndx]);
					}
					else if(nameElementArray[attArrIndx].indexOf("Object__Employee__MedExplanation__TreatmentSummary")!=-1){
						if(valuElementArray[attArrIndx]  == undefined){
							//Alert.show("undefined",Alert.YES);
						...
						//patientCondition = questionIdentifier;
			...
			for(attArrIndx:Number = 0; attArrIndx < nameElementArray.length; attArrIndx++){
				...
				if(nameElementArray[attArrIndx].indexOf("Object__Employee__MedExplanation__PatientCondition")!=-1){										
					if(keyQuestionArr[QIndx]==medicalQuestionIdentifier && valuElementArray[attArrIndx]!=undefined){
						...
						explanationPopUpWindow.MedicalHealthExplCondition.text = medicalQuestionIdentifier;
					}
				}
				if(nameElementArray[attArrIndx].indexOf("Object__Employee__MedExplanation__TreatmentStartDate")!=-1){										
					if(keyQuestionArr[QIndx]==medicalQuestionIdentifier && valuElementArray[attArrIndx]!=undefined){
