...
<html:form action="/SearchClearanceFailureActionUI3.do">
	...
	<div class="formpageinsured">
		...
		<div id="divCompany">
		<div class="field"  style="width:463px ;" id="company_legal_name1"><font color="red">*&nbsp;Legal Name / DBA</font>:<html:text name="AddCustomer" property="answer(Object::Clearance::LegalName1)" size="50" maxlength="125" styleClass="txtbox" styleId="LegalName1" /></div><!--
		...
		<div class="field" style="width:465px ;" id="insureddba">Insured DBA:<html:text	name="AddCustomer" property="answer(Object::Clearance::DBA)" size="50" maxlength="125"	styleClass="txtbox" styleId="DBA" /></div>-->
		</div>
		...
		<%-- <div class="field" style="text-align: right ; width:450px ;"><font color="red">*</font>&nbsp;Zip Code:
			...
			<div class="field" id="zipcodeAutoComplete" style="text-align:right; width:167px ;margin-left:14px;float:left;"><font color="red">*Zipcode or City Name</font>:
			    ...
			    <div  id="zipAutoCompleteResContainer" class="field" style="text-align:left;height:1px; float:left;"></div>			    
	 		</div>
		<div  style="text-align:left; width:590px;float:right;">
		...
		<div class="field" style="width:460px ; float:left; margin-left:-145px"> <font color="red">*Select Submission Type:</font>
			<html:select property="answer(Object::Submission::Type)"  styleId="SubmissionType" onchange="RenderScript()" style="width:120px">
					    <html:option value=""           	 styleClass="txtbox">Select</html:option>
					    <html:option value="NEW_BUSINESS" 	 styleClass="txtbox">New Business</html:option>	
					    <html:option value="RENEWAL" 	 styleClass="txtbox">Renewal</html:option>				
			</html:select>
			</div>	
			<script type="text/javascript">
				function RenderScript()
				{
						...
						if(document.getElementById('SubmissionType').value== "RENEWAL")
							{
								 document.getElementById('RenderValue1').show();
							}
							else
							 document.getElementById('RenderValue1').hide();
				}
			</script>	
			<script>
				function loadscript()
				...
				<div class="field"  style="width:463px ;margin-left:-120px "  id="RenderValue1">
					<font color="red">Renewing Policy # </font>:<html:text style="width:147px" size="50"  property="answer(Object::Submission::RenewalPolicy)"  maxlength="15" styleClass="txtbox" styleId="RenewingPolicy"/>
		...
		<dmshtml:dms_static_with_connector ruleName='privilage' property='<%=new String[]{"CVSTARR_DATEPICKER"}%>' connector='or' negated="false">
		<div class="field" style="width:505px ;text-align: left;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="red">*</font>&nbsp;Proposed Effective Date:       
			<dmshtml:dms_text property="answer(Month)" size="2" style="width:40px;"	maxlength="2" styleClass="txtbox" styleId="csdmm" onkeyup="validateDateField(12,this,'Month');" />&nbsp;
			<dmshtml:dms_text property="answer(Date)" size="2" style="width:40px;"	maxlength="2" styleClass="txtbox" styleId="csddd" onkeyup="validateDateField(31,this,'Date');" />&nbsp;
			<dmshtml:dms_text property="answer(Year)" size="2" style="width:80px;  " maxlength="4" styleClass="txtbox" styleId="csdyy" onkeyup="var dat = new Date();var currentyear = dat.getFullYear();validateDateField(currentyear+1,this,'Year');"/> (MM/DD/YYYY) 
		</div>
		</dmshtml:dms_static_with_connector>

		<dmshtml:dms_static_with_connector ruleName='privilage' property='<%=new String[]{"CVSTARR_DATEPICKER"}%>' connector='or' negated="true">
		<% Date  myDate = Calendar.getInstance().getTime();
		   DateFormat formatter = new SimpleDateFormat("MM/dd/yyyy");
		   String today = formatter.format(myDate);%>

		<div class="field" style="text-align:left; width:290px ;float:left;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="red">*</font>&nbsp;Proposed Effective Date:    
		...
		<div class="field" title="<bean:message key='ToolTip.ClearInsured.Next'/>">
	...
	<html:hidden property="answer(pagename)" value="Create New Submission" />	
...
<html:hidden property="answer(Object::UserDetail::roleName)" value="<%=roleName.toString()%>" styleId="roleNamefrmjsp" />
 ...
 */ 
 ...
 function searchClearance(){
  ...
  try {			
	new Ajax.Request(url, {method: 'post',parameters:$(form).serialize(this),onComplete:function(transport){forwardToLoginPageIfInvalidSession(transport.responseText);},onSuccess: function(transport){showTest(transport.responseText);}});		
   }catch(err) {
...
function checkInsured() {
	var url="/CheckInsured.do"; 
	var panel="MESSAGE_LIST";
	var form=document.forms[0];
  
  try {			
	new Ajax.Request(url, {method: 'post',parameters:$(form).serialize(this),onComplete:function(transport){forwardToLoginPageIfInvalidSession(transport.responseText);},onSuccess: function(transport){showTestInsured(transport.responseText);}});		
   }catch(err) {
    txt="There was an error on this page.\n\n";
    txt+="Error description: " + err.description + "\n\n";
    txt+="Click OK to continue.\n\n";
...
return true;
 ...
 function showTest(testData){
  ...
  if(trimText=='BROKER_HIDE_LIST'){
    ...
    document.getElementById('CLEARANCE_LIST').innerHTML=resultData[1];    
    document.forms[0].action="../ClearanceAction3.0.do";
  }	
 }


function showTestInsured(testData){
  var resultData = testData.split("$HTMLSPLITTER$");
   trimText=resultData[0].replace(/^\s*|\s*$/g,'');
  if(trimText=='INSURED_VALIDATION_FAILURE'){
  	document.getElementById('CLEARANCE_LIST').innerHTML=resultData[1];
  }if(trimText=='INSURED_VALIDATION_SUCCESS'){
	new Ajax.Request("/ClearanceActionUI3.do", {method: 'post',parameters:$(document.forms[0]).serialize(this),onComplete:function(transport){forwardToLoginPageIfInvalidSession(transport.responseText);},onSuccess: function(transport){showTest(transport.responseText);}});		
  }
 }
...
<script type="text/javascript">
   ...
   if((Ext.getCmp('ProposedEffectiveDate1') != null) && (Ext.getCmp('ProposedEffectiveDate1') != undefined)) {
