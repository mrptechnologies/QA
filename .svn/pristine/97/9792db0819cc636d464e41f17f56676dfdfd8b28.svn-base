	...
	<tr>
		<td>
			<table WIDTH="760px" ALIGN="center" BORDER="0" CELLSPACING="0" CELLPADDING="0">
				<tr>
					<td class="NewSectionHead" colspan="4" align="center">ADD/EDIT TAX</td>
				</tr>
										...
										<table WIDTH="90%" ALIGN="left" BORDER="0" CELLSPACING="0" CELLPADDING="2">
											...
											<tr>
												<td>
													...
													<html:hidden name="AddTaxDefinition" property="answer(Object::Product::Tax::Definition::ProductTaxId)" />
