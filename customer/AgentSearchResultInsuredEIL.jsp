...
<template:put name='ProgressBar' content='/common/ProgressBarAgencyBTA.jsp' />
...
<template:put name='ProgressBar' content='/common/ProgressBarAgency.jsp' />
</dmshtml:dms_static_with_connector>

<template:put name='GeneralBody' content='/customer/AgentSearchResultInsuredEILBody.jsp' /> 
