...
<table WIDTH="100%" ALIGN="left" BORDER="0" CELLSPACING="0" CELLPADDING="0">
							...
							<td>&nbsp;</td>
								<td>
									...
									<a href="../GetUWQuoteSummaryAction.do?TabPanelName=Quote_Panel&answer(Object::Customer::CustomerId)=<%=cId.toString()%>&answer(Object::Quote::QuoteVerId)=<%=""+quoteVerId%>&answer(QuoteId)=<%=quoteId.toString()%>&answer(parentQuoteId)=<%=quoteId.toString()%>">
												Quote Summary
									</a>
									<%}%>
								</td>
...
<!--					<td class="SearchResult" align="center" >	
 ...
 -->	
					<td>
					<%if(qmap.getString("Object::Clearance::ClearanceSource").equals("SOLARTIS")){ %>
						<a href="../GetUWQuoteSummaryAction.do?TabPanelName=Quote_Panel&answer(Object::Customer::CustomerId)=<%=qmap.getString("Object::Clearance::CustomerId")%>&answer(Object::Agency::AgencyId)=<%=qmap.getString("Object::Clearance::AgencyId")%>&answer(QuoteId)=<%=qmap.getString("Object::Clearance::QuoteNumber")%>&answer(parentQuoteId)=<%=qmap.getString("Object::Clearance::QuoteNumber")%>">
...
<!-- 					
 ...
 -->					
				...
				<tr   align="center">
					<td colspan="2">	
					<div class="field">			
						<html:button value="Back" property="answer(button)" styleClass="covbutton"  onclick="javascript:history.go(-1);" />	
						</div>			
					</td>
					<td colspan="2">
					<div class="field">
