...
<table WIDTH="98%" ALIGN="center" BORDER="0" CELLSPACING="0" CELLPADDING="2">
	...
	<tr><td class="links">
		...
		<dmshtml:dms_static_with_connector ruleName='privilage' property='<%=new String[]{"ADD_FEE_MENU"}%>' connector='or' negated="true">
			...
			<a href="../feedefinition/AddFees.jsp?TabPanelName=Manage_Panel&clear=yes" title="Click to go to the Add Fees Page" >Add Fees</a>
		</dmshtml:dms_static_with_connector>
			<br>

		<dmshtml:dms_static_with_connector ruleName='privilage' property='<%=new String[]{"FIND_FEE_MENU"}%>' connector='or' negated="true">
			<IMG SRC="../Images/bullxred.gif" WIDTH="20" HEIGHT="20" BORDER="0" ALT="">
			<a href="../FindFeeDefinitionAction.do?TabPanelName=Manage_Panel&clear=yes" title="Click to go to the Find Fee Page" >Find Fees</a>
			<br>
		</dmshtml:dms_static_with_connector>
	</td></tr>
  </td></tr>
