...
<body  topmargin=0 bottommargin=0 leftmargin=0 rightmargin=0 bgcolor="E4E4E4">
	...
	<div id="AddClassDiv" class="todotab_yellowbox2" style="width:920px; padding:20px 0 0 30px;margin:0 0 ;background-color:#fff;border-top: #F0AA3A 1px solid;">
				...
				<div id="AddClassDiv1">
					...
					objectVerId="0" objectName='<%="HAZARDS"%>' applicationType="QUOTE" applicationSubType="" isSubApplicationCoveredByForm="Yes"  actionName="/saveHazardsApplication.go?" isApplicationEnabled='Y'  showOneTabAtTime="N"/>
					...
					<html:hidden property="answer(Object::Quote::ApplicationId)" value="222" />		
					<html:hidden property="answer(Object::Quote::ApplicationVerId)" value="248" />		
					</logic:notPresent>
				</div>
