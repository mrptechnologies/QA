...
<html:form action="/LinkFeesToProductVer">
...
<tr><td>&nbsp;</td></tr>
<tr><td class="MH">
LINK FEES AND PRODUCT VERSIONS
</td></tr>
<tr><td class="TextMatter">
Use this page to link fees to product versions
<br>
</td></tr>
...
<td class="FormLabels" align="left">Select fee(s) to be linked to the product version</td></tr>
<tr><td>
<table WIDTH="550px" ALIGN="center" cellspacing=0 cellpadding="2" border="0">

	<tr><td colspan="2">&nbsp;</td></tr>
	<tr>
			<td class="FormLabels" align="left">Fee</td>
			<td class="FormLabels" align="left">&nbsp;</td>					
			<td class="FormLabels" align="left">Selected Fees</td>
			
</tr>
<bean:define id="ownerId" property="answer(Object::UserDetail::ownerId)" name="LoginPage" scope="session"/>
<tr>
		<td width="15%"><dmshtml:get_available_prodVer_fees nameInSession="arrFees" ownerId="<%=Long.parseLong(""+ownerId)%>"  productId="<%=Long.parseLong(request.getParameter("answer(Object::Product::ProductId)").toString())%>" 
...
%>			
 <dmshtml:dms_option value ='<%=feeMap.getString("feeId")%>'>
...
<td width="30%"><dmshtml:get_prodVer_fees nameInSession="arrFees" ownerId="<%=Long.parseLong(""+ownerId)%>" productVerId="<%=Long.parseLong(request.getParameter("answer(Object::Product::ProductVerId)").toString())%>" 
...
dbname="<%=com.dms.web.util.DbUtils.getReadDS(pageContext)%>"/>
		<dmshtml:dms_select  property="answer(Object::ProductVer::Fees)" styleId="chosen" multiple="true" size="7" >
			<logic:present name="arrFees" scope="request">
	<bean:define id="arrayFees" name="arrFees" type="java.util.ArrayList"/>
	<%
...
<html:hidden property="answer(objectType)" value="productVerFees" />
