	...
	<logic:present name="customerDetail1" scope="request">
		...
		<div class="frame5">
			<div class="frlabelLen left frVerLine">
				<bean:message key="Top.EmployerGroupName"/>:&nbsp;&nbsp;&nbsp;<span class="frinfoLen"><a href="../GetInsuredAction.do?TabPanelName=Insured_Panel&customerId=<%=cId.toString()%>&answer(Object::Customer::CustomerId)=<%=cId.toString()%>&answer(Object::Agency::AgencyId)=<%=""+lngAgencyId%>" ><%=customerDetailMap.getString("custname")%></a></span><br />
