...
<html:form name="FindForm" type="com.dms.web.data.DataForm" action="ListOfAgencyForRetailAgency.do">
...
<bean:define id="ownerId" property="answer(Object::UserDetail::ownerId)" name="LoginPage" scope="session"/>
 <table WIDTH="98%" ALIGN="center" BORDER="0" CELLSPACING="0" CELLPADDING="2">
	   ...
	   <tr><td>&nbsp;</td></tr>
		...
		<tr><td class="MH">FIND AGENCY</td></tr>
		<tr><td><hr size="1" noshade></td></tr>
		<tr><td>
		<tr>
		 <td>
			<table WIDTH="90%" ALIGN="center" BORDER="0" CELLSPACING="0" CELLPADDING="2">
			  <tr><td class="sectionhead" colspan ="2" align="center" >AGENCY DETAILS 	</td></tr>
				...
				<td align="left" ><html:text  property="answer(Agency::Equals::AgencyId)" style="class:txtbox"/></td>
		...
		<tr>
			...
			<td align="left" ><html:text property="answer(Agency::Like::BusinessName)" style="class:txtbox"/></td>
