...
<html:form action="/CVLinkAgencytoInsuredSubEILAction3.0.do">
...
<div class="formpage01">
		...
		<div class="formcontentLeftAlign">
		<input type="button" class="covbutton" value="Change" onclick="editAgency();" style="width:90px;">	
		</div>	
		
		<div class="formcontentRightAlign">
		<logic:present name="AgentStatus">
			<input type="button" class="covbutton" value="Continue" onclick="submitAgent();" style="width:90px;">	
		</logic:present>
		<logic:notPresent name="AgentStatus">
			<input type="button" class="covbutton" value="Select" onclick="submitAgent();" style="width:90px;">	
		</logic:notPresent>
		</div>
...
function listagents() {
 ...
 YAHOO.example.Basic = function() {
        ...
        var myColumnDefs = [
            {key:"AgentFirstName", sortable:true, resizeable:true},
            {key:"AgentLastName", sortable:true, resizeable:true},
