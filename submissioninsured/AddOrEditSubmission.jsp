...
<template:put name='Header1' content='/submission/AddSubmissionHeader.jsp' />
<template:put name='GeneralBody' content='/submissioninsured/AddOrEditSubmissionBody.jsp' /> 
