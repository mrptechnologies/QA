...
<html:form action="/LinkAgencttoCustomerAction.do">
		...
		<tr><td>
			...
			<table WIDTH="100%" ALIGN="Left" cellspacing="2" cellpadding="2">
				...
				<tr>
					...
					<td class="sectionhead" width="10%" align="center">Agent First Name</td>
					
					<td class="sectionhead" width="10%" align="center">Agent Last Name</td>
