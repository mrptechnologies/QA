...
<%
String requestFrom = "";
if(request.getParameter("answer(requestFrom)") != null){ 
	requestFrom = "" + request.getParameter("answer(requestFrom)");
}
%>
...
<!-- [1] Done -->
	...
	<tr>
			...
			Effective Date 
			&nbsp;</td>
			<td class="links"><html:text   property="answer(Object::Quote::QuoteStartDate)" size="15" maxlength="30" styleId="txtDate" styleClass='txtbox' onchange="return validateDate('submit');" onblur="return validateDate('submit');" />&nbsp;(MM/DD/YYYY)</td>
		</tr>
	<tr>		
