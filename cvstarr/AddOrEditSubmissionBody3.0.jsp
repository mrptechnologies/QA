...
<html:form action="/CVSaveInsuredSubmissionUI3" focus="InsuredName" onsubmit="return validateFields()">
...
<div class="field"  style="width:515px;" id="insuredNameBlock"><font color="red">* Legal Name 1:</font>
<html:text  name="AddCustomer" property ="answer(Object::Customer::CustomerName)" maxlength="<%=nameFieldLength%>" styleClass="txtbox" styleId="InsuredName" /> </div>
 
<div class="field"  style="width:515px;" id="insuredNameBlock">Legal Name 2:
   <html:text name="AddCustomer" property="answer(Object::Customer::CustomerName2)" maxlength="<%=nameFieldLength%>" styleClass="txtbox" styleId="InsuredName2" />
</div>
...
<div class="field" id="DBABlock" style="width:515px;">Insured DBA:
   <html:text name="AddCustomer" property="answer(Object::Customer::DBA)"  styleClass="txtbox" styleId="DBA" maxlength="<%=nameFieldLength%>"/>
</div>

<h3>Primary Business Address</h3>

<div class="field" style="width:515px;">Address Line 1:
...
<div class="field" id="zipcodeAutoComplete" style=" text-align:center; width:380px ;float:left;height:2px;"><font color="red">*Zipcode or City Name:</font>
		...
		<div  class="field" style="text-align:left; width:700px;float:right;">
...
<div class="field" style="width:385px;">Is Genius Address same as Business Address?
  <input type="radio" name="answer(Object::Submission::MailingAddressSameAsBusinessAddress)" value="Y" id="MailingAddressSameAsBusinessAddress_Y" checked="checked" />Yes
  <input type="radio" name="answer(Object::Submission::MailingAddressSameAsBusinessAddress)" value="N" id="MailingAddressSameAsBusinessAddress_N" onclick="displayMailingAddressBlock()" />No&nbsp;&nbsp;
</div>
<div class="formpageinsured2">
...
<div class="field" id="otherFOBBlock" style="width:635px;height:40px;">If Other,please Specify
<html:textarea name="AddCustomer" property="answer(Object::Customer::OtherBusiness)" rows="2" cols="30" onkeyup="maxLengthTextArea()" styleId="OtherBusiness" />
			...
			<div class="field">
			<input type="submit" class="covbutton" value="Next" style="width:100px;" id="NextButton">
			</div>
...
var brokerFailure=document.forms[0].BrokerBlocked.value;

if(brokerFailure=='BrokerBlocked') {  
	document.forms[0].action='../CVSaveInsuredSubmissionUI3BrokerFailure.do';
