			...
			<table WIDTH="100%" ALIGN="left" BORDER="0" CELLSPACING="0" CELLPADDING="0">
				...
				<logic:present name="MESSAGE_LISTS" scope="request">
						...
						<tr><td align="left">&nbsp;</td><tr>
							<td align="left">
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<html:button value="Back" styleClass="linkButton" property="answer(back)" onclick="goToSubmissionSummaryPage();"/>
							</td>
						</tr>
			...
			<table WIDTH="100%" ALIGN="left" BORDER="0" CELLSPACING="0" CELLPADDING="0">				
				...
				<tr><td>
					...
					<!-- Added by N.Senthil 
	  					 To set OwnerId -->
					<bean:define id="ownerId" property="answer(Object::UserDetail::ownerId)" name="LoginPage" scope="session"/>
					<bean:define id="submissionType1" name="AddCustomer" property="answer(Object::Submission::Type)"/>
					<bean:define id="submissionRenewalPolNo1" name="AddCustomer" property="answer(Object::Submission::RenewalPolicy)"/>
					<html:hidden property="answer(Object::Submission::Type)" name="AddCustomer" value= '<%=""+submissionType1 %>'/>
					<html:hidden property="answer(Object::Submission::RenewalPolicy)" name="AddCustomer" value= '<%=""+submissionRenewalPolNo1 %>'/>
					<html:hidden property="answer(Object::Quote::QuoteType)" name="AddCustomer" value= '<%=""+submissionType1 %>'/>
					<html:hidden property="answer(Object::QuoteAdditional::RenewalPolicyNumber)" name="AddCustomer" value= '<%=""+submissionRenewalPolNo1 %>'/>
					...
					<html:hidden property="answer(pagename)" value="Register Submission Page" />
	...
	<tr>
		<td>
			<table WIDTH="75%" ALIGN="center" BORDER="0" CELLSPACING="0" CELLPADDING="0">
				...
				<tr>
					<td align="center" class="links" colspan="4" title="<bean:message key='ToolTip.SubmitApplication.SubmitApplication'/>">				
							<INPUT TYPE="submit" value="Submit Completed Application" disabled="disabled"  class="submitbutton" id="ConfirmSubmit">					
					</td>
					<td title="<bean:message key='ToolTip.SubmitApplication.Back'/>">
