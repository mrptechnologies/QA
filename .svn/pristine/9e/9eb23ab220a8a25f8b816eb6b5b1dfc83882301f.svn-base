...
<table WIDTH="86%" ALIGN="center" BORDER="0" CELLSPACING="0" CELLPADDING="2">
	...
	<tr>
		<td class="NewSectionHead" colspan="4" align="center">Product Document Version Details</td>
	</tr>
		...
		<td>
			<table width="86%" ALIGN="right" BORDER="0">
				...
				<tr>
					...
					<td class="links">
						<html:select property="answer(Object::Product::Document::Active)" value="" styleId="Active" styleClass="txtbox">
							<html:option value ="Y">Yes</html:option>
