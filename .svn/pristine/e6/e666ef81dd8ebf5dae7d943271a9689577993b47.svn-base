...
//Validate email address
	if (formElement.emailId.value!=""){
		if(checkMail(formElement.emailId.value)){
...
/*	if (formElement.comboHealth.value=="")
	...
	//	alert("Please enter a numeric value for age"+formElement.elements[4].value);
		//	return false;
		
		//}
		if((formElement.elements[4].value <15) || (formElement.elements[4].value>98))
		{
			alert("Age should be between 15 and 99 years!");
			return false;
...
function submitToSearchEmployeeCencus(){
	var form=document.forms[0];
	...
	form.action="../SearchCencusEmployees.do";
	form.submit();
}
