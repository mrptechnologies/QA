...
<html:form action="/TestAllrisksLogin">      
                    <TABLE WIDTH="90%" ALIGN="center" BORDER=0 CELLSPACING=0 CELLPADDING=2>
									<tr>
										<td class="FormLabels" align="left">UserName</td>
										<td class="FormLabels" align="left">
										<input  name="UserName" id="username" value="" maxlength="40" size="15" class="txtbox">
										</td>
									</tr>
									<tr>
										<td class="FormLabels" align="left">BrokerContactId</td>
										<td class="FormLabels" align="left">
										<input  name="BrokerContactId" id="brokercontactid" maxlength="40" size="15" value="3653" class="txtbox">
										</td>
									</tr>
									...
									<tr>
										...
										<td class="FormLabels" align="left">
										<input type="text" name="BrokerId" id="brokerid" maxlength="40" size="15" value="20015" class="txtbox">
										</td>
									</tr>
									...
									<tr>
										...
										<td class="FormLabels" align="left">
										<input type="text" name="SSOKey" id="ssokey" size="60" value="ALLRISKS#ACC01$HOMEQUICK@NOW" class="txtbox">
										</td>
									</tr>
									...
									<tr>
									   ...
									   <select name="UserRole" >
									        <option value=''>Select</option>
										   	<option value='SSO_AGENT'>SSO_AGENT</option>
								...
								<tr>
									    ...
									    <td class="FormLabels" align="left"> 
										<INPUT name="OwnerId" id="ownerid" type=text value="5"/>
										</td>
								...
								<tr>
									    ...
									    <td class="FormLabels" align="left"> 
										<INPUT name="LogOffURL" id="logoffurl" type=text value="https://web.allrisks.com/online/"/>
										</td>
				...
				java.sql.Connection con = dbCon.getConnection("java:/jdbc/solartisds");
				 String originalURL = "UserName="+request.getParameter("UserName")+"&BrokerContactId="+request.getParameter("BrokerContactId")+"&BrokerId="+request.getParameter("BrokerId")+
      		    ...
      		    String key = com.dms.util.OwnerUtility.getParameter(5,"SSO_PRESHARED_KEY",con);
		        String seed = com.dms.util.OwnerUtility.getParameter(5,"SSO_PRESHARED_SEED",con);
				...
				String url = "https://"+request.getServerName()+"/AllrisksLogin.go?agent_id="+java.net.URLEncoder.encode(encryptedString,"US-ASCII");
				String cleanURL = "https://"+request.getServerName()+"/AllrisksLogin.go?agent_id="+originalURL;
				con.close();
	          %>
...
<html:form action="/TestAllrisksLogin">      
	<TABLE WIDTH="90%" ALIGN="center" BORDER=0 CELLSPACING=0 CELLPADDING=2>
			<tr>
				...
				<td class="FormLabels" align="left">
				<textarea  name="encryptedText" cols="60" rows="10">0m8wzNMD2vtQyrZDwNMQtd3thLS7nzYsDvfqY8tHJb76t%2F3ceND%2FVxyZ932jvoq%2F</textarea>
				</td>
			</tr>
