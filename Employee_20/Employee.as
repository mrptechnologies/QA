...
getMedExplValuefromXML = function(medHealthXML:XML,isNeedNormalFormRetrieve:Boolean){
	...
	for(j = 0;j<medHealthXML.firstChild.childNodes.length;j++){
		...
		if(subApplicationName == "MedQ"){
			for(i=0;i<global_employee_XML_Extended.firstChild.childNodes[j].childNodes.length;i++){
					var nameElement:String = global_employee_XML_Extended.firstChild.childNodes[j].childNodes[i].firstChild.firstChild.nodeValue;
					var valueElement:String = global_employee_XML_Extended.firstChild.childNodes[j].childNodes[i].lastChild.lastChild.nodeValue;
					
					if(nameElement=="Object__Employee__MedicalCondition__Alcohol" and valueElement != null){

						Object__Employee__MedicalCondition__Alcohol___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____ALCOHOL.setValue(valueElement);
						if(Object__Employee__MedicalCondition__Alcohol___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____ALCOHOL.getValue() == "Y"){
							MandatoryIdentifierValue.put("ALCOHOLValue",Object__Employee__MedicalCondition__Alcohol___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____ALCOHOL.getValue());
						}else{
							MandatoryIdentifierValue.put("ALCOHOLValue","N");
						}
					}
					
					else if(nameElement=="Object__Employee__MedicalCondition__AutoImmune" and valueElement != null){

						Object__Employee__MedicalCondition__AutoImmune___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____AUTO_IMMUNE.setValue(valueElement);
						if(Object__Employee__MedicalCondition__AutoImmune___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____AUTO_IMMUNE.getValue() == "Y"){
							MandatoryIdentifierValue.put("AUTOIMMUNEValue",Object__Employee__MedicalCondition__AutoImmune___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____AUTO_IMMUNE.getValue());
							
						}else{
							MandatoryIdentifierValue.put("AUTOIMMUNEValue","N");
						}
					}
					else if(nameElement=="Object__Employee__MedicalCondition__BloddClot" and valueElement != null){

						Object__Employee__MedicalCondition__BloddClot___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____BLOODCLOT.setValue(valueElement);
						if(Object__Employee__MedicalCondition__BloddClot___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____BLOODCLOT.getValue() == "Y"){
							MandatoryIdentifierValue.put("BLOODCLOTValue",Object__Employee__MedicalCondition__BloddClot___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____BLOODCLOT.getValue());
						}else{
							MandatoryIdentifierValue.put("BLOODCLOTValue","N");
						}
					}
					else if(nameElement=="Object__Employee__MedicalCondition__Cancer" and valueElement != null){
						...
						if(Object__Employee__MedicalCondition__Cancer___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____CANCER.getValue() == "Y"){
							MandatoryIdentifierValue.put("CANCERValue",Object__Employee__MedicalCondition__Cancer___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____CANCER.getValue());
						}else{
							MandatoryIdentifierValue.put("CANCERValue","N");
						}
					}
					else if(nameElement=="Object__Employee__MedicalCondition__Circulatory" and valueElement != null){

						Object__Employee__MedicalCondition__Circulatory___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____CIRCULATORY.setValue(valueElement);
						if(Object__Employee__MedicalCondition__Circulatory___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____CIRCULATORY.getValue() == "Y"){
							MandatoryIdentifierValue.put("CIRCULATORYValue",Object__Employee__MedicalCondition__Circulatory___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____CIRCULATORY.getValue());
						}else{
							MandatoryIdentifierValue.put("CIRCULATORYValue","N");
						}
					}
					else if(nameElement=="Object__Employee__MedicalCondition__Diabetes" and valueElement != null){

						Object__Employee__MedicalCondition__Diabetes___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____DIABETES.setValue(valueElement);
						if(Object__Employee__MedicalCondition__Diabetes___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____DIABETES.getValue() == "Y"){
							MandatoryIdentifierValue.put("DIABETESINSULINValue",Object__Employee__MedicalCondition__Diabetes___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____DIABETES.getValue());
						}else{
							MandatoryIdentifierValue.put("DIABETESINSULINValue","N");
						}
					}
					else if(nameElement=="Object__Employee__MedicalCondition__Infertility" and valueElement != null){

						Object__Employee__MedicalCondition__Infertility___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____INFERTILITY.setValue(valueElement);
						if(Object__Employee__MedicalCondition__Infertility___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____INFERTILITY.getValue() == "Y"){
							MandatoryIdentifierValue.put("INFERTILITYValue",Object__Employee__MedicalCondition__Infertility___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____INFERTILITY.getValue());
						}else{
						...
						Object__Employee__MedicalCondition__Kidney___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____KIDNEY_STONES.setValue(valueElement);
						if(Object__Employee__MedicalCondition__Kidney___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____KIDNEY_STONES.getValue() == "Y"){
							MandatoryIdentifierValue.put("KIDNEYValue",Object__Employee__MedicalCondition__Kidney___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____KIDNEY_STONES.getValue());
						}else{
							MandatoryIdentifierValue.put("KIDNEYValue","N");
						}
					}
					else if(nameElement=="Object__Employee__MedicalCondition__CLungDisease" and valueElement != null){

						Object__Employee__MedicalCondition__CLungDisease___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____LUNG_DIESEASE.setValue(valueElement);
						if(Object__Employee__MedicalCondition__CLungDisease___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____LUNG_DIESEASE.getValue() == "Y"){
							MandatoryIdentifierValue.put("LUNGValue",Object__Employee__MedicalCondition__CLungDisease___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____LUNG_DIESEASE.getValue());
						}else{
							MandatoryIdentifierValue.put("LUNGValue","N");
						}
					}
					else if(nameElement=="Object__Employee__MedicalCondition__MuscleDisorder" and valueElement != null){

						Object__Employee__MedicalCondition__MuscleDisorder___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____MUSCLE_DISORDER.setValue(valueElement);
						if(Object__Employee__MedicalCondition__MuscleDisorder___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____MUSCLE_DISORDER.getValue() == "Y"){
							MandatoryIdentifierValue.put("MUSCLEValue",Object__Employee__MedicalCondition__MuscleDisorder___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____MUSCLE_DISORDER.getValue());
						}else{
							MandatoryIdentifierValue.put("MUSCLEValue","N");
						}
					}
					else if(nameElement=="Object__Employee__MedicalCondition__NervousDisorder" and valueElement != null){

						Object__Employee__MedicalCondition__NervousDisorder___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____NERVOUS_DISORDER.setValue(valueElement);
						if(Object__Employee__MedicalCondition__NervousDisorder___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____NERVOUS_DISORDER.getValue() == "Y"){
							MandatoryIdentifierValue.put("NERVOUSValue",Object__Employee__MedicalCondition__NervousDisorder___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____NERVOUS_DISORDER.getValue());
						}else{
							MandatoryIdentifierValue.put("NERVOUSValue","N");
						}
					}
					else if(nameElement=="Object__Employee__MedicalCondition__SpinalDisorder" and valueElement != null){

						Object__Employee__MedicalCondition__SpinalDisorder___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____SPINAL_DISORDER.setValue(valueElement);
						if(Object__Employee__MedicalCondition__SpinalDisorder___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____SPINAL_DISORDER.getValue() == "Y"){
							MandatoryIdentifierValue.put("SPINALValue",Object__Employee__MedicalCondition__SpinalDisorder___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____SPINAL_DISORDER.getValue());
						}else{
							MandatoryIdentifierValue.put("SPINALValue","N");
						}
					}
						...
						if(Object__Employee__MedicalCondition__Transplant___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____TRANSPLANT.getValue() == "Y"){
							MandatoryIdentifierValue.put("TRANSPLANTValue",Object__Employee__MedicalCondition__Transplant___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____TRANSPLANT.getValue());
						}else{
							MandatoryIdentifierValue.put("TRANSPLANTValue","N");
						}
					}
					else if(nameElement=="Object__Employee__MedicalCondition__Smoker" and valueElement != null){

						Object__Employee__MedicalCondition__Smoker___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____SELF_SMOKER.setValue(valueElement);
						if(Object__Employee__MedicalCondition__Smoker___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____SELF_SMOKER.getValue() == "Y"){
							MandatoryIdentifierValue.put("SMOKERValue",Object__Employee__MedicalCondition__Smoker___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____SELF_SMOKER.getValue());
						}else{
							MandatoryIdentifierValue.put("SMOKERValue","N");
						}
					}
					else if(nameElement=="Object__Employee__MedicalCondition__Stomach" and valueElement != null){

						Object__Employee__MedicalCondition__Stomach___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____STOMACH.setValue(valueElement);
						if(Object__Employee__MedicalCondition__Stomach___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____STOMACH.getValue() == "Y"){
							MandatoryIdentifierValue.put("STOMACHValue",Object__Employee__MedicalCondition__Stomach___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____STOMACH.getValue());
						}else{
							MandatoryIdentifierValue.put("STOMACHValue","N");
						}
					}
					else if(nameElement=="Object__Employee__MedicalCondition__Other" and valueElement != null){

						Object__Employee__MedicalCondition__Other___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____OTHER_20.setValue(valueElement);
						if(Object__Employee__MedicalCondition__Other___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____OTHER_20.getValue() == "Y"){
							MandatoryIdentifierValue.put("OTHERDISEASEValue",Object__Employee__MedicalCondition__Other___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____OTHER_20.getValue());
						}else{
							MandatoryIdentifierValue.put("OTHERDISEASEValue","N");
						}
					}
						...
						if(Object__Employee__MedicalQuestion__DiseaseTreatedBefore___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____DISEASE_TREATED_BEFORE.getValue() == "Y"){
							MandatoryIdentifierValue.put("TREATEDBEFOREValue",Object__Employee__MedicalQuestion__DiseaseTreatedBefore___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____DISEASE_TREATED_BEFORE.getValue());
						}else{
						...
						if(Object__Employee__MedicalQuestion__OperatedHospitalizedBefore___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____OPERATED_HOSPITALIZED_BEFORE.getValue() == "Y"){
							MandatoryIdentifierValue.put("HOSPITALIZEDBEFOREValue",Object__Employee__MedicalQuestion__OperatedHospitalizedBefore___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____OPERATED_HOSPITALIZED_BEFORE.getValue());
						}else{
						...
						if(Object__Employee__MedicalQuestion__AdvisedFurtherTreatment___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____ADVISED_FURTHER_TREATMENT.getValue() == "Y"){
							MandatoryIdentifierValue.put("OPERATIONADVISEDValue",Object__Employee__MedicalQuestion__AdvisedFurtherTreatment___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____ADVISED_FURTHER_TREATMENT.getValue());
						}else{
						...
						if(Object__Employee__MedicalQuestion__CurrentlyPregnant___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____CURRENTLY_PREGNANT.getValue() == "Y"){
							Object__Employee__MedicalQuestion__PregnantPersonName___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____PREGNANT_PERSON_NAME.enabled = true;
							Object__Employee__MedicalQuestion__DelivaryDueDateMonth.enabled = true;
							Object__Employee__MedicalQuestion__DelivaryDueDateDate.enabled = true;
							Object__Employee__MedicalQuestion__DelivaryDueDateYear.enabled = true;
							risk_yes.enabled = true;
							risk_no.enabled = true;
						}
					}
						...
						Object__Employee__MedicalCondition__DepressionAnxiety___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____DEPRESSION.setValue(valueElement);
						if(Object__Employee__MedicalCondition__DepressionAnxiety___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____DEPRESSION.getValue() == "Y"){
							MandatoryIdentifierValue.put("DEPRESSIONValue",Object__Employee__MedicalCondition__DepressionAnxiety___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____DEPRESSION.getValue());
						}else{
					...
					else if(nameElement == "Object__Employee__MedicalQuestion__DueDateMonth" and valueElement != null and valueElement!="0000-00-00"){
		...
		else if(subApplicationName == "MandatoryExplMap"){
			...
			for(i=0;i<medHealthXML.firstChild.childNodes[j].childNodes.length;i++){
					...
					//Alert.show("valueElement : Name element "+valueElement+": "+nameElement,Alert.YES);
							...
							}if(valueElement == "No" && MandatoryIdentifierValue.get(identifierValue) == "Y"){
								//Alert.show("valueElement :"+valueElement,Alert.YES);
								btn1._visible = true;
								btn2._visible = false;
								MandatoryValueSet.put(valueSet,"true");
			...
			var identifierArr:Array = new Array('ALCOHOL','AUTOIMMUNE','BLOODCLOT','CANCER','CIRCULATORY','DIABETESINSULIN','HYPERTENSION','INFERTILITY','KIDNEY','LUNG','DEPRESSION','MUSCLE','NERVOUS','SPINAL','TRANSPLANT','SMOKER','STOMACH','OTHERDISEASE','TREATEDBEFORE','HOSPITALIZEDBEFORE','OPERATIONADVISED','PREGNANT');
			...
			if(explDP_array.length>0) {
			 ...
			 if(isNeedNormalFormRetrieve){
					...
					if(nameElement == "Object__Employee__MedicalCondition__Cancer" and valueElement != null){
						...
						Object__Employee__MedicalQuestion__DiseaseTreatedBefore___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____DISEASE_TREATED_BEFORE.text = valueElement;
					}
					else if(nameElement == "Object__Employee__MedicalQuestion__OperatedHospitalizedBefore" and valueElement != null){
						Object__Employee__MedicalQuestion__OperatedHospitalizedBefore___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____OPERATED_HOSPITALIZED_BEFORE.text = valueElement;
					}
					else if(nameElement == "Object__Employee__MedicalQuestion__AdvisedFurtherTreatment" and valueElement != null){
						Object__Employee__MedicalQuestion__AdvisedFurtherTreatment___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____ADVISED_FURTHER_TREATMENT.text = valueElement;
					}
					else if(nameElement == "Object__Employee__MedicalQuestion__CurrentlyPregnant" and valueElement != null){
						Object__Employee__MedicalQuestion__CurrentlyPregnant___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____CURRENTLY_PREGNANT.text = valueElement;
					}
					else if(nameElement == "Object__Employee__MedicalQuestion__PregnantPersonName" and valueElement != null){
						Object__Employee__MedicalQuestion__PregnantPersonName___DMS_EMPLOYEE_MED_HEALTH_QUESTIONNAIRE____PREGNANT_PERSON_NAME.text = valueElement;
					}
		...
		if(subApplicationName == "Expl"){
			...
			for(attArrIndx:Number = 0; attArrIndx < nameElementArray.length; attArrIndx++){
				if(pKeyCheckArr[keyIndex]==nameElementArray[attArrIndx].substr(nameElementArray[attArrIndx].indexOf("_____")+5,nameElementArray[attArrIndx].length)){
					if(nameElementArray[attArrIndx].indexOf("Object__Employee__MedExplanation__PatientName")!=-1){
						//Alert.show("pat Name"+ valuElementArray[attArrIndx],Alert.YES);
						patientName = valuElementArray[attArrIndx];												
					}
					else if(nameElementArray[attArrIndx].indexOf("Object__Employee__MedExplanation__PatientCondition")!=-1){
						//Alert.show("pat condn"+ valuElementArray[attArrIndx],Alert.YES);
