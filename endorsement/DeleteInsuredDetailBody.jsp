					...
					if ((IsModified.toString()).equalsIgnoreCase("N")){ %>
					    ...
					    <tr>
					     ...
					     <td class="TextMatter" width="10%">
					      ...
					      <input type="radio" name="answer(Object::QuoteInsured::QuoteInsuredId)" value="<%=""+quoteInsuredId %>" styleClass="txtbox" checked="<%=selected %>"></td>
					     <%}else{%>
				...
				<table class="FormLabelsApplication" border="0" cellpadding="2" cellspacing="2" >
					<tr>
						...
						<td class="TextMatter1" width="40%">
							...
							<bean:write name="EndorsementDetail" property="answer(Object::QuoteInsured::InsuredFullName)" />
						</td>
					</tr>			
					
					<tr>
						<td class="FormLabels" width="40%">Street Number</td><td class="TextMatter1" width="40%">
							<bean:write name="EndorsementDetail" property="answer(Object::QuoteInsured::StreetNumber)" />
						</td>
					</tr>
						
					<tr>
						<td class="FormLabels" width="40%">Street Name</td><td class="TextMatter1" width="40%">
							<bean:write name="EndorsementDetail" property="answer(Object::QuoteInsured::StreetName)" />
						</td>
					</tr>
					...
					<tr>
						...
						<td class="TextMatter1" width="40%">
							<bean:write name="EndorsementDetail" property="answer(Object::QuoteInsured::Address2)" /></td></tr>

					<tr>
						<td class="FormLabels" width="40%">City</td>
						<td class="TextMatter1" width="40%">
							<bean:write name="EndorsementDetail" property="answer(Object::QuoteInsured::City)"/></td></tr>

					<tr>
						<td class="FormLabels" width="40%">County</td>
						<td class="TextMatter1" width="40%">
							<bean:write name="EndorsementDetail" property="answer(Object::QuoteInsured::CountyName)"  /></td></tr>

					<tr>
						<td class="FormLabels" width="40%">State*</td>
						<td class="TextMatter1" width="40%">
							<bean:write name="EndorsementDetail" property="answer(Object::QuoteInsured::State)" /></td></tr>
					...
					<tr>
						...
						<td class="TextMatter1" width="40%">
							<bean:write name="EndorsementDetail" property ="answer(Object::QuoteInsured::WorkPhoneAreaCode)" />
							<bean:write name="EndorsementDetail" property ="answer(Object::QuoteInsured::WorkPhoneExchangeCode)" />
							<bean:write name="EndorsementDetail" property="answer(Object::QuoteInsured::WorkPhone)" />
						</td>
					</tr>
					...
					<tr>
						...
						<td class="TextMatter1" width="40%">
							<bean:write name="EndorsementDetail" property="answer(Object::QuoteInsured::FaxAreaCode)" />
							<bean:write name="EndorsementDetail" property="answer(Object::QuoteInsured::FaxExchangeCode)" />
							<bean:write name="EndorsementDetail" property="answer(Object::QuoteInsured::Fax)" />
						</td>
					</tr>
